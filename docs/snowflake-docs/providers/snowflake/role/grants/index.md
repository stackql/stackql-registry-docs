...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list_grants" /> | `SELECT` | <CopyableCode code="name, endpoint" /> | List all grants to the role |
...
| <CopyableCode code="revoke_grants" /> | `DELETE` | <CopyableCode code="name, data__securable_type, endpoint" /> | Revoke grants from the role |
