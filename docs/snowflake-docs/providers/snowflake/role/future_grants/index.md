...
|:-----|:--------------|:----------------|:----------------|:------------|
| <CopyableCode code="list_future_grants" /> | `SELECT` | <CopyableCode code="name, endpoint" /> | [`showLimit`](#showLimit) | List all future grants to the role |
...
| <CopyableCode code="revoke_future_grants" /> | `DELETE` | <CopyableCode code="name, data__securable_type, endpoint" /> | [`mode`](#mode) | Revoke future grants from the role |
