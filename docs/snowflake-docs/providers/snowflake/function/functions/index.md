...
| <CopyableCode code="list_functions" /> | `SELECT` | <CopyableCode code="database_name, schema_name, endpoint" /> | [`like`](#like) | Lists the user functions under the database and schema. |
| <CopyableCode code="create_function" /> | `INSERT` | <CopyableCode code="database_name, schema_name, data__arguments, data__name, endpoint" /> | [`createMode`](#createMode) | Create a function. |
| <CopyableCode code="delete_function" /> | `DELETE` | <CopyableCode code="database_name, nameWithArgs, schema_name, endpoint" /> | [`ifExists`](#ifExists) | Delete a function with the given name and args. |
