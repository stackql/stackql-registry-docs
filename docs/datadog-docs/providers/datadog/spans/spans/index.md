...
<tr><td><b>Id</b></td><td><code>datadog.spans.spans</code></td></tr>
</tbody></table>

## Fields
| Name | Datatype | Description |
|:-----|:---------|:------------|
| `data` | `array` | Array of spans matching the request. |
...
| `aggregate_spans` | `EXEC` | `dd_site` | The API endpoint to aggregate spans into buckets and compute metrics and timeseries.<br />This endpoint is rate limited to `300` requests per hour. |
