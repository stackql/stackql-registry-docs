...
<tr><td><b>Id</b></td><td><CopyableCode code="datadog.usage_metering.usage_observability_pipelines" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get_usage_observability_pipelines" /> | `SELECT` | <CopyableCode code="start_hr, dd_site" /> |
| <CopyableCode code="_get_usage_observability_pipelines" /> | `EXEC` | <CopyableCode code="start_hr, dd_site" /> |
