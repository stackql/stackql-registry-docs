...
<tr><td><b>Id</b></td><td><code>datadog.usage_metering.usage_lambda_traced_invocations</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get_usage_lambda_traced_invocations` | `SELECT` | `start_hr, dd_site` |
| `_get_usage_lambda_traced_invocations` | `EXEC` | `start_hr, dd_site` |
