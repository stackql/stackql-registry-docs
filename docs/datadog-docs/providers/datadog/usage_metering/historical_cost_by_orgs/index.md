...
<tr><td><b>Id</b></td><td><code>datadog.usage_metering.historical_cost_by_orgs</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get_historical_cost_by_org` | `SELECT` | `start_month, dd_site` |
| `_get_historical_cost_by_org` | `EXEC` | `start_month, dd_site` |
