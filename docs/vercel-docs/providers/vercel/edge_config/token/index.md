...
<tr><td><b>Id</b></td><td><code>vercel.edge_config.token</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| `get_edge_config_token` | `SELECT` | `edgeConfigId, teamId, token` | Return meta data about an Edge Config token. |
