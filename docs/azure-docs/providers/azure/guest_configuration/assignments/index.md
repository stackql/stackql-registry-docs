...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId, vmName" /> | List all guest configuration assignments for a virtual machine. |
| <CopyableCode code="_rg_list" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId" /> | List all guest configuration assignments for a resource group. |
| <CopyableCode code="_subscription_list" /> | `EXEC` | <CopyableCode code="subscriptionId" /> | List all guest configuration assignments for a subscription. |
