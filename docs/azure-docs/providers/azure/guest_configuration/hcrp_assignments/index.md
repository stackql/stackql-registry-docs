...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_hcrp_assignments', value: 'view', },
        { label: 'hcrp_assignments', value: 'resource', },
    ]
}>
<TabItem value="view">
...
target_resource_id,
vmss_vm_list
FROM azure.guest_configuration.vw_hcrp_assignments
...
Use the following StackQL query and manifest file to create a new <code>hcrp_assignments</code> resource.
...
Deletes the specified <code>hcrp_assignments</code> resource.
