...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_connected_vmwarev_sphere_assignments_reports', value: 'view', },
        { label: 'connected_vmwarev_sphere_assignments_reports', value: 'resource', },
    ]
}>
<TabItem value="view">
...
vmName,
vmss_resource_id
FROM azure.guest_configuration.vw_connected_vmwarev_sphere_assignments_reports
