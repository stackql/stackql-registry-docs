...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="elasticSanName, resourceGroupName, subscriptionId" /> | List all Private Endpoint Connections associated with the Elastic San. |
