...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="api-version, fabricName, resourceGroupName, subscriptionId, vaultName" /> |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, fabricName, resourceGroupName, subscriptionId, vaultName" /> |
