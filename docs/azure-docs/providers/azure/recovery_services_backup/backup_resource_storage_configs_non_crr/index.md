...
|:-----|:--------------|:----------------|:------------|
| `get` | `SELECT` | `api-version, resourceGroupName, subscriptionId, vaultName` | Fetches resource storage config. |
| `patch` | `EXEC` | `api-version, resourceGroupName, subscriptionId, vaultName` | Updates vault storage model type. |
| `update` | `EXEC` | `api-version, resourceGroupName, subscriptionId, vaultName` | Updates vault storage model type. |
