...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_private_endpoint_operation_status', value: 'view', },
        { label: 'private_endpoint_operation_status', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="operationId, privateEndpointConnectionName, resourceGroupName, subscriptionId, vaultName" /> |  |
