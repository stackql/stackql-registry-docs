...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_validate_operation_status', value: 'view', },
        { label: 'validate_operation_status', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="operationId, resourceGroupName, subscriptionId, vaultName" /> | Fetches the status of a triggered validate operation. The status can be in progress, completed
