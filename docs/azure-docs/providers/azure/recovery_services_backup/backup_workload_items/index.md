...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="api-version, containerName, fabricName, resourceGroupName, subscriptionId, vaultName" /> |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, containerName, fabricName, resourceGroupName, subscriptionId, vaultName" /> |
