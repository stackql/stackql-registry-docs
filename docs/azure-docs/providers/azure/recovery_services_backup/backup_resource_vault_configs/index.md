...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="api-version, resourceGroupName, subscriptionId, vaultName" /> | Fetches resource vault config. |
| <CopyableCode code="put" /> | `EXEC` | <CopyableCode code="api-version, resourceGroupName, subscriptionId, vaultName" /> | Updates vault security config.  |
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="api-version, resourceGroupName, subscriptionId, vaultName" /> | Updates vault security config. |
