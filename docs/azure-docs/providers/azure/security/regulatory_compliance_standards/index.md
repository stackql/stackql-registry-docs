...
|:-----|:--------------|:----------------|:------------|
| `RegulatoryComplianceStandards_Get` | `SELECT` | `api-version, regulatoryComplianceStandardName, subscriptionId` | Supported regulatory compliance details state for selected standard |
