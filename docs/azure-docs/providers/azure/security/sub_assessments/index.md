...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, assessmentName, scope" /> | Get security sub-assessments on all your scanned resources inside a scope |
