...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, resourceGroupName, solutionName, subscriptionId" /> | Use this method to get IoT security Analytics metrics in an array. |
