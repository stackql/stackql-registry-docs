...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version" /> | Gets a list with a single sensitivity settings resource |
| <CopyableCode code="sensitivity_settings" /> | `EXEC` | <CopyableCode code="api-version" /> | Gets data sensitivity settings for sensitive data discovery |
