...
Creates, updates, deletes, gets or lists a <code>azure_dev_ops_orgs</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_azure_dev_ops_orgs', value: 'view', },
        { label: 'azure_dev_ops_orgs', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="orgName, resourceGroupName, securityConnectorName, subscriptionId" /> |  |
...
subscriptionId,
system_data
FROM azure.security.vw_azure_dev_ops_orgs
...
Use the following StackQL query and manifest file to create a new <code>azure_dev_ops_orgs</code> resource.
...
Updates a <code>azure_dev_ops_orgs</code> resource.
