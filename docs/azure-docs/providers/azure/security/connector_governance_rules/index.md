...
|:-----|:--------------|:----------------|:------------|
| `SecurityConnectorGovernanceRules_Get` | `SELECT` | `api-version, resourceGroupName, ruleId, securityConnectorName, subscriptionId` | Get a specific governanceRule for the requested scope by ruleId |
