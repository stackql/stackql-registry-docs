...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version" /> | Get metadata information on all assessment types |
| <CopyableCode code="_list_by_subscription" /> | `EXEC` | <CopyableCode code="api-version, subscriptionId" /> | Get metadata information on all assessment types in a specific subscription |
