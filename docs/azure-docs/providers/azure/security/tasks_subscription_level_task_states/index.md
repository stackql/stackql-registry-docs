...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="ascLocation, subscriptionId, taskName, taskUpdateActionType" /> | Recommended tasks that will help improve the security of the subscription proactively |
