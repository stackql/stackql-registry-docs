...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_tasks_subscription_level_tasks', value: 'view', },
        { label: 'tasks_subscription_level_tasks', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="ascLocation, subscriptionId, taskName" /> | Recommended tasks that will help improve the security of the subscription proactively |
...
taskName,
type
FROM azure.security.vw_tasks_subscription_level_tasks
