...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_git_lab_projects', value: 'view', },
        { label: 'git_lab_projects', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="fully_qualified_parent_group_name" /> | `text` | field from the `properties` object |
...
system_data,
url
FROM azure.security.vw_git_lab_projects
