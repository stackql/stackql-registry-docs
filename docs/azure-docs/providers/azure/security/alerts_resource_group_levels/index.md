...
Creates, updates, deletes, gets or lists a <code>alerts_resource_group_levels</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_alerts_resource_group_levels', value: 'view', },
        { label: 'alerts_resource_group_levels', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="alertName, ascLocation, resourceGroupName, subscriptionId" /> | Get an alert that is associated a resource group or a resource in a resource group |
