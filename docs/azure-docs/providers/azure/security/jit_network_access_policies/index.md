...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, subscriptionId" /> | Policies for protecting resources using Just-in-Time access control. |
| <CopyableCode code="_list_by_region" /> | `EXEC` | <CopyableCode code="api-version, ascLocation, subscriptionId" /> | Policies for protecting resources using Just-in-Time access control for the subscription, location |
| <CopyableCode code="_list_by_resource_group" /> | `EXEC` | <CopyableCode code="api-version, resourceGroupName, subscriptionId" /> | Policies for protecting resources using Just-in-Time access control for the subscription, location |
| <CopyableCode code="_list_by_resource_group_and_region" /> | `EXEC` | <CopyableCode code="api-version, ascLocation, resourceGroupName, subscriptionId" /> | Policies for protecting resources using Just-in-Time access control for the subscription, location |
