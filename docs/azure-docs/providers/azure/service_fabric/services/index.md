...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, applicationName, clusterName, resourceGroupName, subscriptionId" /> | Gets all service resources created or in the process of being created in the Service Fabric application resource. |
