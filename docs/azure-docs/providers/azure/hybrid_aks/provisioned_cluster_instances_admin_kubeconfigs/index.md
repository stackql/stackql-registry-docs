...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="connectedClusterResourceUri" /> | Lists the admin credentials of the provisioned cluster (can only be used within private network) |
