...
|:-----|:---------|:------------|
| <CopyableCode code="properties" /> | `object` | Details of the ImageVersionProperties. |

## Methods
| Name | Accessible by | Required Params | Description |
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list_by_image" /> | `SELECT` | <CopyableCode code="imageName, resourceGroupName, subscriptionId" /> | List ImageVersion resources by Image |
