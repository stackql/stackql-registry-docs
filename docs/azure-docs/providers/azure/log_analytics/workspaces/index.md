...
<tr><td><b>Id</b></td><td><code>azure.log_analytics.workspaces</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `subscriptionId` | Gets the workspaces in a subscription. |
| `_list_by_resource_group` | `EXEC` | `resourceGroupName, subscriptionId` | Gets workspaces in a resource group. |
