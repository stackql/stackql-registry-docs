...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="queryPackName, resourceGroupName, subscriptionId" /> | Gets a list of Queries defined within a Log Analytics QueryPack. |
