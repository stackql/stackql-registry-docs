...
| <CopyableCode code="replace" /> | `REPLACE` | <CopyableCode code="resourceGroupName, serverName, subscriptionId" /> | Replaces all firewall rules on the server. |
...
start_ip_address,
subscriptionId
FROM azure.sql.vw_firewall_rules
...
Replaces all fields in the specified <code>firewall_rules</code> resource.
