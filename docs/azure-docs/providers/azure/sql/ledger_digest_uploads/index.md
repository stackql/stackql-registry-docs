...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_ledger_digest_uploads', value: 'view', },
        { label: 'ledger_digest_uploads', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>ledger_digest_uploads</code> resource.
