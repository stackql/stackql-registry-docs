...
<tr><td><b>Id</b></td><td><code>azure.sql.databases_metrics</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `$filter, databaseName, resourceGroupName, serverName, subscriptionId` |
| `_list` | `EXEC` | `$filter, databaseName, resourceGroupName, serverName, subscriptionId` |
