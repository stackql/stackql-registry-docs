...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="$filter, databaseName, resourceGroupName, serverName, subscriptionId" /> |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="$filter, databaseName, resourceGroupName, serverName, subscriptionId" /> |
