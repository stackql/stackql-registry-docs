...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_managed_database_sensitivity_labels', value: 'view', },
        { label: 'managed_database_sensitivity_labels', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="databaseName, managedInstanceName, resourceGroupName, subscriptionId" /> | Update sensitivity labels of a given database using an operations batch. |
...
tableName,
table_name
FROM azure.sql.vw_managed_database_sensitivity_labels
...
Use the following StackQL query and manifest file to create a new <code>managed_database_sensitivity_labels</code> resource.
...
Updates a <code>managed_database_sensitivity_labels</code> resource.
...
Deletes the specified <code>managed_database_sensitivity_labels</code> resource.
