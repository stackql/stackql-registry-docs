...
| <CopyableCode code="exec_get" /> | `EXEC` | <CopyableCode code="databaseName, managedInstanceName, resourceGroupName, schemaName, subscriptionId" /> | Get managed database schema |
