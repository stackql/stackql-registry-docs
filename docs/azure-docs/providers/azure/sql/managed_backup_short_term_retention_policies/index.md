...
| <CopyableCode code="_list_by_database" /> | `EXEC` | <CopyableCode code="databaseName, managedInstanceName, resourceGroupName, subscriptionId" /> | Gets a managed database's short term retention policy list. |
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="databaseName, managedInstanceName, policyName, resourceGroupName, subscriptionId" /> | Updates a managed database's short term retention policy. |
