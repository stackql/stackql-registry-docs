...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_server_blob_auditing_policies', value: 'view', },
        { label: 'server_blob_auditing_policies', value: 'resource', },
    ]
}>
<TabItem value="view">
...
storage_endpoint,
subscriptionId
FROM azure.sql.vw_server_blob_auditing_policies
...
Use the following StackQL query and manifest file to create a new <code>server_blob_auditing_policies</code> resource.
