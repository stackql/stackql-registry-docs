...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="modelName, registryName, resourceGroupName, subscriptionId" /> |
| <CopyableCode code="create_or_get_start_pending_upload" /> | `EXEC` | <CopyableCode code="modelName, registryName, resourceGroupName, subscriptionId, version" /> |
| <CopyableCode code="package" /> | `EXEC` | <CopyableCode code="modelName, registryName, resourceGroupName, subscriptionId, version, data__inferencingServer, data__targetEnvironmentId" /> |
