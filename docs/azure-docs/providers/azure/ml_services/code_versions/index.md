...
<tr><td><b>Id</b></td><td><code>azure.ml_services.code_versions</code></td></tr>
</tbody></table>
...
| `create_or_get_start_pending_upload` | `EXEC` | `name, resourceGroupName, subscriptionId, version, workspaceName` |
