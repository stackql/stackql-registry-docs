...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_featurestore_entity_versions', value: 'view', },
        { label: 'featurestore_entity_versions', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="index_columns" /> | `text` | field from the `properties` object |
...
| Name | Datatype | Description |
|:-----|:---------|:------------|
| <CopyableCode code="properties" /> | `object` | DTO object representing feature entity version |
</TabItem></Tabs>
...
version,
workspaceName
FROM azure.ml_services.vw_featurestore_entity_versions
WHERE name = '{{ name }}'
...
Use the following StackQL query and manifest file to create a new <code>featurestore_entity_versions</code> resource.
...
Deletes the specified <code>featurestore_entity_versions</code> resource.
