...
<tr><td><b>Id</b></td><td><code>azure.ml_services.inference_groups_skus</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `groupName, poolName, resourceGroupName, subscriptionId, workspaceName` |
| `_list` | `EXEC` | `groupName, poolName, resourceGroupName, subscriptionId, workspaceName` |
