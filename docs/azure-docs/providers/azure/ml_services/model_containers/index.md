...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_model_containers', value: 'view', },
        { label: 'model_containers', value: 'resource', },
    ]
}>
<TabItem value="view">
...
subscriptionId,
workspaceName
FROM azure.ml_services.vw_model_containers
...
Use the following StackQL query and manifest file to create a new <code>model_containers</code> resource.
...
Deletes the specified <code>model_containers</code> resource.
