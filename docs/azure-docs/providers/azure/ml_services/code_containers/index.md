...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_code_containers', value: 'view', },
        { label: 'code_containers', value: 'resource', },
    ]
}>
<TabItem value="view">
...
subscriptionId,
workspaceName
FROM azure.ml_services.vw_code_containers
...
Use the following StackQL query and manifest file to create a new <code>code_containers</code> resource.
...
Deletes the specified <code>code_containers</code> resource.
