...
<tr><td><b>Id</b></td><td><code>azure.ml_services.model_versions</code></td></tr>
</tbody></table>
...
| `package` | `EXEC` | `name, resourceGroupName, subscriptionId, version, workspaceName, data__inferencingServer, data__targetEnvironmentId` |
