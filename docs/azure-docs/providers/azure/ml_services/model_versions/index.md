...
| <CopyableCode code="package" /> | `EXEC` | <CopyableCode code="name, resourceGroupName, subscriptionId, version, workspaceName, data__inferencingServer, data__targetEnvironmentId" /> |
