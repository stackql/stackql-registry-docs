...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_model_versions', value: 'view', },
        { label: 'model_versions', value: 'resource', },
    ]
}>
<TabItem value="view">
...
version,
workspaceName
FROM azure.ml_services.vw_model_versions
WHERE name = '{{ name }}'
...
Deletes the specified <code>model_versions</code> resource.
