...
Creates, updates, deletes, gets or lists a <code>environment_containers</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_environment_containers', value: 'view', },
        { label: 'environment_containers', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>environment_containers</code> resource.
...
Deletes the specified <code>environment_containers</code> resource.
