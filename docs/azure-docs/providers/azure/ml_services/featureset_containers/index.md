...
|:-----|:---------|:------------|
| <CopyableCode code="properties" /> | `object` | DTO object representing feature set |
...
Use the following StackQL query and manifest file to create a new <code>featureset_containers</code> resource.
...
Deletes the specified <code>featureset_containers</code> resource.
