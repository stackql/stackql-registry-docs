...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_data_containers', value: 'view', },
        { label: 'data_containers', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>data_containers</code> resource.
...
Deletes the specified <code>data_containers</code> resource.
