...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_connection_rai_blocklists', value: 'view', },
        { label: 'connection_rai_blocklists', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="connectionName, raiBlocklistName, resourceGroupName, subscriptionId, workspaceName" /> |  |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="connectionName, resourceGroupName, subscriptionId, workspaceName" /> |  |
| <CopyableCode code="create" /> | `INSERT` | <CopyableCode code="connectionName, raiBlocklistName, resourceGroupName, subscriptionId, workspaceName, data__properties" /> |  |
...
type,
workspaceName
FROM azure.ml_services.vw_connection_rai_blocklists
...
Use the following StackQL query and manifest file to create a new <code>connection_rai_blocklists</code> resource.
...
Deletes the specified <code>connection_rai_blocklists</code> resource.
