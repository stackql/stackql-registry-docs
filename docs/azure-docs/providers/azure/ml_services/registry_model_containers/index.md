...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_registry_model_containers', value: 'view', },
        { label: 'registry_model_containers', value: 'resource', },
    ]
}>
<TabItem value="view">
...
resourceGroupName,
subscriptionId
FROM azure.ml_services.vw_registry_model_containers
...
Use the following StackQL query and manifest file to create a new <code>registry_model_containers</code> resource.
...
Deletes the specified <code>registry_model_containers</code> resource.
