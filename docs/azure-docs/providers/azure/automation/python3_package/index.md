...
| <CopyableCode code="_list_by_automation_account" /> | `EXEC` | <CopyableCode code="automationAccountName, resourceGroupName, subscriptionId" /> | Retrieve a list of python 3 packages. |
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="automationAccountName, packageName, resourceGroupName, subscriptionId" /> | Update the python 3 package identified by package name. |
