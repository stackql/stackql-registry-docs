...
<tr><td><b>Id</b></td><td><code>azure.automation.power_shell72_module</code></td></tr>
</tbody></table>
...
| `list_by_automation_account` | `SELECT` | `automationAccountName, resourceGroupName, subscriptionId` | Retrieve a list of PowerShell72 modules. |
...
| `_list_by_automation_account` | `EXEC` | `automationAccountName, resourceGroupName, subscriptionId` | Retrieve a list of PowerShell72 modules. |
