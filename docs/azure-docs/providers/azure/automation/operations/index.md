...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` |  | Lists all of the available Automation REST API operations. |
| <CopyableCode code="_list" /> | `EXEC` |  | Lists all of the available Automation REST API operations. |
| <CopyableCode code="operations" /> | `EXEC` | <CopyableCode code="automationAccountName, resourceGroupName, subscriptionId" /> | Post operation to serialize or deserialize GraphRunbookContent |
