...
<tr><td><b>Id</b></td><td><code>azure.automation.operations</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` |  | Lists all of the available Automation REST API operations. |
| `operations` | `EXEC` | `automationAccountName, resourceGroupName, subscriptionId` | Post operation to serialize or deserialize GraphRunbookContent |
