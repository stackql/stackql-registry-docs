...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | Lists all of the available Automation REST API operations. |
| <CopyableCode code="convert_graph_runbook_content" /> | `EXEC` | <CopyableCode code="automationAccountName, resourceGroupName, subscriptionId" /> | Post operation to serialize or deserialize GraphRunbookContent |
