...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="automationAccountName, resourceGroupName, subscriptionId" /> | Get all software update configurations for the account. |
