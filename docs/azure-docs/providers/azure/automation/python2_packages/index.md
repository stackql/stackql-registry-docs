...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_python2_packages', value: 'view', },
        { label: 'python2_packages', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="automationAccountName, packageName, resourceGroupName, subscriptionId" /> | Update the python 2 package identified by package name. |
...
Use the following StackQL query and manifest file to create a new <code>python2_packages</code> resource.
...
Updates a <code>python2_packages</code> resource.
...
Deletes the specified <code>python2_packages</code> resource.
