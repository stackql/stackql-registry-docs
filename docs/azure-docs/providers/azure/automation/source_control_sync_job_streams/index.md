...
| <CopyableCode code="_list_by_sync_job" /> | `EXEC` | <CopyableCode code="automationAccountName, resourceGroupName, sourceControlName, sourceControlSyncJobId, subscriptionId" /> | Retrieve a list of sync job streams identified by sync job id. |
