...
<tr><td><b>Id</b></td><td><code>azure.automation.hybrid_runbook_workers</code></td></tr>
</tbody></table>
...
| `_list_by_hybrid_runbook_worker_group` | `EXEC` | `automationAccountName, hybridRunbookWorkerGroupName, resourceGroupName, subscriptionId` | Retrieve a list of hybrid runbook workers. |
