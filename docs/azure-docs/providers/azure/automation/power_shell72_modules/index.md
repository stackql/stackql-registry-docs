...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_power_shell72_modules', value: 'view', },
        { label: 'power_shell72_modules', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>power_shell72_modules</code> resource.
...
Updates a <code>power_shell72_modules</code> resource.
...
Deletes the specified <code>power_shell72_modules</code> resource.
