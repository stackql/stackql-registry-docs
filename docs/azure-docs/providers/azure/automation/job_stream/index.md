...
| <CopyableCode code="_list_by_job" /> | `EXEC` | <CopyableCode code="automationAccountName, jobName, resourceGroupName, subscriptionId" /> | Retrieve a list of jobs streams identified by job name. |
