...
<tr><td><b>Id</b></td><td><code>azure.video_analyzer.pipeline_job_operation_statuses</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `accountName, operationId, pipelineJobName, resourceGroupName, subscriptionId` |
