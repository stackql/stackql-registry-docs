...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_savings_plan_order_aliases', value: 'view', },
        { label: 'savings_plan_order_aliases', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="kind" /> | `text` | Resource provider kind |
| <CopyableCode code="provisioning_state" /> | `text` | field from the `properties` object |
| <CopyableCode code="renew" /> | `text` | field from the `properties` object |
| <CopyableCode code="savingsPlanOrderAliasName" /> | `text` | field from the `properties` object |
| <CopyableCode code="savings_plan_order_id" /> | `text` | field from the `properties` object |
...
| <CopyableCode code="kind" /> | `string` | Resource provider kind |
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="savingsPlanOrderAliasName" /> | Get a savings plan. |
| <CopyableCode code="create" /> | `INSERT` | <CopyableCode code="savingsPlanOrderAliasName, data__sku" /> | Create a savings plan. Learn more about permissions needed at https://go.microsoft.com/fwlink/?linkid=2215851 |
...
Use the following StackQL query and manifest file to create a new <code>savings_plan_order_aliases</code> resource.
