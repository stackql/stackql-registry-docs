...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | List all the operations. |
| <CopyableCode code="validate_purchase" /> | `EXEC` | <CopyableCode code="" /> | Validate savings plan purchase. |
