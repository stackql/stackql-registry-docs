...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="id, scheduleDefinitionId, subscriptionId" /> |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="id, scheduleDefinitionId, subscriptionId" /> |
