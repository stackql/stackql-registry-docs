...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="create_or_update" /> | `INSERT` | <CopyableCode code="scheduleDefinitionId, scope" /> | Create or Update access review schedule definition. |

## `INSERT` example

Use the following StackQL query and manifest file to create a new <code>scope_access_review_schedule_definitions_by_ids</code> resource.
