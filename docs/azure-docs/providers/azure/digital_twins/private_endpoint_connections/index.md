...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="privateEndpointConnectionName, resourceGroupName, resourceName, subscriptionId" /> | Get private endpoint connection properties for the given private endpoint. |
...
| <CopyableCode code="create_or_update" /> | `INSERT` | <CopyableCode code="privateEndpointConnectionName, resourceGroupName, resourceName, subscriptionId, data__properties" /> | Update the status of a private endpoint connection with the given name. |
...
system_data,
type
FROM azure.digital_twins.vw_private_endpoint_connections
