...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="dnsForwardingRulesetName, resourceGroupName, subscriptionId" /> | Lists forwarding rules in a DNS forwarding ruleset. |
