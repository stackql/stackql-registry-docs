...
| <CopyableCode code="_list_by_replication_protected_items" /> | `EXEC` | <CopyableCode code="api-version, fabricName, protectionContainerName, replicatedProtectedItemName, resourceGroupName, resourceName, subscriptionId" /> | Lists the available recovery points for a replication protected item. |
