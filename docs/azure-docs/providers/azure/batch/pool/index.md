...
| <CopyableCode code="_list_by_batch_account" /> | `EXEC` | <CopyableCode code="accountName, resourceGroupName, subscriptionId" /> | Lists all of the pools in the specified account. |
