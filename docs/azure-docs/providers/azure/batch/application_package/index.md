...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="accountName, applicationName, resourceGroupName, subscriptionId" /> | Lists all of the application packages in the specified application. |
