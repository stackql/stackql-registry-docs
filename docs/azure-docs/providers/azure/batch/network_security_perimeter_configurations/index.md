...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="accountName, networkSecurityPerimeterConfigurationName, resourceGroupName, subscriptionId" /> | Gets information about the specified NSP configuration. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="accountName, resourceGroupName, subscriptionId" /> | Lists all of the NSP configurations in the specified account. |
...
subscriptionId
FROM azure.batch.vw_network_security_perimeter_configurations
