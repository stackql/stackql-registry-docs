...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_communications_no_subscriptions', value: 'view', },
        { label: 'communications_no_subscriptions', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>communications_no_subscriptions</code> resource.
