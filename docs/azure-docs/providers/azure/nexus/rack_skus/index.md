...
<tr><td><b>Id</b></td><td><code>azure.nexus.rack_skus</code></td></tr>
</tbody></table>
...
| `_list_by_subscription` | `EXEC` | `subscriptionId` | Get a list of rack SKUs in the provided subscription. |
