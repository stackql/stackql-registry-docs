...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_l2_networks', value: 'view', },
        { label: 'l2_networks', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="l2NetworkName" /> | `text` | field from the `properties` object |
| <CopyableCode code="l2_isolation_domain_id" /> | `text` | field from the `properties` object |
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="l2NetworkName, resourceGroupName, subscriptionId" /> | Update tags associated with the provided layer 2 (L2) network. |
...
Use the following StackQL query and manifest file to create a new <code>l2_networks</code> resource.
...
Updates a <code>l2_networks</code> resource.
...
Deletes the specified <code>l2_networks</code> resource.
