...
| <CopyableCode code="_list_by_managed_instance" /> | `EXEC` | <CopyableCode code="instanceName, resourceGroupName, subscriptionId" /> | A comprehensive list of all monitored resources within a SCOM managed instance. |
