...
<tr><td><b>Id</b></td><td><code>azure.scom.managed_gateways</code></td></tr>
</tbody></table>
...
| `list_by_managed_instance` | `SELECT` | `instanceName, resourceGroupName, subscriptionId` | A comprehensive list of all gateway resources within a SCOM managed instance. |
...
| `_list_by_managed_instance` | `EXEC` | `instanceName, resourceGroupName, subscriptionId` | A comprehensive list of all gateway resources within a SCOM managed instance. |
