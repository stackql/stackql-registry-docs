...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_workflow_run_action_request_histories', value: 'view', },
        { label: 'workflow_run_action_request_histories', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="actionName, requestHistoryName, resourceGroupName, runName, subscriptionId, workflowName" /> | Gets a workflow run request history. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="actionName, resourceGroupName, runName, subscriptionId, workflowName" /> | List a workflow run request history. |
