...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="actionName, resourceGroupName, runName, subscriptionId, workflowName" /> | Gets a workflow run action. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="resourceGroupName, runName, subscriptionId, workflowName" /> | Gets a list of workflow run actions. |
...
type,
workflowName
FROM azure.logic_apps.vw_workflow_run_actions
