...
<tr><td><b>Id</b></td><td><code>azure.logic_apps.integration_account_schemas_content_callback_url</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `api-version, integrationAccountName, resourceGroupName, schemaName, subscriptionId` |
