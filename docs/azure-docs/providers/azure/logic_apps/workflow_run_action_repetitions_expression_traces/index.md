...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="actionName, repetitionName, resourceGroupName, runName, subscriptionId, workflowName" /> | Lists a workflow run expression trace. |
