...
Creates, updates, deletes, gets or lists a <code>integration_account_schemas_content_callback_urls</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="integrationAccountName, resourceGroupName, schemaName, subscriptionId" /> | Get the content callback url. |
