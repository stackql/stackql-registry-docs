...
Creates, updates, deletes, gets or lists a <code>integration_account_agreements_content_callback_urls</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="agreementName, integrationAccountName, resourceGroupName, subscriptionId" /> | Get the content callback url. |
