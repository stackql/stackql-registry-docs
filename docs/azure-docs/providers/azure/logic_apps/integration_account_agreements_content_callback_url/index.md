...
<tr><td><b>Id</b></td><td><code>azure.logic_apps.integration_account_agreements_content_callback_url</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `agreementName, api-version, integrationAccountName, resourceGroupName, subscriptionId` |
