...
Creates, updates, deletes, gets or lists a <code>integration_account_assemblies_content_callback_urls</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="assemblyArtifactName, integrationAccountName, resourceGroupName, subscriptionId" /> | Get the content callback url for an integration account assembly. |
