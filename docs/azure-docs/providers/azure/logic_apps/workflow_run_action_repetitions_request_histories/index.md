...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="actionName, repetitionName, requestHistoryName, resourceGroupName, runName, subscriptionId, workflowName" /> | Gets a workflow run repetition request history. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="actionName, repetitionName, resourceGroupName, runName, subscriptionId, workflowName" /> | List a workflow run repetition request history. |
...
type,
workflowName
FROM azure.logic_apps.vw_workflow_run_action_repetitions_request_histories
