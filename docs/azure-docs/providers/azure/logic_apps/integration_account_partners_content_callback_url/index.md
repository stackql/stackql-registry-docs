...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.logic_apps.integration_account_partners_content_callback_url" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="api-version, integrationAccountName, partnerName, resourceGroupName, subscriptionId" /> |
