...
Creates, updates, deletes, gets or lists a <code>integration_account_maps_content_callback_urls</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="integrationAccountName, mapName, resourceGroupName, subscriptionId" /> | Get the content callback url. |
