...
<tr><td><b>Id</b></td><td><code>azure.logic_apps.workflow_triggers_callback_url</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `api-version, resourceGroupName, subscriptionId, triggerName, workflowName` |
