...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="actionName, repetitionName, resourceGroupName, runName, subscriptionId, workflowName" /> | Get a workflow run action repetition. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="actionName, resourceGroupName, runName, subscriptionId, workflowName" /> | Get all of a workflow run action repetitions. |
