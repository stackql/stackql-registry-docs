...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.migrate_projects.databases_database" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="api-version, databaseName, migrateProjectName, resourceGroupName, subscriptionId" /> |
