...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.service_map.ports_liveness" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="machineName, portName, resourceGroupName, subscriptionId, workspaceName" /> |
