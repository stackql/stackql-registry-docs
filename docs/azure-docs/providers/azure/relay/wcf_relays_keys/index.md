...
<tr><td><b>Id</b></td><td><code>azure.relay.wcf_relays_keys</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `authorizationRuleName, namespaceName, relayName, resourceGroupName, subscriptionId` |
