...
<tr><td><b>Id</b></td><td><code>azure.purview.ingestion_private_endpoint_connections_status</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `update` | `EXEC` | `accountName, api-version, resourceGroupName, subscriptionId` |
