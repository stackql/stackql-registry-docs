...
Creates, updates, deletes, gets or lists a <code>internal_networks_static_route_bfd_administrative_states</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="internalNetworkName, l3IsolationDomainName, resourceGroupName, subscriptionId" /> | Update Static Route BFD administrative state for internalNetwork. |
