...
| <CopyableCode code="_list_by_share" /> | `EXEC` | <CopyableCode code="accountName, api-version, resourceGroupName, shareName, subscriptionId" /> | List share subscriptions in a provider share |
