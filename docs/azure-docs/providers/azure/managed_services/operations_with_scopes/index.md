...
Creates, updates, deletes, gets or lists a <code>operations_with_scopes</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="scope" /> | Gets a list of the operations with the scope. |
