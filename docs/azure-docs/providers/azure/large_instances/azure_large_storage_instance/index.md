...
| <CopyableCode code="_list_by_resource_group" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId" /> | Gets a list of AzureLargeStorageInstances in the specified subscription and<br />resource group. The operations returns various properties of each Azure<br />LargeStorage instance. |
| <CopyableCode code="_list_by_subscription" /> | `EXEC` | <CopyableCode code="subscriptionId" /> | Gets a list of AzureLargeStorageInstances in the specified subscription. The<br />operations returns various properties of each Azure LargeStorage instance. |
