...
| <CopyableCode code="_list_by_storage_sync_service" /> | `EXEC` | <CopyableCode code="resourceGroupName, storageSyncServiceName, subscriptionId" /> | Get a PrivateEndpointConnection List. |
