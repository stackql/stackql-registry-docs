...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, provisioningServiceName, resourceGroupName, subscriptionId" /> | Get all the certificates tied to the provisioning service. |
