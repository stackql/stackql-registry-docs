...
<tr><td><b>Id</b></td><td><code>azure.iot_hub_device_provisioning.iot_dps_resource_private_endpoint_connection</code></td></tr>
</tbody></table>
...
| `create_or_update` | `INSERT` | `api-version, privateEndpointConnectionName, resourceGroupName, resourceName, subscriptionId, data__properties` | Create or update the status of a private endpoint connection with the specified name |
