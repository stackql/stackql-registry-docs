...
|:-----|:---------|:------------|
| <CopyableCode code="nextLink" /> | `string` | The link used to get the next page of IoT Central application templates. |
| <CopyableCode code="value" /> | `array` | A list of IoT Central Application Templates. |
## Methods
