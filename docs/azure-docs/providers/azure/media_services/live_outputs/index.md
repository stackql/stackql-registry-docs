...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="accountName, api-version, liveEventName, resourceGroupName, subscriptionId" /> | Lists the live outputs of a live event. |
