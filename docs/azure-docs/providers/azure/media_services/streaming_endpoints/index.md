...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="accountName, api-version, resourceGroupName, subscriptionId" /> | Lists the streaming endpoints in the account. |
| <CopyableCode code="_skus" /> | `EXEC` | <CopyableCode code="accountName, api-version, resourceGroupName, streamingEndpointName, subscriptionId" /> | List streaming endpoint supported skus. |
