...
| <CopyableCode code="_list_by_mobile_network" /> | `EXEC` | <CopyableCode code="mobileNetworkName, resourceGroupName, subscriptionId" /> | Gets all the SIM policies in a mobile network. |
