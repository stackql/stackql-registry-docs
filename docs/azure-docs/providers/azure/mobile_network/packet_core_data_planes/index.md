...
| <CopyableCode code="_list_by_packet_core_control_plane" /> | `EXEC` | <CopyableCode code="packetCoreControlPlaneName, resourceGroupName, subscriptionId" /> | Lists all the packet core data planes associated with a packet core control plane. |
