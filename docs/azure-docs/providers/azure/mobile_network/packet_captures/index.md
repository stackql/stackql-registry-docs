...
| <CopyableCode code="_list_by_packet_core_control_plane" /> | `EXEC` | <CopyableCode code="packetCoreControlPlaneName, resourceGroupName, subscriptionId" /> | Lists all the packet capture sessions under a packet core control plane. |
