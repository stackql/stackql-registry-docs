...
| <CopyableCode code="_list_by_mobile_network" /> | `EXEC` | <CopyableCode code="mobileNetworkName, resourceGroupName, subscriptionId" /> | Lists all sites in the mobile network. |
