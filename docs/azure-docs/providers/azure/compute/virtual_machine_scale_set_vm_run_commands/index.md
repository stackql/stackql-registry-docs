...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="instanceId, resourceGroupName, subscriptionId, vmScaleSetName" /> | The operation to get all run commands of an instance in Virtual Machine Scaleset. |
