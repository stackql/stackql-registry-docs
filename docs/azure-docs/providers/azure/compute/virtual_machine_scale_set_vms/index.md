...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId, virtualMachineScaleSetName" /> | Gets a list of all virtual machines in a VM scale sets. |
