...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="instanceId, resourceGroupName, subscriptionId, vmScaleSetName" /> | The operation to get all extensions of an instance in Virtual Machine Scaleset. |
