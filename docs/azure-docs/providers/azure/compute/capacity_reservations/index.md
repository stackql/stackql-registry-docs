...
| `_list_by_capacity_reservation_group` | `EXEC` | `capacityReservationGroupName, resourceGroupName, subscriptionId` | Lists all of the capacity reservations in the specified capacity reservation group. Use the nextLink property in the response to get the next page of capacity reservations. |
| `update` | `EXEC` | `capacityReservationGroupName, capacityReservationName, resourceGroupName, subscriptionId` | The operation to update a capacity reservation. |
