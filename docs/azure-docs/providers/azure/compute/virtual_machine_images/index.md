...
| <CopyableCode code="_list_by_edge_zone" /> | `EXEC` | <CopyableCode code="edgeZone, location, subscriptionId" /> | Gets a list of all virtual machine image versions for the specified edge zone |
