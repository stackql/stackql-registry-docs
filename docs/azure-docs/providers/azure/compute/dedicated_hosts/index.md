...
| <CopyableCode code="_list_by_host_group" /> | `EXEC` | <CopyableCode code="hostGroupName, resourceGroupName, subscriptionId" /> | Lists all of the dedicated hosts in the specified dedicated host group. Use the nextLink property in the response to get the next page of dedicated hosts. |
