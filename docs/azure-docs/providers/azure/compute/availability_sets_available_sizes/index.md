...
<tr><td><b>Id</b></td><td><code>azure.compute.availability_sets_available_sizes</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `availabilitySetName, resourceGroupName, subscriptionId` |
| `_list` | `EXEC` | `availabilitySetName, resourceGroupName, subscriptionId` |
