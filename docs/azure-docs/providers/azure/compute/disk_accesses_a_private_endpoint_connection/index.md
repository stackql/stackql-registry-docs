...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.compute.disk_accesses_a_private_endpoint_connection" /></td></tr>
</tbody></table>
...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="diskAccessName, privateEndpointConnectionName, resourceGroupName, subscriptionId" /> | Approve or reject a private endpoint connection under disk access resource, this can't be used to create a new private endpoint connection. |
