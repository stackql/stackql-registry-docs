...
| <CopyableCode code="_list_by_restore_point" /> | `EXEC` | <CopyableCode code="resourceGroupName, restorePointCollectionName, subscriptionId, vmRestorePointName" /> | Lists diskRestorePoints under a vmRestorePoint. |
