...
| <CopyableCode code="_list_by_gallery_application" /> | `EXEC` | <CopyableCode code="galleryApplicationName, galleryName, resourceGroupName, subscriptionId" /> | List gallery Application Versions in a gallery Application Definition. |
