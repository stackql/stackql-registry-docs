...
<tr><td><b>Id</b></td><td><code>azure.compute.virtual_machine_images_edge_zone_skus</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `edgeZone, location, offer, publisherName, subscriptionId` |
