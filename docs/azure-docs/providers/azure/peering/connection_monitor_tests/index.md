...
| <CopyableCode code="_list_by_peering_service" /> | `EXEC` | <CopyableCode code="peeringServiceName, resourceGroupName, subscriptionId" /> | Lists all connection monitor tests under the given subscription, resource group and peering service. |
