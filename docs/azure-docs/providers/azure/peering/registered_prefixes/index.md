...
| <CopyableCode code="_list_by_peering" /> | `EXEC` | <CopyableCode code="peeringName, resourceGroupName, subscriptionId" /> | Lists all registered prefixes under the given subscription, resource group and peering. |
