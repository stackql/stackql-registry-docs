...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="assignmentName, resourceScope" /> | List operations for given blueprint assignment within a subscription or a management group. |
