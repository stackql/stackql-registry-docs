...
<tr><td><b>Id</b></td><td><code>azure.blueprints.assignment_operations</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `assignmentName, resourceScope` | List operations for given blueprint assignment within a subscription or a management group. |
