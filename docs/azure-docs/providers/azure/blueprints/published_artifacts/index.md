...
<tr><td><b>Id</b></td><td><code>azure.blueprints.published_artifacts</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `blueprintName, resourceScope, versionId` | List artifacts for a version of a published blueprint definition. |
