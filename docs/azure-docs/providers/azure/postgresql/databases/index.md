...
| <CopyableCode code="create" /> | `INSERT` | <CopyableCode code="databaseName, resourceGroupName, serverName, subscriptionId" /> | Creates a new database or updates an existing database. |
