...
| <CopyableCode code="_list_by_target_server" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId, targetDbServerName" /> | List all the migrations on a given target server. |
