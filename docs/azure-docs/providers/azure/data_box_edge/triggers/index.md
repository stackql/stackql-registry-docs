...
| <CopyableCode code="_list_by_data_box_edge_device" /> | `EXEC` | <CopyableCode code="deviceName, resourceGroupName, subscriptionId" /> | Lists all the triggers configured in the device. |
