...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="deviceName, resourceGroupName, roleName, subscriptionId" /> |
| <CopyableCode code="exec_get" /> | `EXEC` | <CopyableCode code="deviceName, resourceGroupName, roleName, subscriptionId" /> |
