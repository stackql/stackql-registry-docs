...
| <CopyableCode code="_list_by_data_box_edge_device" /> | `EXEC` | <CopyableCode code="deviceName, resourceGroupName, subscriptionId" /> | Gets all the users registered on a Data Box Edge/Data Box Gateway device. |
