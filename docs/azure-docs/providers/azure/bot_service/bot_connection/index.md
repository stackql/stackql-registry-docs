...
| <CopyableCode code="_list_by_bot_service" /> | `EXEC` | <CopyableCode code="resourceGroupName, resourceName, subscriptionId" /> | Returns all the Connection Settings registered to a particular BotService resource |
