...
| <CopyableCode code="display" /> | `object` | The operation supported by Bot Service Management. |
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | Lists all the available BotService operations. |
