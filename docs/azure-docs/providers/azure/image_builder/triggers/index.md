...
| <CopyableCode code="_list_by_image_template" /> | `EXEC` | <CopyableCode code="imageTemplateName, resourceGroupName, subscriptionId" /> | List all triggers for the specified Image Template resource |
