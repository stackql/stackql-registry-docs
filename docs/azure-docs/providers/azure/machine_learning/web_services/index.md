...
| <CopyableCode code="_list_by_resource_group" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId" /> | Gets the web services in the specified resource group. |
| <CopyableCode code="_list_by_subscription_id" /> | `EXEC` | <CopyableCode code="subscriptionId" /> | Gets the web services in the specified subscription. |
