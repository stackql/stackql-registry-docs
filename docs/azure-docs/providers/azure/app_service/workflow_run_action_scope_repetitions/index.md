...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="actionName, name, resourceGroupName, runName, subscriptionId, workflowName" /> | List the workflow run action scoped repetitions. |
