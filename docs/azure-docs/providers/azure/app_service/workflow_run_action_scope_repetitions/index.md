...
<tr><td><b>Id</b></td><td><code>azure.app_service.workflow_run_action_scope_repetitions</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `actionName, name, resourceGroupName, runName, subscriptionId, workflowName` | List the workflow run action scoped repetitions. |
