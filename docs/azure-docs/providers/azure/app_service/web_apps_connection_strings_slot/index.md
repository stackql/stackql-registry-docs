...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.web_apps_connection_strings_slot" /></td></tr>
</tbody></table>
...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="name, resourceGroupName, slot, subscriptionId" /> | Description for Replaces the connection strings of an app. |
