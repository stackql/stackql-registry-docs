...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.certificate_orders_certificate" /></td></tr>
</tbody></table>
...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="certificateOrderName, name, resourceGroupName, subscriptionId" /> | Description for Creates or updates a certificate and associates with key vault secret. |
