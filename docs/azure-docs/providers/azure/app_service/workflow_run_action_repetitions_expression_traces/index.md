...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="actionName, name, repetitionName, resourceGroupName, runName, subscriptionId, workflowName" /> | Lists a workflow run expression trace. |
