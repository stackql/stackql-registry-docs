...
<tr><td><b>Id</b></td><td><code>azure.app_service.workflow_run_action_repetitions_expression_traces</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `actionName, name, repetitionName, resourceGroupName, runName, subscriptionId, workflowName` |
