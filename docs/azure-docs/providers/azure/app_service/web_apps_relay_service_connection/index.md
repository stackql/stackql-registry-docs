...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.web_apps_relay_service_connection" /></td></tr>
</tbody></table>
...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="entityName, name, resourceGroupName, subscriptionId" /> | Description for Creates a new hybrid connection configuration (PUT), or updates an existing one (PATCH). |
