...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.web_apps_source_control" /></td></tr>
</tbody></table>
...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="name, resourceGroupName, subscriptionId" /> | Description for Updates the source control configuration of an app. |
