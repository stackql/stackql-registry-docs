...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.web_apps_vnet_connection_gateway" /></td></tr>
</tbody></table>
...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="gatewayName, name, resourceGroupName, subscriptionId, vnetName" /> | Description for Adds a gateway to a connected Virtual Network (PUT) or updates it (PATCH). |
