...
<tr><td><b>Id</b></td><td><code>azure.app_service.environments_multi_role_pool_instance_metric_definitions</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `instance, name, resourceGroupName, subscriptionId` |
| `_list` | `EXEC` | `instance, name, resourceGroupName, subscriptionId` |
