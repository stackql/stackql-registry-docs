...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="name, processId, resourceGroupName, subscriptionId" /> | Description for Get a memory dump of a process by its ID for a specific scaled-out instance in a web site. |
...
FROM azure.app_service.process_dumps
WHERE name = '{{ name }}'
