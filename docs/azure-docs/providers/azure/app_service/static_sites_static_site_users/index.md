...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.static_sites_static_site_users" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="authprovider, name, resourceGroupName, subscriptionId" /> |
