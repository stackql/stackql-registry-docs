...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.web_apps_scm_allowed_slot" /></td></tr>
</tbody></table>
...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="name, resourceGroupName, slot, subscriptionId" /> | Description for Updates whether user publishing credentials are allowed on the site or not. |
