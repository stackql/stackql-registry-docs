...
|:-----|:---------|:------------|
| <CopyableCode code="name" /> | `string` | Name of the SKU capability. |
| <CopyableCode code="reason" /> | `string` | Reason of the SKU capability. |
| <CopyableCode code="value" /> | `string` | Value of the SKU capability. |
## Methods
