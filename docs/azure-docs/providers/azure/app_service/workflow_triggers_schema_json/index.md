...
<tr><td><b>Id</b></td><td><code>azure.app_service.workflow_triggers_schema_json</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `name, resourceGroupName, subscriptionId, triggerName, workflowName` |
