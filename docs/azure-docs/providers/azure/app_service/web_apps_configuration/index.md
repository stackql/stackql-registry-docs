...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.web_apps_configuration" /></td></tr>
</tbody></table>
...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="name, resourceGroupName, subscriptionId" /> | Description for Updates the configuration of an app. |
