...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.web_apps_vnet_connection" /></td></tr>
</tbody></table>
...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="name, resourceGroupName, subscriptionId, vnetName" /> | Description for Adds a Virtual Network connection to an app or slot (PUT) or updates the connection properties (PATCH). |
