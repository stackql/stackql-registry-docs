...
<tr><td><b>Id</b></td><td><code>azure.app_service.static_sites_user_provided_function_app_for_static_site_build</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `environmentName, functionAppName, name, resourceGroupName, subscriptionId` |
