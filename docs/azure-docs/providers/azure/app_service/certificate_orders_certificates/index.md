...
<tr><td><b>Id</b></td><td><code>azure.app_service.certificate_orders_certificates</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `certificateOrderName, resourceGroupName, subscriptionId` |
| `_list` | `EXEC` | `certificateOrderName, resourceGroupName, subscriptionId` |
