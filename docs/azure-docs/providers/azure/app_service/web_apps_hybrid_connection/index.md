...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.app_service.web_apps_hybrid_connection" /></td></tr>
</tbody></table>
...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="name, namespaceName, relayName, resourceGroupName, subscriptionId" /> | Description for Creates a new Hybrid Connection using a Service Bus relay. |
