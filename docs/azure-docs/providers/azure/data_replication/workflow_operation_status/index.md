...
<tr><td><b>Id</b></td><td><code>azure.data_replication.workflow_operation_status</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `jobName, operationId, resourceGroupName, subscriptionId, vaultName` |
