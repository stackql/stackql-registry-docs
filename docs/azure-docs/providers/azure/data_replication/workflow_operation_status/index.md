...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="jobName, operationId, resourceGroupName, subscriptionId, vaultName" /> | Tracks the results of an asynchronous operation on the job. |
