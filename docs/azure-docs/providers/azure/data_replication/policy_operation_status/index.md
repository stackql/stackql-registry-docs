...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="operationId, policyName, resourceGroupName, subscriptionId, vaultName" /> | Tracks the results of an asynchronous operation on the policy. |
