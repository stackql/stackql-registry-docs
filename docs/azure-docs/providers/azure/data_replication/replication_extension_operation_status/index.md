...
<tr><td><b>Id</b></td><td><code>azure.data_replication.replication_extension_operation_status</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `operationId, replicationExtensionName, resourceGroupName, subscriptionId, vaultName` |
