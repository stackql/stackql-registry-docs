...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | Gets the operations. |
| <CopyableCode code="check_name_availability" /> | `EXEC` | <CopyableCode code="location, subscriptionId" /> | Checks the resource name availability. |
| <CopyableCode code="deployment_preflight" /> | `EXEC` | <CopyableCode code="deploymentId, resourceGroupName, subscriptionId" /> |  |
