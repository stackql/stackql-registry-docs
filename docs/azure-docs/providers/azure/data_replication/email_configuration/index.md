...
<tr><td><b>Id</b></td><td><code>azure.data_replication.email_configuration</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `resourceGroupName, subscriptionId, vaultName` | Gets the list of alert configuration settings for the given vault. |
