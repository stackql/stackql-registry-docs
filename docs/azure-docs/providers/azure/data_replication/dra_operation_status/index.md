...
<tr><td><b>Id</b></td><td><code>azure.data_replication.dra_operation_status</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `fabricAgentName, fabricName, operationId, resourceGroupName, subscriptionId` |
