...
<tr><td><b>Id</b></td><td><code>azure.data_replication.workflow</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `resourceGroupName, subscriptionId, vaultName` | Gets the list of jobs in the given vault. |
