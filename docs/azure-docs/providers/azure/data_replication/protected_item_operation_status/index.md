...
<tr><td><b>Id</b></td><td><code>azure.data_replication.protected_item_operation_status</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `operationId, protectedItemName, resourceGroupName, subscriptionId, vaultName` |
