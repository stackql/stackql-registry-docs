...
<tr><td><b>Id</b></td><td><code>azure.machine_learning_services.workspace_features</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `WorkspaceFeatures_List` | `SELECT` | `resourceGroupName, subscriptionId, workspaceName` |
