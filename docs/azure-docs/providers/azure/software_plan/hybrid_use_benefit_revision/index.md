...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.software_plan.hybrid_use_benefit_revision" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="planId, scope" /> |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="planId, scope" /> |
