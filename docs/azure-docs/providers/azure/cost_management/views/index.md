...
| <CopyableCode code="_list" /> | `EXEC` |  | Lists all views by tenant and object. |
| <CopyableCode code="_list_by_scope" /> | `EXEC` | <CopyableCode code="scope" /> | Lists all views at the given scope. |
