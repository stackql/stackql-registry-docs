...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cost_management.exports_execution_history" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="exportName, scope" /> |
| <CopyableCode code="_get" /> | `EXEC` | <CopyableCode code="exportName, scope" /> |
