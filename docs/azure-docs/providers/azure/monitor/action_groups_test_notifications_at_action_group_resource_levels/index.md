...
Creates, updates, deletes, gets or lists a <code>action_groups_test_notifications_at_action_group_resource_levels</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="actionGroupName, notificationId, resourceGroupName, subscriptionId" /> | Get the test notifications by the notification id |
