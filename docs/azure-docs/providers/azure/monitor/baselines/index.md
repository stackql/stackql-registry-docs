...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="interval, metricName, resourceUri, timespan" /> |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="interval, metricName, resourceUri, timespan" /> |
