...
| <CopyableCode code="_list_by_resource_group" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId" /> | Get a list of all Activity Log Alert rules in a resource group. |
| <CopyableCode code="_list_by_subscription_id" /> | `EXEC` | <CopyableCode code="subscriptionId" /> | Get a list of all Activity Log Alert rules in a subscription. |
