...
| <CopyableCode code="_list_by_alert_rule" /> | `EXEC` | <CopyableCode code="resourceGroupName, ruleName, subscriptionId" /> | Gets a list of incidents associated to an alert rule |
