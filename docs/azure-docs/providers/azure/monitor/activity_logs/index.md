...
Creates, updates, deletes, gets or lists a <code>activity_logs</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="$filter, subscriptionId" /> | Provides the list of records from the activity logs. |
