...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_service_endpoint_policies', value: 'view', },
        { label: 'service_endpoint_policies', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="contextual_service_endpoint_policies" /> | `text` | field from the `properties` object |
| <CopyableCode code="etag" /> | `text` | A unique read-only string that changes whenever the resource is updated. |
| <CopyableCode code="kind" /> | `text` | Kind of service endpoint policy. This is metadata used for the Azure portal experience. |
...
| <CopyableCode code="service_alias" /> | `text` | field from the `properties` object |
| <CopyableCode code="service_endpoint_policy_definitions" /> | `text` | field from the `properties` object |
...
| <CopyableCode code="update_tags" /> | `EXEC` | <CopyableCode code="resourceGroupName, serviceEndpointPolicyName, subscriptionId" /> | Updates tags of a service endpoint policy. |
...
Use the following StackQL query and manifest file to create a new <code>service_endpoint_policies</code> resource.
...
Deletes the specified <code>service_endpoint_policies</code> resource.
