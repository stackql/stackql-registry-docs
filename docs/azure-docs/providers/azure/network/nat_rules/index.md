...
| <CopyableCode code="_list_by_vpn_gateway" /> | `EXEC` | <CopyableCode code="gatewayName, resourceGroupName, subscriptionId" /> | Retrieves all nat rules for a particular virtual wan vpn gateway. |
