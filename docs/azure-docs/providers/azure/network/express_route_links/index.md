...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="expressRoutePortName, resourceGroupName, subscriptionId" /> | Retrieve the ExpressRouteLink sub-resources of the specified ExpressRoutePort resource. |
