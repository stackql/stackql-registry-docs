...
| <CopyableCode code="_list_by_route_filter" /> | `EXEC` | <CopyableCode code="resourceGroupName, routeFilterName, subscriptionId" /> | Gets all RouteFilterRules in a route filter. |
