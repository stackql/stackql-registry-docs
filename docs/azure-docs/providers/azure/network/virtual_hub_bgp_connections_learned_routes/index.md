...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="connectionName, hubName, resourceGroupName, subscriptionId" /> | Retrieves a list of routes the virtual hub bgp connection has learned. |
