...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` |  | Get a specified connection created by this subscription. |
...
| <CopyableCode code="create_or_update" /> | `INSERT` |  | Create a network manager connection on this subscription. |
| <CopyableCode code="delete" /> | `DELETE` |  | Delete specified connection created by this subscription. |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="subscriptionId" /> | List all network manager connections created by this subscription. |
