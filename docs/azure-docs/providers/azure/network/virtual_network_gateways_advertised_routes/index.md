...
<tr><td><b>Id</b></td><td><code>azure.network.virtual_network_gateways_advertised_routes</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `peer, resourceGroupName, subscriptionId, virtualNetworkGatewayName` |
