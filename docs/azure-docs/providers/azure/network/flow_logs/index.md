...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="networkWatcherName, resourceGroupName, subscriptionId" /> | Lists all flow log resources for the specified Network Watcher. |
