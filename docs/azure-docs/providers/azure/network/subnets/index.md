...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_subnets', value: 'view', },
        { label: 'subnets', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="address_prefixes" /> | `text` | field from the `properties` object |
| <CopyableCode code="application_gateway_ip_configurations" /> | `text` | field from the `properties` object |
| <CopyableCode code="default_outbound_access" /> | `text` | field from the `properties` object |
| <CopyableCode code="delegations" /> | `text` | field from the `properties` object |
| <CopyableCode code="etag" /> | `text` | A unique read-only string that changes whenever the resource is updated. |
| <CopyableCode code="ip_allocations" /> | `text` | field from the `properties` object |
| <CopyableCode code="ip_configuration_profiles" /> | `text` | field from the `properties` object |
...
| <CopyableCode code="private_endpoint_network_policies" /> | `text` | field from the `properties` object |
| <CopyableCode code="private_endpoints" /> | `text` | field from the `properties` object |
| <CopyableCode code="private_link_service_network_policies" /> | `text` | field from the `properties` object |
| <CopyableCode code="provisioning_state" /> | `text` | field from the `properties` object |
| <CopyableCode code="purpose" /> | `text` | field from the `properties` object |
| <CopyableCode code="resourceGroupName" /> | `text` | field from the `properties` object |
| <CopyableCode code="resource_navigation_links" /> | `text` | field from the `properties` object |
| <CopyableCode code="route_table" /> | `text` | field from the `properties` object |
| <CopyableCode code="service_association_links" /> | `text` | field from the `properties` object |
| <CopyableCode code="service_endpoint_policies" /> | `text` | field from the `properties` object |
| <CopyableCode code="service_endpoints" /> | `text` | field from the `properties` object |
| <CopyableCode code="sharing_scope" /> | `text` | field from the `properties` object |
| <CopyableCode code="subnetName" /> | `text` | field from the `properties` object |
...
Use the following StackQL query and manifest file to create a new <code>subnets</code> resource.
...
Deletes the specified <code>subnets</code> resource.
