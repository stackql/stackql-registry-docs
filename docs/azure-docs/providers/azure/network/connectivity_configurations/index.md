...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="networkManagerName, resourceGroupName, subscriptionId" /> | Lists all the network manager connectivity configuration in a specified network manager. |
