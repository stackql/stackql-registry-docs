...
|:-----|:--------------|:----------------|:------------|
| `NetworkInterfaceIPConfigurations_Get` | `SELECT` | `ipConfigurationName, networkInterfaceName, resourceGroupName, subscriptionId` | Gets the specified network interface ip configuration. |
