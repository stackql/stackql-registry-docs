...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="networkSecurityGroupName, resourceGroupName, subscriptionId" /> | Gets all security rules in a network security group. |
