...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.network.application_gateways_ssl_predefined_policy" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="predefinedPolicyName, subscriptionId" /> |
