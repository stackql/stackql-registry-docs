...
| <CopyableCode code="bgp_communities" /> | `text` | field from the `properties` object |
| <CopyableCode code="ddos_protection_plan" /> | `text` | field from the `properties` object |
| <CopyableCode code="dhcp_options" /> | `text` | field from the `properties` object |
| <CopyableCode code="enable_ddos_protection" /> | `text` | field from the `properties` object |
| <CopyableCode code="enable_vm_protection" /> | `text` | field from the `properties` object |
...
| <CopyableCode code="flow_timeout_in_minutes" /> | `text` | field from the `properties` object |
| <CopyableCode code="ip_allocations" /> | `text` | field from the `properties` object |
| <CopyableCode code="location" /> | `text` | Resource location. |
| <CopyableCode code="private_endpoint_v_net_policies" /> | `text` | field from the `properties` object |
...
| <CopyableCode code="virtual_network_peerings" /> | `text` | field from the `properties` object |
</TabItem>
...
| <CopyableCode code="list_all" /> | `SELECT` | <CopyableCode code="subscriptionId" /> | Gets all virtual networks in a subscription. |
...
| <CopyableCode code="update_tags" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId, virtualNetworkName" /> | Updates a virtual network tags. |
