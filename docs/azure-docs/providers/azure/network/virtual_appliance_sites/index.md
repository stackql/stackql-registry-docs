...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="networkVirtualApplianceName, resourceGroupName, subscriptionId" /> | Lists all Network Virtual Appliance Sites in a Network Virtual Appliance resource. |
