...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="privateEndpointName, resourceGroupName, subscriptionId" /> | Gets all private dns zone groups in a private endpoint. |
