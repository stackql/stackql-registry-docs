...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="networkInterfaceName, resourceGroupName, subscriptionId" /> | Get all Tap configurations in a network interface. |
