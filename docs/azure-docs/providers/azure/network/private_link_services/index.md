...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_private_link_services', value: 'view', },
        { label: 'private_link_services', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="auto_approval" /> | `text` | field from the `properties` object |
| <CopyableCode code="destination_ip_address" /> | `text` | field from the `properties` object |
| <CopyableCode code="enable_proxy_protocol" /> | `text` | field from the `properties` object |
...
| <CopyableCode code="load_balancer_frontend_ip_configurations" /> | `text` | field from the `properties` object |
...
Use the following StackQL query and manifest file to create a new <code>private_link_services</code> resource.
...
Deletes the specified <code>private_link_services</code> resource.
