...
Creates, updates, deletes, gets or lists a <code>admin_rule_collections</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_admin_rule_collections', value: 'view', },
        { label: 'admin_rule_collections', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="configurationName, networkManagerName, resourceGroupName, ruleCollectionName, subscriptionId" /> | Gets a network manager security admin configuration rule collection. |
...
| <CopyableCode code="create_or_update" /> | `INSERT` | <CopyableCode code="configurationName, networkManagerName, resourceGroupName, ruleCollectionName, subscriptionId" /> | Creates or updates an admin rule collection. |
| <CopyableCode code="delete" /> | `DELETE` | <CopyableCode code="configurationName, networkManagerName, resourceGroupName, ruleCollectionName, subscriptionId" /> | Deletes an admin rule collection. |
...
system_data,
type
FROM azure.network.vw_admin_rule_collections
...
Use the following StackQL query and manifest file to create a new <code>admin_rule_collections</code> resource.
...
Deletes the specified <code>admin_rule_collections</code> resource.
