...
<tr><td><b>Id</b></td><td><code>azure.network.public_ip_addresses_virtual_machine_scale_set_public_ip_addresses</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `api-version, resourceGroupName, subscriptionId, virtualMachineScaleSetName` |
| `_list` | `EXEC` | `api-version, resourceGroupName, subscriptionId, virtualMachineScaleSetName` |
