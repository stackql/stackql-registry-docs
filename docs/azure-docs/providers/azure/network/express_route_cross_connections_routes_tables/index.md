...
Creates, updates, deletes, gets or lists a <code>express_route_cross_connections_routes_tables</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="crossConnectionName, devicePath, peeringName, resourceGroupName, subscriptionId" /> | Gets the currently advertised routes table associated with the express route cross connection in a resource group. |
