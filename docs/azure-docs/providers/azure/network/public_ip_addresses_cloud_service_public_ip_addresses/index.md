...
<tr><td><b>Id</b></td><td><code>azure.network.public_ip_addresses_cloud_service_public_ip_addresses</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `api-version, cloudServiceName, resourceGroupName, subscriptionId` |
| `_list` | `EXEC` | `api-version, cloudServiceName, resourceGroupName, subscriptionId` |
