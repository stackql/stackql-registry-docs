...
Creates, updates, deletes, gets or lists a <code>available_delegations</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="location, subscriptionId" /> | Gets all of the available subnet delegations for this subscription in this region. |
