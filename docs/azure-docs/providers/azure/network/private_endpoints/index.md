...
| <CopyableCode code="custom_dns_configs" /> | `text` | field from the `properties` object |
| <CopyableCode code="custom_network_interface_name" /> | `text` | field from the `properties` object |
...
| <CopyableCode code="private_link_service_connections" /> | `text` | field from the `properties` object |
