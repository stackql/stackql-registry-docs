...
Creates, updates, deletes, gets or lists a <code>artifact_stores_private_end_points</code> resource.
...
|:-----|:---------|:------------|
| <CopyableCode code="manualPrivateEndPointConnections" /> | `array` | list of private endpoints. |

## Methods
| Name | Accessible by | Required Params | Description |
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="artifactStoreName, publisherName, resourceGroupName, subscriptionId" /> | List manual private endpoints on artifact stores |
