...
| <CopyableCode code="_list_by_network_service_design_group" /> | `EXEC` | <CopyableCode code="networkServiceDesignGroupName, publisherName, resourceGroupName, subscriptionId" /> | Gets information about a list of network service design versions under a network service design group. |
