...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_network_function_definition_groups', value: 'view', },
        { label: 'network_function_definition_groups', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="networkFunctionDefinitionGroupName, publisherName, resourceGroupName, subscriptionId" /> | Updates a network function definition group resource. |
...
Use the following StackQL query and manifest file to create a new <code>network_function_definition_groups</code> resource.
...
Updates a <code>network_function_definition_groups</code> resource.
...
Deletes the specified <code>network_function_definition_groups</code> resource.
