...
| <CopyableCode code="_list_by_database" /> | `EXEC` | <CopyableCode code="clusterName, databaseName, resourceGroupName, subscriptionId" /> | Returns the list of data connections of the given Kusto database. |
