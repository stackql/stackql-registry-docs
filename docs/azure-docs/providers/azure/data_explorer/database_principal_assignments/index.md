...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="clusterName, databaseName, resourceGroupName, subscriptionId" /> | Lists all Kusto cluster database principalAssignments. |
