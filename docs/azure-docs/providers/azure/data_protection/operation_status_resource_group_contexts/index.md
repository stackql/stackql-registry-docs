...
Creates, updates, deletes, gets or lists a <code>operation_status_resource_group_contexts</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_operation_status_resource_group_contexts', value: 'view', },
        { label: 'operation_status_resource_group_contexts', value: 'resource', },
    ]
}>
<TabItem value="view">
...
status,
subscriptionId
FROM azure.data_protection.vw_operation_status_resource_group_contexts
