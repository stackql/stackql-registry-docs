...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_configuration_profile_hci_assignments', value: 'view', },
        { label: 'configuration_profile_hci_assignments', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="clusterName, configurationProfileAssignmentName, resourceGroupName, subscriptionId" /> | Get information about a configuration profile assignment |
| <CopyableCode code="create_or_update" /> | `INSERT` | <CopyableCode code="clusterName, configurationProfileAssignmentName, resourceGroupName, subscriptionId" /> | Creates an association between a AzureStackHCI cluster and Automanage configuration profile |
| <CopyableCode code="delete" /> | `DELETE` | <CopyableCode code="clusterName, configurationProfileAssignmentName, resourceGroupName, subscriptionId" /> | Delete a configuration profile assignment |
...
Use the following StackQL query and manifest file to create a new <code>configuration_profile_hci_assignments</code> resource.
...
Deletes the specified <code>configuration_profile_hci_assignments</code> resource.
