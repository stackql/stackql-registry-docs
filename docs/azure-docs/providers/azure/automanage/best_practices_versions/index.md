...
<tr><td><b>Id</b></td><td><code>azure.automanage.best_practices_versions</code></td></tr>
</tbody></table>
...
| `_list_by_tenant` | `EXEC` | `bestPracticeName` | Retrieve a list of Automanage best practices versions |
