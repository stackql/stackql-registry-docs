...
| <CopyableCode code="_list_by_resource" /> | `EXEC` | <CopyableCode code="azureResourceName, resourceGroupName, subscriptionId" /> | Gets private endpoint connection for Power BI. |
