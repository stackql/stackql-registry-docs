...
| <CopyableCode code="update_tags" /> | `EXEC` | <CopyableCode code="privateEndpointConnectionName, resourceGroupName, serverName, subscriptionId" /> | Updates private endpoint connection with the specified tags. |
