...
| <CopyableCode code="isDataAction" /> | `boolean` | Is a data action. |
| <CopyableCode code="properties" /> | `object` | Properties of the operation |

## Methods
| Name | Accessible by | Required Params | Description |
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | List all of the available operations the Desktop Virtualization resource provider supports. |
