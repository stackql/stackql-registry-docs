...
<tr><td><b>Id</b></td><td><code>azure.desktop_virtualization.application_groups</code></td></tr>
</tbody></table>
...
| `_list_by_resource_group` | `EXEC` | `resourceGroupName, subscriptionId` | List applicationGroups. |
| `_list_by_subscription` | `EXEC` | `subscriptionId` | List applicationGroups in subscription. |
| `update` | `EXEC` | `applicationGroupName, resourceGroupName, subscriptionId` | Update an applicationGroup. |
