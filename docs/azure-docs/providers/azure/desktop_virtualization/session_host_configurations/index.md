...
<tr><td><b>Id</b></td><td><code>azure.desktop_virtualization.session_host_configurations</code></td></tr>
</tbody></table>
...
| `update` | `EXEC` | `hostPoolName, resourceGroupName, subscriptionId` | Update a SessionHostConfiguration. |
