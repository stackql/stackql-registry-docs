...
<tr><td><b>Id</b></td><td><code>azure.desktop_virtualization.user_sessions</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `hostPoolName, resourceGroupName, sessionHostName, subscriptionId` | List userSessions. |
| `_list_by_host_pool` | `EXEC` | `hostPoolName, resourceGroupName, subscriptionId` | List userSessions. |
