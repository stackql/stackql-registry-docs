...
<tr><td><b>Id</b></td><td><code>azure.desktop_virtualization.active_session_host_configurations</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `hostPoolName, resourceGroupName, subscriptionId` |
