...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="subscriptionId" /> | The List operation gets information about the deleted managed HSMs associated with the subscription. |
