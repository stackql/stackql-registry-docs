...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list_by_subscription" /> | `SELECT` | <CopyableCode code="location, subscriptionId" /> | Gets a list of all Search quota usages in the given subscription. |
| <CopyableCode code="_list_by_subscription" /> | `EXEC` | <CopyableCode code="location, subscriptionId" /> | Gets a list of all Search quota usages in the given subscription. |
