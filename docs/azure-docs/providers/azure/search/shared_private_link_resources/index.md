...
| <CopyableCode code="properties" /> | `object` | Describes the properties of an existing Shared Private Link Resource managed by the search service. |
...
| <CopyableCode code="_list_by_service" /> | `EXEC` | <CopyableCode code="resourceGroupName, searchServiceName, subscriptionId" /> | Gets a list of all shared private link resources managed by the given service. |
