...
| <CopyableCode code="properties" /> | `object` | Password hash properties |
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list_by_firmware" /> | `SELECT` | <CopyableCode code="firmwareId, resourceGroupName, subscriptionId, workspaceName" /> | Lists password hash analysis results of a firmware. |
