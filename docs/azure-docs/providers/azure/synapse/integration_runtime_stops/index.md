...
Creates, updates, deletes, gets or lists a <code>integration_runtime_stops</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="integrationRuntimeName, integrationRuntimeOperationId, resourceGroupName, subscriptionId, workspaceName" /> | Get an integration runtime stop operation status |
