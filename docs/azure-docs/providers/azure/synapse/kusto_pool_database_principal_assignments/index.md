...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_kusto_pool_database_principal_assignments', value: 'view', },
        { label: 'kusto_pool_database_principal_assignments', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>kusto_pool_database_principal_assignments</code> resource.
...
Deletes the specified <code>kusto_pool_database_principal_assignments</code> resource.
