...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="resourceGroupName, sqlPoolName, subscriptionId, workloadGroupName, workspaceName" /> | Get list of  Sql pool's workload classifier for workload groups. |
