...
<tr><td><b>Id</b></td><td><code>azure.synapse.integration_runtimes_outbound_network_dependencies_endpoints</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `integrationRuntimeName, resourceGroupName, subscriptionId, workspaceName` |
