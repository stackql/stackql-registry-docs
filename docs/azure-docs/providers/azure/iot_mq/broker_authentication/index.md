...
| <CopyableCode code="_list_by_broker_resource" /> | `EXEC` | <CopyableCode code="brokerName, mqName, resourceGroupName, subscriptionId" /> | List BrokerAuthenticationResource resources by BrokerResource |
