...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="api-version, clusterVersion, location, subscriptionId" /> | Gets information about an available Service Fabric managed cluster code version. |
