...
Creates, updates, deletes, gets or lists a <code>azure_ad_administrators</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_azure_ad_administrators', value: 'view', },
        { label: 'azure_ad_administrators', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="identity_resource_id" /> | `text` | field from the `properties` object |
...
| Name | Datatype | Description |
|:-----|:---------|:------------|
| <CopyableCode code="properties" /> | `object` | The properties of an administrator. |
</TabItem></Tabs>
...
Use the following StackQL query and manifest file to create a new <code>azure_ad_administrators</code> resource.
...
Deletes the specified <code>azure_ad_administrators</code> resource.
