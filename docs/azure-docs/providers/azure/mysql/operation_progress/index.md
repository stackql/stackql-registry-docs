...
Creates, updates, deletes, gets or lists a <code>operation_progress</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_operation_progress', value: 'view', },
        { label: 'operation_progress', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="properties" /> | `object` | Represents the response properties specific to the operation |
