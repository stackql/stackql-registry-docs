...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, groupName, projectName, serviceName, subscriptionId" /> | The project resource is a nested resource representing a stored migration project. This method returns a list of files owned by a project resource. |
