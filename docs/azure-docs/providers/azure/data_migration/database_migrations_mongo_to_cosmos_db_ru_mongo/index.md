...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_database_migrations_mongo_to_cosmos_db_ru_mongo', value: 'view', },
        { label: 'database_migrations_mongo_to_cosmos_db_ru_mongo', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>database_migrations_mongo_to_cosmos_db_ru_mongo</code> resource.
...
Deletes the specified <code>database_migrations_mongo_to_cosmos_db_ru_mongo</code> resource.
