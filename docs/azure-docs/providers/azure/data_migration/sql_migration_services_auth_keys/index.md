...
|:-----|:---------|:------------|
| <CopyableCode code="authKey1" /> | `string` | The first authentication key. |
| <CopyableCode code="authKey2" /> | `string` | The second authentication key. |

## Methods
| Name | Accessible by | Required Params | Description |
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="resourceGroupName, sqlMigrationServiceName, subscriptionId" /> | Retrieve the List of Authentication Keys for Self Hosted Integration Runtime. |
