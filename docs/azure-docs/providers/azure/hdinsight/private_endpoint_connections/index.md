...
| <CopyableCode code="create_or_update" /> | `INSERT` | <CopyableCode code="clusterName, privateEndpointConnectionName, resourceGroupName, subscriptionId" /> | Approve or reject a private endpoint connection manually. |
...
subscriptionId,
type
FROM azure.hdinsight.vw_private_endpoint_connections
