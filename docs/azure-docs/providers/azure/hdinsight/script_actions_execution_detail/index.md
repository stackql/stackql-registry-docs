...
<tr><td><b>Id</b></td><td><code>azure.hdinsight.script_actions_execution_detail</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `clusterName, resourceGroupName, scriptExecutionId, subscriptionId` |
