...
<tr><td><b>Id</b></td><td><code>azure.hdinsight.applications_azure_async_operation_status</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `applicationName, clusterName, operationId, resourceGroupName, subscriptionId` |
