...
| <CopyableCode code="_list_by_account" /> | `EXEC` | <CopyableCode code="accountName, resourceGroupName, subscriptionId" /> | Lists the Data Lake Store virtual network rules within the specified Data Lake Store account. |
