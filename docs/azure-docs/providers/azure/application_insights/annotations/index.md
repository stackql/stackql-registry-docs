...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="end, resourceGroupName, resourceName, start, subscriptionId" /> | Gets the list of annotations for a component for given time range |
