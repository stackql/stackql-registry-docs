...
| <CopyableCode code="_list_by_provider_registration" /> | `EXEC` | <CopyableCode code="providerNamespace, subscriptionId" /> | Gets the list of the rollouts for the given provider. |
