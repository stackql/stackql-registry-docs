...
Use the following StackQL query and manifest file to create a new <code>skus_nested_resource_type_firsts</code> resource.
...
Deletes the specified <code>skus_nested_resource_type_firsts</code> resource.
