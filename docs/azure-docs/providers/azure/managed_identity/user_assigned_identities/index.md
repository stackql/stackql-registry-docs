...
| <CopyableCode code="properties" /> | `object` | The properties associated with the user assigned identity. |
...
| <CopyableCode code="_list_by_resource_group" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId" /> | Lists all the userAssignedIdentities available under the specified ResourceGroup. |
| <CopyableCode code="_list_by_subscription" /> | `EXEC` | <CopyableCode code="subscriptionId" /> | Lists all the userAssignedIdentities available under the specified subscription. |
