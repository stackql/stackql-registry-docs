...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="clusterName, clusterResourceName, clusterRp, resourceGroupName, subscriptionId" /> | List all Extensions in the cluster. |
