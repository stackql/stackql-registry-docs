...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_commitment_plans', value: 'view', },
        { label: 'commitment_plans', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>commitment_plans</code> resource.
...
Deletes the specified <code>commitment_plans</code> resource.
