...
|:-----|:---------|:------------|
| <CopyableCode code="description" /> | `string` | Description of Content Filter. |
| <CopyableCode code="filterType" /> | `string` | Content Filter type. |
| <CopyableCode code="policyName" /> | `string` | Name of Content Filter. |
## Methods
