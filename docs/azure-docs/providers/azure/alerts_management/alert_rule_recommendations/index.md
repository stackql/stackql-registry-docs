...
Creates, updates, deletes, gets or lists a <code>alert_rule_recommendations</code> resource.
...
|:-----|:---------|:------------|
| <CopyableCode code="properties" /> | `object` | Describes the format of Alert Rule Recommendations response. |
