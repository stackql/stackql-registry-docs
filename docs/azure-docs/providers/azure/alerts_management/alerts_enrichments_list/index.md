...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.alerts_management.alerts_enrichments_list" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="alertId, scope" /> |
