...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | Lists all of the available RP operations. |
| <CopyableCode code="job_execution" /> | `EXEC` | <CopyableCode code="jobExecutionName, jobName, resourceGroupName, subscriptionId" /> |  |
