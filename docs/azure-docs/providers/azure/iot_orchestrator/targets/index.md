...
<tr><td><b>Id</b></td><td><code>azure.iot_orchestrator.targets</code></td></tr>
</tbody></table>
...
| `_list_by_resource_group` | `EXEC` | `resourceGroupName, subscriptionId` | List Target resources by resource group |
| `_list_by_subscription` | `EXEC` | `subscriptionId` | List Target resources by subscription ID |
| `update` | `EXEC` | `name, resourceGroupName, subscriptionId` | Update a Target |
