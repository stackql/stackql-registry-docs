...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_private_link_resources_comps', value: 'view', },
        { label: 'private_link_resources_comps', value: 'resource', },
    ]
}>
<TabItem value="view">
...
system_data,
type
FROM azure.security_and_compliance.vw_private_link_resources_comps
