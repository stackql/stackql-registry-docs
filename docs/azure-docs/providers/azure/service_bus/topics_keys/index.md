...
<tr><td><b>Id</b></td><td><code>azure.service_bus.topics_keys</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `authorizationRuleName, namespaceName, resourceGroupName, subscriptionId, topicName` |
