...
<tr><td><b>Id</b></td><td><code>azure.service_bus.disaster_recovery_configs_keys</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `alias, authorizationRuleName, namespaceName, resourceGroupName, subscriptionId` |
