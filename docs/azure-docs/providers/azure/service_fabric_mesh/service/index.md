...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, applicationResourceName, resourceGroupName, subscriptionId" /> | Gets the information about all services of an application resource. The information include the description and other properties of the Service. |
