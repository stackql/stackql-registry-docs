...
|:-----|:--------------|:----------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="api-version, applicationResourceName, codePackageName, replicaName, resourceGroupName, serviceResourceName, subscriptionId" /> |
