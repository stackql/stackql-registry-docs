...
<tr><td><b>Id</b></td><td><code>azure.device_update.private_endpoint_connection_proxies_private_endpoint_properties</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `update` | `EXEC` | `accountName, privateEndpointConnectionProxyId, resourceGroupName, subscriptionId` |
