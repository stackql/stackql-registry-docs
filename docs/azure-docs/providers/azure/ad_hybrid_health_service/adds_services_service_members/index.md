...
Creates, updates, deletes, gets or lists a <code>adds_services_service_members</code> resource.
...
| <CopyableCode code="add" /> | `EXEC` | <CopyableCode code="serviceName" /> | Onboards  a server, for a given Active Directory Domain Controller service, to Azure Active Directory Connect Health Service. |
