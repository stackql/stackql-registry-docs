...
<tr><td><b>Id</b></td><td><code>azure.ad_hybrid_health_service.service_members</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| `get` | `SELECT` | `serviceMemberId, serviceName` | Gets the details of a server, for a given service, that are onboarded to Azure Active Directory Connect Health Service. |
| `list` | `SELECT` | `serviceName` | Gets the details of the servers, for a given service, that are onboarded to Azure Active Directory Connect Health Service. |
| `add` | `INSERT` | `serviceName` | Onboards  a server, for a given service, to Azure Active Directory Connect Health Service. |
| `delete` | `DELETE` | `serviceMemberId, serviceName` | Deletes a server that has been onboarded to Azure Active Directory Connect Health Service. |
| `_list` | `EXEC` | `serviceName` | Gets the details of the servers, for a given service, that are onboarded to Azure Active Directory Connect Health Service. |
