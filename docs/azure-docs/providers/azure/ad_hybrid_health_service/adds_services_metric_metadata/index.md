...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="metricName, serviceName" /> | Gets the service related metric information. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="serviceName" /> | Gets the service related metrics information. |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="serviceName" /> | Gets the service related metrics information. |
