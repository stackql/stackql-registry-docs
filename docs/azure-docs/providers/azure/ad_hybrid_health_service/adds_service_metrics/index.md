...
Creates, updates, deletes, gets or lists a <code>adds_service_metrics</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="groupName, metricName, serviceName" /> | Gets the server related metrics for a given metric and group combination. |
