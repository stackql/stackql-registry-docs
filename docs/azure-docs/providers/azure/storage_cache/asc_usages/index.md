...
Creates, updates, deletes, gets or lists a <code>asc_usages</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="location, subscriptionId" /> | Gets the quantity used and quota limit for resources |
