...
Creates, updates, deletes, gets or lists a <code>iis_web_applications_controllers</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_iis_web_applications_controllers', value: 'view', },
        { label: 'iis_web_applications_controllers', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="resourceGroupName, siteName, subscriptionId, webAppSiteName, webApplicationName" /> | Method to update tags on IIS web application. |
...
Updates a <code>iis_web_applications_controllers</code> resource.
