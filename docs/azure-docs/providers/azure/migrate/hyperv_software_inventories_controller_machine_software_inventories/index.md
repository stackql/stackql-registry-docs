...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_hyperv_software_inventories_controller_machine_software_inventories', value: 'view', },
        { label: 'hyperv_software_inventories_controller_machine_software_inventories', value: 'resource', },
    ]
}>
<TabItem value="view">
