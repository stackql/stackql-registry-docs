...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_hyperv_sites_controllers', value: 'view', },
        { label: 'hyperv_sites_controllers', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="resourceGroupName, siteName, subscriptionId" /> | Update a HypervSite |
...
Use the following StackQL query and manifest file to create a new <code>hyperv_sites_controllers</code> resource.
...
Updates a <code>hyperv_sites_controllers</code> resource.
...
Deletes the specified <code>hyperv_sites_controllers</code> resource.
