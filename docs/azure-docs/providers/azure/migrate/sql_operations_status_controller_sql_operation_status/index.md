...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_sql_operations_status_controller_sql_operation_status', value: 'view', },
        { label: 'sql_operations_status_controller_sql_operation_status', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="operationStatusName, resourceGroupName, siteName, sqlSiteName, subscriptionId" /> | Method to get operation status. |
