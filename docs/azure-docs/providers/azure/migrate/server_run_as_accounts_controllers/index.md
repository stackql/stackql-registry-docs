...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_server_run_as_accounts_controllers', value: 'view', },
        { label: 'server_run_as_accounts_controllers', value: 'resource', },
    ]
}>
<TabItem value="view">
...
subscriptionId,
updated_timestamp
FROM azure.migrate.vw_server_run_as_accounts_controllers
