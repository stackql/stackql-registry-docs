...
| <CopyableCode code="_list_by_cluster" /> | `EXEC` | <CopyableCode code="clusterName, resourceGroupName, subscriptionId" /> | List all the configurations of a cluster. |
| <CopyableCode code="_list_by_server" /> | `EXEC` | <CopyableCode code="clusterName, resourceGroupName, serverName, subscriptionId" /> | List all the configurations of a server in cluster. |
