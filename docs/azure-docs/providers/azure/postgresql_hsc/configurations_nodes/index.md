...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_configurations_nodes', value: 'view', },
        { label: 'configurations_nodes', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="clusterName, configurationName, resourceGroupName, subscriptionId" /> | Gets information of a configuration for worker nodes. |
...
subscriptionId,
value
FROM azure.postgresql_hsc.vw_configurations_nodes
