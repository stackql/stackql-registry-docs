...
| <CopyableCode code="_list_by_resource_group" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId" /> | Lists all projects in the resource group. |
| <CopyableCode code="_list_by_subscription" /> | `EXEC` | <CopyableCode code="subscriptionId" /> | Lists all projects in the subscription. |
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="projectName, resourceGroupName, subscriptionId" /> | Partially updates a project. |
