...
<tr><td><b>Id</b></td><td><code>azure.dev_center.project_allowed_environment_types</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `projectName, resourceGroupName, subscriptionId` | Lists allowed environment types for a project. |
