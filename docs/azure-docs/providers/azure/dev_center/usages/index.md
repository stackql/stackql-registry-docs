...
<tr><td><b>Id</b></td><td><code>azure.dev_center.usages</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list_by_location` | `SELECT` | `location, subscriptionId` |
| `_list_by_location` | `EXEC` | `location, subscriptionId` |
