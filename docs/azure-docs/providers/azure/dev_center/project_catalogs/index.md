...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_project_catalogs', value: 'view', },
        { label: 'project_catalogs', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="catalogName, projectName, resourceGroupName, subscriptionId" /> | Gets an associated project catalog. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="projectName, resourceGroupName, subscriptionId" /> | Lists the catalogs associated with a project. |
| <CopyableCode code="create_or_update" /> | `INSERT` | <CopyableCode code="catalogName, projectName, resourceGroupName, subscriptionId" /> | Creates or updates a project catalog. |
| <CopyableCode code="delete" /> | `DELETE` | <CopyableCode code="catalogName, projectName, resourceGroupName, subscriptionId" /> | Deletes a project catalog resource. |
| <CopyableCode code="patch" /> | `UPDATE` | <CopyableCode code="catalogName, projectName, resourceGroupName, subscriptionId" /> | Partially updates a project catalog. |
| <CopyableCode code="connect" /> | `EXEC` | <CopyableCode code="catalogName, projectName, resourceGroupName, subscriptionId" /> | Connects a project catalog to enable syncing. |
| <CopyableCode code="sync" /> | `EXEC` | <CopyableCode code="catalogName, projectName, resourceGroupName, subscriptionId" /> | Syncs templates for a template source. |
...
Use the following StackQL query and manifest file to create a new <code>project_catalogs</code> resource.
...
Updates a <code>project_catalogs</code> resource.
...
Deletes the specified <code>project_catalogs</code> resource.
