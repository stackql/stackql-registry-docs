...
<tr><td><b>Id</b></td><td><code>azure.dev_center.network_connections_health_details</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `networkConnectionName, resourceGroupName, subscriptionId` |
