...
<tr><td><b>Id</b></td><td><code>azure.dev_center.environment_types</code></td></tr>
</tbody></table>
...
| `_list_by_dev_center` | `EXEC` | `devCenterName, resourceGroupName, subscriptionId` | Lists environment types for the devcenter. |
| `update` | `EXEC` | `devCenterName, environmentTypeName, resourceGroupName, subscriptionId` | Partially updates an environment type. |
