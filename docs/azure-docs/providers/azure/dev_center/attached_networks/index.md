...
| <CopyableCode code="_list_by_dev_center" /> | `EXEC` | <CopyableCode code="devCenterName, resourceGroupName, subscriptionId" /> | Lists the attached NetworkConnections for a DevCenter. |
| <CopyableCode code="_list_by_project" /> | `EXEC` | <CopyableCode code="projectName, resourceGroupName, subscriptionId" /> | Lists the attached NetworkConnections for a Project. |
