...
<tr><td><b>Id</b></td><td><code>azure.dashboard.private_link_resources</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `privateLinkResourceName, resourceGroupName, subscriptionId, workspaceName` |
