...
|:-----|:--------------|:----------------|
| <CopyableCode code="list_by_cloud_hsm_cluster" /> | `SELECT` | <CopyableCode code="cloudHsmClusterName, resourceGroupName, subscriptionId" /> |
| <CopyableCode code="_list_by_cloud_hsm_cluster" /> | `EXEC` | <CopyableCode code="cloudHsmClusterName, resourceGroupName, subscriptionId" /> |
