...
| <CopyableCode code="_list_by_managed_network" /> | `EXEC` | <CopyableCode code="managedNetworkName, resourceGroupName, subscriptionId" /> | The ListByManagedNetwork ManagedNetworkGroup operation retrieves all the Managed Network Groups in a specified Managed Networks in a paginated format. |
