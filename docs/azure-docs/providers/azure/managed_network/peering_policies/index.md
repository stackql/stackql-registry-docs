...
| `_list_by_managed_network` | `EXEC` | `managedNetworkName, resourceGroupName, subscriptionId` | The ListByManagedNetwork PeeringPolicies operation retrieves all the Managed Network Peering Policies in a specified Managed Network, in a paginated format. |
