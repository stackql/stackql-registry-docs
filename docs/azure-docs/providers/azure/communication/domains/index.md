...
| <CopyableCode code="_list_by_email_service_resource" /> | `EXEC` | <CopyableCode code="emailServiceName, resourceGroupName, subscriptionId" /> | Handles requests to list all Domains resources under the parent EmailServices resource. |
