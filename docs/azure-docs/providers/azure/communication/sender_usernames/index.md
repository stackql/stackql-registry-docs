...
| <CopyableCode code="_list_by_domains" /> | `EXEC` | <CopyableCode code="domainName, emailServiceName, resourceGroupName, subscriptionId" /> | List all valid sender usernames for a domains resource. |
