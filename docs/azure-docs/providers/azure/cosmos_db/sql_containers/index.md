...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_sql_containers', value: 'view', },
        { label: 'sql_containers', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="properties" /> | `object` | The properties of an Azure Cosmos DB container |
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="accountName, containerName, databaseName, resourceGroupName, subscriptionId" /> | Gets the SQL container under an existing Azure Cosmos DB database account. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="accountName, databaseName, resourceGroupName, subscriptionId" /> | Lists the SQL container under an existing Azure Cosmos DB database account. |
| <CopyableCode code="create_update" /> | `INSERT` | <CopyableCode code="accountName, containerName, databaseName, resourceGroupName, subscriptionId, data__properties" /> | Create or update an Azure Cosmos DB SQL container |
| <CopyableCode code="delete" /> | `DELETE` | <CopyableCode code="accountName, containerName, databaseName, resourceGroupName, subscriptionId" /> | Deletes an existing Azure Cosmos DB SQL container. |
...
tags,
type
FROM azure.cosmos_db.vw_sql_containers
...
Use the following StackQL query and manifest file to create a new <code>sql_containers</code> resource.
...
Deletes the specified <code>sql_containers</code> resource.
