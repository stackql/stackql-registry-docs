...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmos_db.cassandra_keyspace_throughput" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="accountName, keyspaceName, resourceGroupName, subscriptionId" /> |
