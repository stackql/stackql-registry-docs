...
<tr><td><b>Id</b></td><td><code>azure.cosmos_db.graphs</code></td></tr>
</tbody></table>
...
| `delete` | `DELETE` | `accountName, graphName, resourceGroupName, subscriptionId` | Deletes an existing Azure Cosmos DB Graph Resource. |
| `_list` | `EXEC` | `accountName, resourceGroupName, subscriptionId` | Lists the graphs under an existing Azure Cosmos DB database account. |
| `create_update` | `EXEC` | `accountName, graphName, resourceGroupName, subscriptionId, data__properties` | Create or update an Azure Cosmos DB Graph. |
