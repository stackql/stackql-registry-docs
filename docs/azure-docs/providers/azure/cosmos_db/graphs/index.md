...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.cosmos_db.graphs" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="accountName, resourceGroupName, subscriptionId" /> | Lists the graphs under an existing Azure Cosmos DB database account. |
| <CopyableCode code="create_update" /> | `EXEC` | <CopyableCode code="accountName, graphName, resourceGroupName, subscriptionId, data__properties" /> | Create or update an Azure Cosmos DB Graph. |
