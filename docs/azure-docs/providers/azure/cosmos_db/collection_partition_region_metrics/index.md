...
<tr><td><b>Id</b></td><td><code>azure.cosmos_db.collection_partition_region_metrics</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `$filter, accountName, collectionRid, databaseRid, region, resourceGroupName, subscriptionId` |
| `_list` | `EXEC` | `$filter, accountName, collectionRid, databaseRid, region, resourceGroupName, subscriptionId` |
