...
<tr><td><b>Id</b></td><td><code>azure.cosmos_db.database_accounts_metrics</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `$filter, accountName, resourceGroupName, subscriptionId` |
| `_list` | `EXEC` | `$filter, accountName, resourceGroupName, subscriptionId` |
