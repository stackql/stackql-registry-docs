...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_cassandra_keyspace_throughputs', value: 'view', },
        { label: 'cassandra_keyspace_throughputs', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="accountName, keyspaceName, resourceGroupName, subscriptionId" /> | Gets the RUs per second of the Cassandra Keyspace under an existing Azure Cosmos DB database account with the provided name. |
| <CopyableCode code="update" /> | `REPLACE` | <CopyableCode code="accountName, keyspaceName, resourceGroupName, subscriptionId, data__properties" /> | Update RUs per second of an Azure Cosmos DB Cassandra Keyspace |
...
tags,
type
FROM azure.cosmos_db.vw_cassandra_keyspace_throughputs
...
Replaces all fields in the specified <code>cassandra_keyspace_throughputs</code> resource.
