...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_sql_databases', value: 'view', },
        { label: 'sql_databases', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="accountName, databaseName, resourceGroupName, subscriptionId" /> | Gets the SQL database under an existing Azure Cosmos DB database account with the provided name. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="accountName, resourceGroupName, subscriptionId" /> | Lists the SQL databases under an existing Azure Cosmos DB database account. |
| <CopyableCode code="create_update" /> | `INSERT` | <CopyableCode code="accountName, databaseName, resourceGroupName, subscriptionId, data__properties" /> | Create or update an Azure Cosmos DB SQL database |
| <CopyableCode code="delete" /> | `DELETE` | <CopyableCode code="accountName, databaseName, resourceGroupName, subscriptionId" /> | Deletes an existing Azure Cosmos DB SQL database. |
...
tags,
type
FROM azure.cosmos_db.vw_sql_databases
...
Use the following StackQL query and manifest file to create a new <code>sql_databases</code> resource.
...
Deletes the specified <code>sql_databases</code> resource.
