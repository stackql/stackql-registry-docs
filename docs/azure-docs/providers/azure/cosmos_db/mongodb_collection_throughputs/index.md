...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_mongodb_collection_throughputs', value: 'view', },
        { label: 'mongodb_collection_throughputs', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="accountName, collectionName, databaseName, resourceGroupName, subscriptionId" /> | Gets the RUs per second of the MongoDB collection under an existing Azure Cosmos DB database account with the provided name. |
| <CopyableCode code="update" /> | `REPLACE` | <CopyableCode code="accountName, collectionName, databaseName, resourceGroupName, subscriptionId, data__properties" /> | Update the RUs per second of an Azure Cosmos DB MongoDB collection |
...
tags,
type
FROM azure.cosmos_db.vw_mongodb_collection_throughputs
...
Replaces all fields in the specified <code>mongodb_collection_throughputs</code> resource.
