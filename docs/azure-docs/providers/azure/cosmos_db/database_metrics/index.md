...
<tr><td><b>Id</b></td><td><code>azure.cosmos_db.database_metrics</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `$filter, accountName, databaseRid, resourceGroupName, subscriptionId` |
| `_list` | `EXEC` | `$filter, accountName, databaseRid, resourceGroupName, subscriptionId` |
