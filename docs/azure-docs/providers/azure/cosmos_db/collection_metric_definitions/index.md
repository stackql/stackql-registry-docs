...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="accountName, collectionRid, databaseRid, resourceGroupName, subscriptionId" /> | Retrieves metric definitions for the given collection. |
