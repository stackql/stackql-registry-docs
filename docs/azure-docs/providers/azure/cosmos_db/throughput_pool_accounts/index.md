...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId, throughputPoolName" /> | Lists all the Azure Cosmos DB accounts available under the subscription. |
