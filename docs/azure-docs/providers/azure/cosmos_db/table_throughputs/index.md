...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_table_throughputs', value: 'view', },
        { label: 'table_throughputs', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="accountName, resourceGroupName, subscriptionId, tableName" /> | Gets the RUs per second of the Table under an existing Azure Cosmos DB database account with the provided name. |
| <CopyableCode code="update" /> | `REPLACE` | <CopyableCode code="accountName, resourceGroupName, subscriptionId, tableName, data__properties" /> | Update RUs per second of an Azure Cosmos DB Table |
...
tags,
type
FROM azure.cosmos_db.vw_table_throughputs
...
Replaces all fields in the specified <code>table_throughputs</code> resource.
