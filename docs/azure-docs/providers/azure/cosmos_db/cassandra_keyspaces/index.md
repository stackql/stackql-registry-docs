...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_cassandra_keyspaces', value: 'view', },
        { label: 'cassandra_keyspaces', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="create_update" /> | `INSERT` | <CopyableCode code="accountName, keyspaceName, resourceGroupName, subscriptionId, data__properties" /> | Create or update an Azure Cosmos DB Cassandra keyspace |
...
tags,
type
FROM azure.cosmos_db.vw_cassandra_keyspaces
...
Use the following StackQL query and manifest file to create a new <code>cassandra_keyspaces</code> resource.
...
Deletes the specified <code>cassandra_keyspaces</code> resource.
