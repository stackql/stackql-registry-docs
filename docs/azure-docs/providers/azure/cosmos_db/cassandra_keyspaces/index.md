...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="accountName, resourceGroupName, subscriptionId" /> | Lists the Cassandra keyspaces under an existing Azure Cosmos DB database account. |
