...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="accountName, keyspaceName, resourceGroupName, subscriptionId" /> | Lists the Cassandra materialized views under an existing Azure Cosmos DB database account. |
| <CopyableCode code="create_update" /> | `EXEC` | <CopyableCode code="accountName, keyspaceName, resourceGroupName, subscriptionId, viewName, data__properties" /> | Create or update an Azure Cosmos DB Cassandra View |
