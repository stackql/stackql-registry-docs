...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="accountName, containerName, databaseName, resourceGroupName, subscriptionId" /> | Lists the SQL storedProcedure under an existing Azure Cosmos DB database account. |
