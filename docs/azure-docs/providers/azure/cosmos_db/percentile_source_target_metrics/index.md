...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="$filter, accountName, resourceGroupName, sourceRegion, subscriptionId, targetRegion" /> |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="$filter, accountName, resourceGroupName, sourceRegion, subscriptionId, targetRegion" /> |
