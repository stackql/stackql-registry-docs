...
<tr><td><b>Id</b></td><td><code>azure.cosmos_db.percentile_source_target_metrics</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `$filter, accountName, resourceGroupName, sourceRegion, subscriptionId, targetRegion` |
| `_list` | `EXEC` | `$filter, accountName, resourceGroupName, sourceRegion, subscriptionId, targetRegion` |
