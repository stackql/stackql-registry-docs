...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="$filter, accountName, collectionRid, databaseRid, partitionKeyRangeId, resourceGroupName, subscriptionId" /> |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="$filter, accountName, collectionRid, databaseRid, partitionKeyRangeId, resourceGroupName, subscriptionId" /> |
