...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_cassandra_table_throughputs', value: 'view', },
        { label: 'cassandra_table_throughputs', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="accountName, keyspaceName, resourceGroupName, subscriptionId, tableName" /> | Gets the RUs per second of the Cassandra table under an existing Azure Cosmos DB database account with the provided name. |
| <CopyableCode code="update" /> | `REPLACE` | <CopyableCode code="accountName, keyspaceName, resourceGroupName, subscriptionId, tableName, data__properties" /> | Update RUs per second of an Azure Cosmos DB Cassandra table |
...
Replaces all fields in the specified <code>cassandra_table_throughputs</code> resource.
