...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="accountName, databaseName, resourceGroupName, subscriptionId" /> | Lists the ClientEncryptionKeys under an existing Azure Cosmos DB SQL database. |
