...
<tr><td><b>Id</b></td><td><code>azure.cosmos_db.database_account_region_metrics</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `$filter, accountName, region, resourceGroupName, subscriptionId` |
| `_list` | `EXEC` | `$filter, accountName, region, resourceGroupName, subscriptionId` |
