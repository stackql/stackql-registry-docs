...
<tr><td><b>Id</b></td><td><code>azure.cosmos_db.database_metric_definitions</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `accountName, databaseRid, resourceGroupName, subscriptionId` |
| `_list` | `EXEC` | `accountName, databaseRid, resourceGroupName, subscriptionId` |
