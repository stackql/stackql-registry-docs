...
Creates, updates, deletes, gets or lists a <code>object_anchors_accounts</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_object_anchors_accounts', value: 'view', },
        { label: 'object_anchors_accounts', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="accountName, resourceGroupName, subscriptionId" /> | Updating an Object Anchors Account |
...
Use the following StackQL query and manifest file to create a new <code>object_anchors_accounts</code> resource.
...
Updates a <code>object_anchors_accounts</code> resource.
...
Deletes the specified <code>object_anchors_accounts</code> resource.
