...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_web_pub_subs', value: 'view', },
        { label: 'web_pub_subs', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="socket_io" /> | `text` | field from the `properties` object |
...
Use the following StackQL query and manifest file to create a new <code>web_pub_subs</code> resource.
...
Updates a <code>web_pub_subs</code> resource.
...
Deletes the specified <code>web_pub_subs</code> resource.
