...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_replica_shared_private_link_resources', value: 'view', },
        { label: 'replica_shared_private_link_resources', value: 'resource', },
    ]
}>
<TabItem value="view">
...
status,
subscriptionId
FROM azure.web_pubsub.vw_replica_shared_private_link_resources
...
Use the following StackQL query and manifest file to create a new <code>replica_shared_private_link_resources</code> resource.
