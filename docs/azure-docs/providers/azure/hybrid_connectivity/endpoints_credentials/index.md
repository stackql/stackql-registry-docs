...
Creates, updates, deletes, gets or lists a <code>endpoints_credentials</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="endpointName, resourceUri" /> | Gets the endpoint access credentials to the resource. |
