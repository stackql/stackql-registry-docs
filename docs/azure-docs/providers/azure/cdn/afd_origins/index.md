...
| <CopyableCode code="_list_by_origin_group" /> | `EXEC` | <CopyableCode code="originGroupName, profileName, resourceGroupName, subscriptionId" /> | Lists all of the existing origins within an origin group. |
