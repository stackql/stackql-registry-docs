...
| <CopyableCode code="_list_by_profile" /> | `EXEC` | <CopyableCode code="profileName, resourceGroupName, subscriptionId" /> | Lists security policies associated with the profile |
