...
Creates, updates, deletes, gets or lists a <code>afd_profiles_resource_usages</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="profileName, resourceGroupName, subscriptionId" /> | Checks the quota and actual usage of endpoints under the given Azure Front Door profile. |
