...
<tr><td><b>Id</b></td><td><code>azure.dev_test_labs.service_fabrics_applicable_schedules</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `api-version, labName, name, resourceGroupName, subscriptionId, userName` |
