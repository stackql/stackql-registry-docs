...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, artifactSourceName, labName, resourceGroupName, subscriptionId" /> | List artifacts in a given artifact source. |
