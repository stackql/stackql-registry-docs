...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="providerName, resourceGroupName, resourceName, resourceType, subscriptionId" /> | List configurationAssignments for resource. |
