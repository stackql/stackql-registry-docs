...
| <CopyableCode code="_list_by_product" /> | `EXEC` | <CopyableCode code="productId, resourceGroupName, serviceName, subscriptionId" /> | Lists the collection of developer groups associated with the specified product. |
| <CopyableCode code="check_entity_exists" /> | `EXEC` | <CopyableCode code="groupId, productId, resourceGroupName, serviceName, subscriptionId" /> | Checks that Group entity specified by identifier is associated with the Product entity. |
