...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_product_policies', value: 'view', },
        { label: 'product_policies', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>product_policies</code> resource.
...
Deletes the specified <code>product_policies</code> resource.
