...
| <CopyableCode code="_list_by_operation" /> | `EXEC` | <CopyableCode code="apiId, operationId, resourceGroupName, serviceName, subscriptionId" /> | Get the list of policy configuration at the API Operation level. |
