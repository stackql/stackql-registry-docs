...
| <CopyableCode code="_list_by_service" /> | `EXEC` | <CopyableCode code="quotaCounterKey, resourceGroupName, serviceName, subscriptionId" /> | Lists a collection of current quota counter periods associated with the counter-key configured in the policy on the specified service instance. The api does not support paging yet. |
