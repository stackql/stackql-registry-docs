...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>workspace_api_version_set</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><code>azure.api_management.workspace_api_version_set</code></td></tr>
</tbody></table>
...
| `_list_by_service` | `EXEC` | `resourceGroupName, serviceName, subscriptionId, workspaceId` | Lists a collection of API Version Sets in the specified workspace with a service instance. |
| `update` | `EXEC` | `If-Match, resourceGroupName, serviceName, subscriptionId, versionSetId, workspaceId` | Updates the details of the Api VersionSet specified by its identifier. |
