...
<tr><td><b>Id</b></td><td><code>azure.api_management.workspace_api_operation</code></td></tr>
</tbody></table>
...
| `_list_by_api` | `EXEC` | `apiId, resourceGroupName, serviceName, subscriptionId, workspaceId` | Lists a collection of the operations for the specified API. |
| `update` | `EXEC` | `If-Match, apiId, operationId, resourceGroupName, serviceName, subscriptionId, workspaceId` | Updates the details of the operation in the API specified by its identifier. |
