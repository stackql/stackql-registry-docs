...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_named_values', value: 'view', },
        { label: 'named_values', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="namedValueId, resourceGroupName, serviceName, subscriptionId" /> | Gets the secret of the named value specified by its identifier. |
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="If-Match, namedValueId, resourceGroupName, serviceName, subscriptionId" /> | Updates the specific named value. |
...
Use the following StackQL query and manifest file to create a new <code>named_values</code> resource.
...
Updates a <code>named_values</code> resource.
...
Deletes the specified <code>named_values</code> resource.
