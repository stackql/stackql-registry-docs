...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_workspace_api_operations', value: 'view', },
        { label: 'workspace_api_operations', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="If-Match, apiId, operationId, resourceGroupName, serviceName, subscriptionId, workspaceId" /> | Updates the details of the operation in the API specified by its identifier. |
...
Use the following StackQL query and manifest file to create a new <code>workspace_api_operations</code> resource.
...
Updates a <code>workspace_api_operations</code> resource.
...
Deletes the specified <code>workspace_api_operations</code> resource.
