...
<tr><td><b>Id</b></td><td><code>azure.api_management.workspace_subscription</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `resourceGroupName, serviceName, subscriptionId, workspaceId` | Lists all subscriptions of the workspace in an API Management service instance. |
...
| `update` | `EXEC` | `If-Match, resourceGroupName, serviceName, sid, subscriptionId, workspaceId` | Updates the details of a subscription specified by its identifier. |
