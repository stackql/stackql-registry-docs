...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_workspace_product_api_links', value: 'view', },
        { label: 'workspace_product_api_links', value: 'resource', },
    ]
}>
<TabItem value="view">
...
subscriptionId,
workspaceId
FROM azure.api_management.vw_workspace_product_api_links
...
Use the following StackQL query and manifest file to create a new <code>workspace_product_api_links</code> resource.
...
Deletes the specified <code>workspace_product_api_links</code> resource.
