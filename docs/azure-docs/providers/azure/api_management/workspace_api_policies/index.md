...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_workspace_api_policies', value: 'view', },
        { label: 'workspace_api_policies', value: 'resource', },
    ]
}>
<TabItem value="view">
...
value,
workspaceId
FROM azure.api_management.vw_workspace_api_policies
WHERE apiId = '{{ apiId }}'
...
Use the following StackQL query and manifest file to create a new <code>workspace_api_policies</code> resource.
...
Deletes the specified <code>workspace_api_policies</code> resource.
