...
| <CopyableCode code="_list_by_api" /> | `EXEC` | <CopyableCode code="apiId, resourceGroupName, serviceName, subscriptionId" /> | Lists a collection of the operations for the specified API. |
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="If-Match, apiId, operationId, resourceGroupName, serviceName, subscriptionId" /> | Updates the details of the operation in the API specified by its identifier. |
