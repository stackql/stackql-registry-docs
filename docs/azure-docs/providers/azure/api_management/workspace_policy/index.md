...
| <CopyableCode code="_list_by_api" /> | `EXEC` | <CopyableCode code="resourceGroupName, serviceName, subscriptionId, workspaceId" /> | Get the policy configuration at the workspace level. |
