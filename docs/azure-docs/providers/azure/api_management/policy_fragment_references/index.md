...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="id, resourceGroupName, serviceName, subscriptionId" /> | Lists policy resources that reference the policy fragment. |
