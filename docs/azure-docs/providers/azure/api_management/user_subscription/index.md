...
|:-----|:--------------|:----------------|:------------|
| `UserSubscription_Get` | `SELECT` | `resourceGroupName, serviceName, sid, subscriptionId, userId` | Gets the specified Subscription entity associated with a particular user. |
