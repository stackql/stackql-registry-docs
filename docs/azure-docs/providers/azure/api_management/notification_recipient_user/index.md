...
| <CopyableCode code="_list_by_notification" /> | `EXEC` | <CopyableCode code="notificationName, resourceGroupName, serviceName, subscriptionId" /> | Gets the list of the Notification Recipient User subscribed to the notification. |
| <CopyableCode code="check_entity_exists" /> | `EXEC` | <CopyableCode code="notificationName, resourceGroupName, serviceName, subscriptionId, userId" /> | Determine if the Notification Recipient User is subscribed to the notification. |
