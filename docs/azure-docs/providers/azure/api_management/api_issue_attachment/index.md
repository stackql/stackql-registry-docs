...
| <CopyableCode code="_list_by_service" /> | `EXEC` | <CopyableCode code="apiId, issueId, resourceGroupName, serviceName, subscriptionId" /> | Lists all attachments for the Issue associated with the specified API. |
