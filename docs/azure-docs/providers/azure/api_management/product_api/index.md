...
| <CopyableCode code="_list_by_product" /> | `EXEC` | <CopyableCode code="productId, resourceGroupName, serviceName, subscriptionId" /> | Lists a collection of the APIs associated with a product. |
| <CopyableCode code="check_entity_exists" /> | `EXEC` | <CopyableCode code="apiId, productId, resourceGroupName, serviceName, subscriptionId" /> | Checks that API entity specified by identifier is associated with the Product entity. |
