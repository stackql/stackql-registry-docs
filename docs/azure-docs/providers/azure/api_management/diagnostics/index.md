...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="If-Match, diagnosticId, resourceGroupName, serviceName, subscriptionId" /> | Updates the details of the Diagnostic specified by its identifier. |
...
Updates a <code>diagnostics</code> resource.
...
Deletes the specified <code>diagnostics</code> resource.
