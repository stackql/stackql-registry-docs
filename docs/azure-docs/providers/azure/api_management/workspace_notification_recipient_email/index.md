...
<tr><td><b>Id</b></td><td><code>azure.api_management.workspace_notification_recipient_email</code></td></tr>
</tbody></table>
...
| `_list_by_notification` | `EXEC` | `notificationName, resourceGroupName, serviceName, subscriptionId, workspaceId` | Gets the list of the Notification Recipient Emails subscribed to a notification. |
| `check_entity_exists` | `EXEC` | `email, notificationName, resourceGroupName, serviceName, subscriptionId, workspaceId` | Determine if Notification Recipient Email subscribed to the notification. |
