...
| <CopyableCode code="_list_by_notification" /> | `EXEC` | <CopyableCode code="notificationName, resourceGroupName, serviceName, subscriptionId, workspaceId" /> | Gets the list of the Notification Recipient Emails subscribed to a notification. |
| <CopyableCode code="check_entity_exists" /> | `EXEC` | <CopyableCode code="email, notificationName, resourceGroupName, serviceName, subscriptionId, workspaceId" /> | Determine if Notification Recipient Email subscribed to the notification. |
