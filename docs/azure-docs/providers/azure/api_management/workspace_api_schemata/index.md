...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_workspace_api_schemata', value: 'view', },
        { label: 'workspace_api_schemata', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>workspace_api_schemata</code> resource.
...
Deletes the specified <code>workspace_api_schemata</code> resource.
