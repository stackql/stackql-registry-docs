...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_global_schemata', value: 'view', },
        { label: 'global_schemata', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>global_schemata</code> resource.
...
Deletes the specified <code>global_schemata</code> resource.
