...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_sign_in_settings', value: 'view', },
        { label: 'sign_in_settings', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="If-Match, resourceGroupName, serviceName, subscriptionId" /> | Update Sign-In settings. |
...
Use the following StackQL query and manifest file to create a new <code>sign_in_settings</code> resource.
...
Updates a <code>sign_in_settings</code> resource.
