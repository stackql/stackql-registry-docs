...
Creates, updates, deletes, gets or lists a <code>api_version_sets</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_api_version_sets', value: 'view', },
        { label: 'api_version_sets', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="If-Match, resourceGroupName, serviceName, subscriptionId, versionSetId" /> | Updates the details of the Api VersionSet specified by its identifier. |
...
Use the following StackQL query and manifest file to create a new <code>api_version_sets</code> resource.
...
Updates a <code>api_version_sets</code> resource.
...
Deletes the specified <code>api_version_sets</code> resource.
