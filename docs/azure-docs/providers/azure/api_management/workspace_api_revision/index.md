...
<tr><td><b>Id</b></td><td><code>azure.api_management.workspace_api_revision</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list_by_service` | `SELECT` | `apiId, resourceGroupName, serviceName, subscriptionId, workspaceId` |
| `_list_by_service` | `EXEC` | `apiId, resourceGroupName, serviceName, subscriptionId, workspaceId` |
