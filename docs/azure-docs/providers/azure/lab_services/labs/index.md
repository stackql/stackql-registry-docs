...
| <CopyableCode code="_list_by_resource_group" /> | `EXEC` |  | Returns a list of all labs in a resource group. |
| <CopyableCode code="_list_by_subscription" /> | `EXEC` |  | Returns a list of all labs for a subscription. |
