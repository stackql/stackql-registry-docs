...
| <CopyableCode code="_list_by_resource_group" /> | `EXEC` |  | Returns a list of all lab plans for a subscription and resource group. |
| <CopyableCode code="_list_by_subscription" /> | `EXEC` |  | Returns a list of all lab plans within a subscription |
