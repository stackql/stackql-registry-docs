...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>operation_status_result</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="azure.aks.operation_status_result" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="operationId, resourceGroupName, resourceName, subscriptionId" /> |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="resourceGroupName, resourceName, subscriptionId" /> |
| <CopyableCode code="get_by_agent_pool" /> | `EXEC` | <CopyableCode code="agentPoolName, operationId, resourceGroupName, resourceName, subscriptionId" /> |
