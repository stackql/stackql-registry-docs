...
<tr><td><b>Id</b></td><td><code>azure.aks.private_endpoint_connections</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `resourceGroupName, resourceName, subscriptionId` | To learn more about private clusters, see: https://docs.microsoft.com/azure/aks/private-clusters |
| `update` | `EXEC` | `privateEndpointConnectionName, resourceGroupName, resourceName, subscriptionId` |  |
