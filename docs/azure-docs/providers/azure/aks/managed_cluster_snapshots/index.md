...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.aks.managed_cluster_snapshots" /></td></tr>
</tbody></table>
...
| <CopyableCode code="properties" /> | `object` | Properties for a managed cluster snapshot. |
