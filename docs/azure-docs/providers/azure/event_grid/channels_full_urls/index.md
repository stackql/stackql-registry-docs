...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="channelName, partnerNamespaceName, resourceGroupName, subscriptionId" /> | Get the full endpoint URL of a partner destination channel. |
