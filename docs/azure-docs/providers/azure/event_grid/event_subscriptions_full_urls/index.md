...
Creates, updates, deletes, gets or lists a <code>event_subscriptions_full_urls</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="eventSubscriptionName, scope" /> | Get the full endpoint URL for an event subscription. |
