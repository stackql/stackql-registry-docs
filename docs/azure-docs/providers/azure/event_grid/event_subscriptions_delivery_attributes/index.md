...
Creates, updates, deletes, gets or lists a <code>event_subscriptions_delivery_attributes</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="eventSubscriptionName, scope" /> | Get all delivery attributes for an event subscription. |
