...
<tr><td><b>Id</b></td><td><code>azure.event_grid.event_subscriptions_regional_by_resource_group_for_topic_type</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `location, resourceGroupName, subscriptionId, topicTypeName` |
| `_list` | `EXEC` | `location, resourceGroupName, subscriptionId, topicTypeName` |
