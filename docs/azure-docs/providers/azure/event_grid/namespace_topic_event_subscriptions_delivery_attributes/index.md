...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="eventSubscriptionName, namespaceName, resourceGroupName, subscriptionId, topicName" /> | Get all delivery attributes for an event subscription of a namespace topic. |
