...
| <CopyableCode code="_list_by_partner_namespace" /> | `EXEC` | <CopyableCode code="partnerNamespaceName, resourceGroupName, subscriptionId" /> | List all the channels in a partner namespace. |
