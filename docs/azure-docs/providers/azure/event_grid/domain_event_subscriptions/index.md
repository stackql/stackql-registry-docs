...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_domain_event_subscriptions', value: 'view', },
        { label: 'domain_event_subscriptions', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="domainName, eventSubscriptionName, resourceGroupName, subscriptionId" /> | Update an existing event subscription for a topic. |
...
Use the following StackQL query and manifest file to create a new <code>domain_event_subscriptions</code> resource.
...
Updates a <code>domain_event_subscriptions</code> resource.
...
Deletes the specified <code>domain_event_subscriptions</code> resource.
