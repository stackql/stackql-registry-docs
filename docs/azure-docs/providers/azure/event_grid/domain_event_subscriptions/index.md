...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="domainName, resourceGroupName, subscriptionId" /> | List all event subscriptions that have been created for a specific topic. |
