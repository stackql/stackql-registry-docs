...
<tr><td><b>Id</b></td><td><code>azure.event_grid.network_security_perimeter_configurations</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `resourceGroupName, resourceName, resourceType, subscriptionId` | Get all network security perimeter configurations associated with a topic or domain. |
