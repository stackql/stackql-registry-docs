...
| <CopyableCode code="_list_by_resource" /> | `EXEC` | <CopyableCode code="parentName, parentType, resourceGroupName, subscriptionId" /> | Get all private endpoint connections under a topic, domain, or partner namespace or namespace. |
