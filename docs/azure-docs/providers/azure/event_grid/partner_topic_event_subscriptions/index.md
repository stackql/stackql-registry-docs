...
| <CopyableCode code="_list_by_partner_topic" /> | `EXEC` | <CopyableCode code="partnerTopicName, resourceGroupName, subscriptionId" /> | List event subscriptions that belong to a specific partner topic. |
