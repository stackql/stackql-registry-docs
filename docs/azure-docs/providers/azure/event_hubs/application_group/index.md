...
<tr><td><b>Id</b></td><td><code>azure.event_hubs.application_group</code></td></tr>
</tbody></table>
...
| `_list_by_namespace` | `EXEC` | `namespaceName, resourceGroupName, subscriptionId` | Gets a list of application groups for a Namespace. |
