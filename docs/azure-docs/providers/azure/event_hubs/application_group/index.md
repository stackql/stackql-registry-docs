...
<tr><td><b>Id</b></td><td><CopyableCode code="azure.event_hubs.application_group" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_list_by_namespace" /> | `EXEC` | <CopyableCode code="namespaceName, resourceGroupName, subscriptionId" /> | Gets a list of application groups for a Namespace. |
