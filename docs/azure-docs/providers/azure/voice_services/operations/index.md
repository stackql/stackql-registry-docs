...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | List the operations for the provider |
| <CopyableCode code="check_local_name_availability" /> | `EXEC` | <CopyableCode code="location, subscriptionId" /> | Check whether the resource name is available in the given region. |
