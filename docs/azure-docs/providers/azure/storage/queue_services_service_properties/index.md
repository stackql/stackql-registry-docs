...
<tr><td><b>Id</b></td><td><code>azure.storage.queue_services_service_properties</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `accountName, queueServiceName, resourceGroupName, subscriptionId` |
