...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="FileServicesName, accountName, resourceGroupName, subscriptionId" /> | Gets the properties of file services in storage accounts, including CORS (Cross-Origin Resource Sharing) rules. |
...
WHERE FileServicesName = '{{ FileServicesName }}'
