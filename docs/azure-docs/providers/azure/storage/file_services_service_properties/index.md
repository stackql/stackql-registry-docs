...
<tr><td><b>Id</b></td><td><code>azure.storage.file_services_service_properties</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `FileServicesName, accountName, resourceGroupName, subscriptionId` |
