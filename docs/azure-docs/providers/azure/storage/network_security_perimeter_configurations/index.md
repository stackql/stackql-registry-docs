...
| Name | Datatype | Description |
|:-----|:---------|:------------|
| <CopyableCode code="properties" /> | `object` | Properties of the Network Security Perimeter Configuration |
</TabItem></Tabs>
...
subscriptionId
FROM azure.storage.vw_network_security_perimeter_configurations
