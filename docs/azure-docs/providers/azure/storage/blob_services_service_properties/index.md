...
<tr><td><b>Id</b></td><td><code>azure.storage.blob_services_service_properties</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `BlobServicesName, accountName, resourceGroupName, subscriptionId` |
