...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="BlobServicesName, accountName, resourceGroupName, subscriptionId" /> | Gets the properties of a storage account’s Blob service, including properties for Storage Analytics and CORS (Cross-Origin Resource Sharing) rules. |
...
WHERE BlobServicesName = '{{ BlobServicesName }}'
