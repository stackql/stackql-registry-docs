...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="buildServiceName, builderName, resourceGroupName, serviceName, subscriptionId" /> | Handles requests to list all buildpack bindings in a builder. |
