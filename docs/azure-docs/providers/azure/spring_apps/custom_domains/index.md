...
<tr><td><b>Id</b></td><td><code>azure.spring_apps.custom_domains</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `appName, resourceGroupName, serviceName, subscriptionId` | List the custom domains of one lifecycle application. |
| `update` | `EXEC` | `appName, domainName, resourceGroupName, serviceName, subscriptionId` | Update custom domain of one lifecycle application. |
