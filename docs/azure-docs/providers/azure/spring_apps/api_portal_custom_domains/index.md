...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="apiPortalName, resourceGroupName, serviceName, subscriptionId" /> | Handle requests to list all API portal custom domains. |
