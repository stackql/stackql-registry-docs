...
| <CopyableCode code="_list_by_group" /> | `EXEC` | <CopyableCode code="resourceGroupName, sqlVirtualMachineGroupName, subscriptionId" /> | Lists all availability group listeners in a SQL virtual machine group. |
