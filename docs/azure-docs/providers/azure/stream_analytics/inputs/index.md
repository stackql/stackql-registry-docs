...
| <CopyableCode code="_list_by_streaming_job" /> | `EXEC` | <CopyableCode code="jobName, resourceGroupName, subscriptionId" /> | Lists all of the inputs under the specified streaming job. |
