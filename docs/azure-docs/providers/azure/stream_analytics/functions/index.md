...
| <CopyableCode code="_list_by_streaming_job" /> | `EXEC` | <CopyableCode code="jobName, resourceGroupName, subscriptionId" /> | Lists all of the functions under the specified streaming job. |
