...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="deploymentName, operationId" /> | Gets a deployments operation. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="deploymentName" /> | Gets all deployments operations for a deployment. |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="deploymentName" /> | Gets all deployments operations for a deployment. |
