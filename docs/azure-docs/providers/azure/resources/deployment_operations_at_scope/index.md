...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="deploymentName, operationId, scope" /> | Gets a deployments operation. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="deploymentName, scope" /> | Gets all deployments operations for a deployment. |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="deploymentName, scope" /> | Gets all deployments operations for a deployment. |
