...
| <CopyableCode code="_list_by_factory" /> | `EXEC` | <CopyableCode code="api-version, factoryName, resourceGroupName, subscriptionId" /> | Lists all resources of type change data capture. |
