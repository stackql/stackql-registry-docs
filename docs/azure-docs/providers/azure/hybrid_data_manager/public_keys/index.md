...
| <CopyableCode code="_list_by_data_manager" /> | `EXEC` | <CopyableCode code="dataManagerName, resourceGroupName, subscriptionId" /> | This method gets the list view of public keys, however it will only have one element. |
