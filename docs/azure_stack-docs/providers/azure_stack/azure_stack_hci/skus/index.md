...
| <CopyableCode code="_list_by_offer" /> | `EXEC` | <CopyableCode code="clusterName, offerName, publisherName, resourceGroupName, subscriptionId" /> | List Skus available for a offer within the HCI Cluster. |
