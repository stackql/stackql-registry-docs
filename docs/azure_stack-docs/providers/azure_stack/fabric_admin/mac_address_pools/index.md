...
<tr><td><b>Id</b></td><td><code>azure_stack.fabric_admin.mac_address_pools</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `location, resourceGroupName, subscriptionId` | Returns a list of all MAC address pools at a location. |
