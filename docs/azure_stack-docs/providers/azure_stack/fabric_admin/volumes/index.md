...
<tr><td><b>Id</b></td><td><code>azure_stack.fabric_admin.volumes</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `location, resourceGroupName, scaleUnit, storageSubSystem, subscriptionId` | Returns a list of all storage volumes at a location. |
