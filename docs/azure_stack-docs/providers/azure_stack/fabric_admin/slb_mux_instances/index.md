...
<tr><td><b>Id</b></td><td><code>azure_stack.fabric_admin.slb_mux_instances</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `location, resourceGroupName, subscriptionId` | Returns a list of all software load balancer instances at a location. |
