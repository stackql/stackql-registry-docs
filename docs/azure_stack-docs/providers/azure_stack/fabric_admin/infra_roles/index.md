...
<tr><td><b>Id</b></td><td><code>azure_stack.fabric_admin.infra_roles</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `location, resourceGroupName, subscriptionId` | Returns a list of all infrastructure roles at a location. |
