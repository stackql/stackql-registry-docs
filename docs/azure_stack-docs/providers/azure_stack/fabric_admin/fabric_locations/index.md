...
<tr><td><b>Id</b></td><td><code>azure_stack.fabric_admin.fabric_locations</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `resourceGroupName, subscriptionId` | Returns a list of all fabric locations. |
