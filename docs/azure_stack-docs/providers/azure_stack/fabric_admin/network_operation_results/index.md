...
<tr><td><b>Id</b></td><td><code>azure_stack.fabric_admin.network_operation_results</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `location, resourceGroupName, subscriptionId` | Returns a list of all network operation results at a location. |
