...
<tr><td><b>Id</b></td><td><code>azure_stack.subscriptions_admin.delegated_provider_offers</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `delegatedProviderSubscriptionId, subscriptionId` | Get the list of delegated provider offers. |
