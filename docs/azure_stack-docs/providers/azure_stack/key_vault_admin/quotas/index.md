...
| <CopyableCode code="properties" /> | `object` | Properties for keyvault quotas. |
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="location, subscriptionId" /> | Get a list of all quota objects for KeyVault at a location. |
