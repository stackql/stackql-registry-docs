...
| <CopyableCode code="disable_tenant_subscription_feature" /> | `EXEC` | <CopyableCode code="featureName, location, subscriptionId" /> | Disable the tenant subscription feature. |
| <CopyableCode code="enable_tenant_subscription_feature" /> | `EXEC` | <CopyableCode code="featureName, location, subscriptionId" /> | Enable the tenant subscription feature. |
