...
<tr><td><b>Id</b></td><td><code>azure_stack.compute_admin.disk_migration_jobs</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `location, subscriptionId` | Returns a list of disk migration jobs. |
