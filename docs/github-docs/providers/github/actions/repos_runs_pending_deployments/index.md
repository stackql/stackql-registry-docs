---
title: repos_runs_pending_deployments
hide_title: false
hide_table_of_contents: false
keywords:
  - repos_runs_pending_deployments
  - actions
  - github    
  - stackql
...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>repos_runs_pending_deployments</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><code>github.actions.repos_runs_pending_deployments</code></td></tr>
</tbody></table>
...
| `review_pending_deployments_for_run` | `EXEC` | `owner, repo, run_id, data__comment, data__environment_ids, data__state` | Approve or reject pending deployments that are waiting on approval by a required reviewer.<br /><br />Required reviewers with read access to the repository contents and deployments can use this endpoint. Required reviewers must authenticate using an access token with the `repo` scope to use this endpoint. |
