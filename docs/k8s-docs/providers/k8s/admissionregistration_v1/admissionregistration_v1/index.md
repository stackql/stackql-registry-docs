...
<tr><td><b>Id</b></td><td><code>k8s.admissionregistration_v1.admissionregistration_v1</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `getAdmissionregistrationV1APIResources` | `SELECT` | `cluster_addr, protocol` |
