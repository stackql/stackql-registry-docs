...
<tr><td><b>Id</b></td><td><code>azure_isv.paloaltonetworks.local_rules_counters</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `localRulestackName, priority, resourceGroupName, subscriptionId` |
