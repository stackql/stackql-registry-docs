...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.paloaltonetworks.local_rules_counters" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="localRulestackName, priority, resourceGroupName, subscriptionId" /> |
