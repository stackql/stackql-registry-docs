...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_prefix_list_local_rulestacks', value: 'view', },
        { label: 'prefix_list_local_rulestacks', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>prefix_list_local_rulestacks</code> resource.
...
Deletes the specified <code>prefix_list_local_rulestacks</code> resource.
