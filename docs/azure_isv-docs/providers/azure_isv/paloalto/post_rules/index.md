...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_post_rules', value: 'view', },
        { label: 'post_rules', value: 'resource', },
    ]
}>
<TabItem value="view">
...
Use the following StackQL query and manifest file to create a new <code>post_rules</code> resource.
...
Deletes the specified <code>post_rules</code> resource.
