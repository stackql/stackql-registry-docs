...
Creates, updates, deletes, gets or lists a <code>organization_environment_by_ids</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_organization_environment_by_ids', value: 'view', },
        { label: 'organization_environment_by_ids', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:---------|:------------|
| <CopyableCode code="id" /> | `text` | Id of the environment |
| <CopyableCode code="name" /> | `text` | Display name of the environment |
| <CopyableCode code="environmentId" /> | `text` | field from the `properties` object |
| <CopyableCode code="kind" /> | `text` | Type of environment |
