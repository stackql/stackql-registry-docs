...
Creates, updates, deletes, gets or lists a <code>organization_schema_registry_cluster_by_ids</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_organization_schema_registry_cluster_by_ids', value: 'view', },
        { label: 'organization_schema_registry_cluster_by_ids', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="kind" /> | `text` | Kind of the cluster |
