...
| <CopyableCode code="name" /> | `string` | The name of the agreement. |
| <CopyableCode code="properties" /> | `object` | Terms properties for Marketplace and Confluent. |
| <CopyableCode code="systemData" /> | `object` | Metadata pertaining to creation and last modification of the resource. |
| <CopyableCode code="type" /> | `string` | The type of the agreement. |
## Methods
