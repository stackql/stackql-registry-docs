...
Creates, updates, deletes, gets or lists a <code>and_associate_pl_filters</code> resource.
...
Use the following StackQL query and manifest file to create a new <code>and_associate_pl_filters</code> resource.
