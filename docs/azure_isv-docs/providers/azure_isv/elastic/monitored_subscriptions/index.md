...
| <CopyableCode code="properties" /> | `object` | The request to update subscriptions needed to be monitored by the Elastic monitor resource. |
...
subscriptionId,
type
FROM azure_isv.elastic.vw_monitored_subscriptions
