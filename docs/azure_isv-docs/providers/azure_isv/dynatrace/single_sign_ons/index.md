...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_single_sign_ons', value: 'view', },
        { label: 'single_sign_ons', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:---------|:------------|
| <CopyableCode code="aad_domains" /> | `text` | field from the `properties` object |
...
| Name | Datatype | Description |
|:-----|:---------|:------------|
| <CopyableCode code="properties" /> | `object` | The details of a Dynatrace single sign-on. |
...
| <CopyableCode code="create_or_update" /> | `INSERT` | <CopyableCode code="configurationName, monitorName, resourceGroupName, subscriptionId, data__properties" /> |  |
...
Use the following StackQL query and manifest file to create a new <code>single_sign_ons</code> resource.
