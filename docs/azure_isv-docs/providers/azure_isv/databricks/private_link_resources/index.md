...
<tr><td><b>Id</b></td><td><code>azure_isv.databricks.private_link_resources</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `resourceGroupName, subscriptionId, workspaceName` | List private link resources for a given workspace |
