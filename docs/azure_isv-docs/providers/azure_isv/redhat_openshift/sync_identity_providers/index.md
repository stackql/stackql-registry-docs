...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_isv.redhat_openshift.sync_identity_providers" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="resourceGroupName, resourceName, subscriptionId" /> | The operation returns properties of each SyncIdentityProvider. |
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="childResourceName, resourceGroupName, resourceName, subscriptionId" /> | The operation returns properties of a SyncIdentityProvider. |
