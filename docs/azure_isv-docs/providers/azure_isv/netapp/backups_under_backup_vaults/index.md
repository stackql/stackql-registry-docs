...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="restore_files" /> | `EXEC` | <CopyableCode code="accountName, backupName, backupVaultName, resourceGroupName, subscriptionId, data__destinationVolumeId, data__fileList" /> | Restore the specified files from the specified backup to the active filesystem |
