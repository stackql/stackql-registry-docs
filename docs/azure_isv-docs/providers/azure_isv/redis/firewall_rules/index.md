...
<tr><td><b>Id</b></td><td><code>azure_isv.redis.firewall_rules</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `cacheName, resourceGroupName, subscriptionId` | Gets all firewall rules in the specified redis cache. |
