...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="cacheName, resourceGroupName, subscriptionId" /> | Gets the list of access policy assignments associated with this redis cache |
