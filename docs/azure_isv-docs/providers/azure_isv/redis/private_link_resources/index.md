...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list_by_redis_cache" /> | `SELECT` | <CopyableCode code="cacheName, resourceGroupName, subscriptionId" /> | Gets the private link resources that need to be created for a redis cache. |
