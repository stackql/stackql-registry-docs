...
Operations on a <code>model_permission_levels</code> resource.  
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="getpermissionlevels" /> | `SELECT` | <CopyableCode code="registered_model_id, deployment_name" /> | Gets the permission levels that a user can have on an object. |
