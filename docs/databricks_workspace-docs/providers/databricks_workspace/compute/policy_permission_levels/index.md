...
Operations on a <code>policy_permission_levels</code> resource.  
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="getpermissionlevels" /> | `SELECT` | <CopyableCode code="cluster_policy_id, deployment_name" /> | Gets the permission levels that a user can have on an object. |
