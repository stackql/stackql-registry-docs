...
Operations on a <code>credential_validation</code> resource.  
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="validatecredential" /> | `SELECT` | <CopyableCode code="deployment_name" /> | Validates a credential. |
