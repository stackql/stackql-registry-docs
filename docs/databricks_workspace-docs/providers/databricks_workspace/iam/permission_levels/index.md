...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="getpermissionlevels" /> | `SELECT` | <CopyableCode code="request_object_id, request_object_type, deployment_name" /> | Gets the permission levels that a user can have on an object. |
