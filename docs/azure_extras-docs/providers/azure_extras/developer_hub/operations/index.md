...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | Returns list of operations. |
| <CopyableCode code="generate_preview_artifacts" /> | `EXEC` | <CopyableCode code="location, subscriptionId" /> |  |
| <CopyableCode code="github_oauth" /> | `EXEC` | <CopyableCode code="location, subscriptionId" /> |  |
| <CopyableCode code="github_oauth_callback" /> | `EXEC` | <CopyableCode code="code, location, state, subscriptionId" /> |  |
