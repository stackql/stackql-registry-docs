...
| <CopyableCode code="_list_by_test_base_account" /> | `EXEC` | <CopyableCode code="resourceGroupName, subscriptionId, testBaseAccountName" /> | Lists all the VHDs under a test base account. |
