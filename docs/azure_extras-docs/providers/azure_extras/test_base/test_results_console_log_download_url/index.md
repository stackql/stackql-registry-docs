...
<tr><td><b>Id</b></td><td><code>azure_extras.test_base.test_results_console_log_download_url</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `packageName, resourceGroupName, subscriptionId, testBaseAccountName, testResultName, data__logFileName` |
