...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="resourceUri" /> | List Offer resources by parent |
| <CopyableCode code="_list_by_subscription" /> | `EXEC` | <CopyableCode code="subscriptionId" /> | List Offer resources by subscription |
