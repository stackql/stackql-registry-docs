...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | Lists all of the available Microsoft.Education API operations. |
| <CopyableCode code="redeem_invitation_code" /> | `EXEC` | <CopyableCode code="data__firstName, data__lastName, data__redeemCode" /> | Redeem invite code to join a redeemable lab |
