...
|:-----|:---------|:------------|
| <CopyableCode code="stopSellNotifications" /> | `array` |  |

## Methods
| Name | Accessible by | Required Params | Description |
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="privateStoreId" /> | List stop sell notifications for both stop sell offers and stop sell plans |
