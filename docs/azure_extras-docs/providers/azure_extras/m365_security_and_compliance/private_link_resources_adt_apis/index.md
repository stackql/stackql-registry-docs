...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_private_link_resources_adt_apis', value: 'view', },
        { label: 'private_link_resources_adt_apis', value: 'resource', },
    ]
}>
<TabItem value="view">
...
system_data,
type
FROM azure_extras.m365_security_and_compliance.vw_private_link_resources_adt_apis
