...
<tr><td><b>Id</b></td><td><code>azure_extras.m365_security_and_compliance.operation_results</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `get` | `SELECT` | `locationName, operationResultId, subscriptionId` |
