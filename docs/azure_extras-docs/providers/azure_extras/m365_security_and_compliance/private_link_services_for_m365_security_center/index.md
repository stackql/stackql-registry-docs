...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_private_link_services_for_m365_security_center', value: 'view', },
        { label: 'private_link_services_for_m365_security_center', value: 'resource', },
    ]
}>
<TabItem value="view">
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="resourceGroupName, resourceName, subscriptionId" /> | Get the metadata of a privateLinkServicesForM365SecurityCenter resource. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="subscriptionId" /> | Get all the privateLinkServicesForM365SecurityCenter instances in a subscription. |
...
| <CopyableCode code="create_or_update" /> | `INSERT` | <CopyableCode code="resourceGroupName, resourceName, subscriptionId" /> | Create or update the metadata of a privateLinkServicesForM365SecurityCenter instance. |
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="resourceGroupName, resourceName, subscriptionId" /> | Update the metadata of a privateLinkServicesForM365SecurityCenter instance. |
...
tags,
type
FROM azure_extras.m365_security_and_compliance.vw_private_link_services_for_m365_security_center
...
Use the following StackQL query and manifest file to create a new <code>private_link_services_for_m365_security_center</code> resource.
...
Updates a <code>private_link_services_for_m365_security_center</code> resource.
...
Deletes the specified <code>private_link_services_for_m365_security_center</code> resource.
