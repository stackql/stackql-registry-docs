...
| `_list` | `EXEC` | `subscriptionId` | Get all the privateLinkServicesForEDMUpload instances in a subscription. |
| `_list_by_resource_group` | `EXEC` | `resourceGroupName, subscriptionId` | Get all the service instances in a resource group. |
| `update` | `EXEC` | `resourceGroupName, resourceName, subscriptionId` | Update the metadata of a privateLinkServicesForEDMUpload instance. |
