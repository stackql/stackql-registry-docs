...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_private_link_resources_for_scc_powershell', value: 'view', },
        { label: 'private_link_resources_for_scc_powershell', value: 'resource', },
    ]
}>
<TabItem value="view">
...
system_data,
type
FROM azure_extras.m365_security_and_compliance.vw_private_link_resources_for_scc_powershell
