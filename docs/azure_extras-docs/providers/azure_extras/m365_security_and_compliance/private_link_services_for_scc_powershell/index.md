...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_private_link_services_for_scc_powershell', value: 'view', },
        { label: 'private_link_services_for_scc_powershell', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="resourceGroupName, resourceName, subscriptionId" /> | Update the metadata of a privateLinkServicesForSCCPowershell instance. |
...
tags,
type
FROM azure_extras.m365_security_and_compliance.vw_private_link_services_for_scc_powershell
...
Use the following StackQL query and manifest file to create a new <code>private_link_services_for_scc_powershell</code> resource.
...
Updates a <code>private_link_services_for_scc_powershell</code> resource.
...
Deletes the specified <code>private_link_services_for_scc_powershell</code> resource.
