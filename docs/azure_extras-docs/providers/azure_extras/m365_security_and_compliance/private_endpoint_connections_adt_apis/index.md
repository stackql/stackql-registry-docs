...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_private_endpoint_connections_adt_apis', value: 'view', },
        { label: 'private_endpoint_connections_adt_apis', value: 'resource', },
    ]
}>
<TabItem value="view">
...
system_data,
type
FROM azure_extras.m365_security_and_compliance.vw_private_endpoint_connections_adt_apis
...
Use the following StackQL query and manifest file to create a new <code>private_endpoint_connections_adt_apis</code> resource.
...
Deletes the specified <code>private_endpoint_connections_adt_apis</code> resource.
