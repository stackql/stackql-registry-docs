...
|:-----|:---------|:------------|
| <CopyableCode code="value" /> | `array` | List of supported operations. |

## Methods
| Name | Accessible by | Required Params | Description |
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | Lists all of the available Addons RP operations. |
