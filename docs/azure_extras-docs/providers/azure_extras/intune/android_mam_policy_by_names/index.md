...
Creates, updates, deletes, gets or lists a <code>android_mam_policy_by_names</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_android_mam_policy_by_names', value: 'view', },
        { label: 'android_mam_policy_by_names', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="file_encryption" /> | `text` | field from the `properties` object |
...
| <CopyableCode code="screen_capture" /> | `text` | field from the `properties` object |
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="hostName, policyName" /> | Returns AndroidMAMPolicy with given name. |
