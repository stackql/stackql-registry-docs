...
Creates, updates, deletes, gets or lists a <code>ios_groups_for_mam_policies</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="hostName, policyName" /> | Returns groups for a given iOSMAMPolicy. |
