...
Creates, updates, deletes, gets or lists a <code>ios_group_for_mam_policies</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="delete" /> | `DELETE` | <CopyableCode code="groupId, hostName, policyName" /> | Delete Group for iOS Policy |

## `DELETE` example

Deletes the specified <code>ios_group_for_mam_policies</code> resource.
