...
| <CopyableCode code="_list_by_account" /> | `EXEC` | <CopyableCode code="accountResourceName, resourceGroupName, subscriptionId" /> | Gets the details of the extension resources created within the resource group. |
