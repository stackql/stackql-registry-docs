...
Creates, updates, deletes, gets or lists a <code>observability_services</code> resource.
...
<Tabs
    defaultValue="view"
    values={[
        { label: 'vw_observability_services', value: 'view', },
        { label: 'observability_services', value: 'resource', },
    ]
}>
<TabItem value="view">
...
| <CopyableCode code="observabilityServiceName" /> | `text` | field from the `properties` object |
...
| <CopyableCode code="update_tags" /> | `EXEC` | <CopyableCode code="observabilityServiceName, resourceGroupName, subscriptionId" /> | Update a ObservabilityServiceResource |
...
Use the following StackQL query and manifest file to create a new <code>observability_services</code> resource.
...
Deletes the specified <code>observability_services</code> resource.
