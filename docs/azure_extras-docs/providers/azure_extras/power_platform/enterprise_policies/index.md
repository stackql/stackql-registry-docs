...
<tr><td><b>Id</b></td><td><code>azure_extras.power_platform.enterprise_policies</code></td></tr>
</tbody></table>
...
| `_list_by_resource_group` | `EXEC` | `resourceGroupName, subscriptionId` | Retrieve a list of EnterprisePolicies within a given resource group |
| `_list_by_subscription` | `EXEC` | `subscriptionId` | Retrieve a list of EnterprisePolicies within a subscription |
| `update` | `EXEC` | `enterprisePolicyName, resourceGroupName, subscriptionId` | Updates an EnterprisePolicy |
