...
<tr><td><b>Id</b></td><td><code>azure_extras.power_platform.private_link_resources</code></td></tr>
</tbody></table>
...
| `_list_by_enterprise_policy` | `EXEC` | `enterprisePolicyName, resourceGroupName, subscriptionId` | Gets the private link resources that need to be created for enterprisePolicy. |
