...
| <CopyableCode code="_list_by_enterprise_policy" /> | `EXEC` | <CopyableCode code="enterprisePolicyName, resourceGroupName, subscriptionId" /> | List all private endpoint connections on an EnterprisePolicy. |
