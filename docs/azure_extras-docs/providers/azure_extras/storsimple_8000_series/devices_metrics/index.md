...
<tr><td><b>Id</b></td><td><code>azure_extras.storsimple_8000_series.devices_metrics</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list` | `SELECT` | `$filter, deviceName, managerName, resourceGroupName, subscriptionId` |
| `_list` | `EXEC` | `$filter, deviceName, managerName, resourceGroupName, subscriptionId` |
