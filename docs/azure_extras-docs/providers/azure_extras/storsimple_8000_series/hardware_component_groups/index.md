...
<tr><td><b>Id</b></td><td><code>azure_extras.storsimple_8000_series.hardware_component_groups</code></td></tr>
</tbody></table>
...
| `_list_by_device` | `EXEC` | `deviceName, managerName, resourceGroupName, subscriptionId` | Lists the hardware component groups at device-level. |
