...
| <CopyableCode code="_list_by_device" /> | `EXEC` | <CopyableCode code="deviceName, managerName, resourceGroupName, subscriptionId" /> | Retrieves all the volumes in a device. |
| <CopyableCode code="_list_by_volume_container" /> | `EXEC` | <CopyableCode code="deviceName, managerName, resourceGroupName, subscriptionId, volumeContainerName" /> | Retrieves all the volumes in a volume container. |
