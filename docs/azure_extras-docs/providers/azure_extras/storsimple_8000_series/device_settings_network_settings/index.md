...
| <CopyableCode code="update" /> | `EXEC` | <CopyableCode code="deviceName, managerName, resourceGroupName, subscriptionId, data__properties" /> | Updates the network settings on the specified device. |
