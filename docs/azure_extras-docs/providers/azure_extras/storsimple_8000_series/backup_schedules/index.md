...
| <CopyableCode code="_list_by_backup_policy" /> | `EXEC` | <CopyableCode code="backupPolicyName, deviceName, managerName, resourceGroupName, subscriptionId" /> | Gets all the backup schedules in a backup policy. |
