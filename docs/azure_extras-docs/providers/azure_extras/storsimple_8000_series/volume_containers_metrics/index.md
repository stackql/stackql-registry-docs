...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="$filter, deviceName, managerName, resourceGroupName, subscriptionId, volumeContainerName" /> | Gets the metrics for the specified volume container. |
