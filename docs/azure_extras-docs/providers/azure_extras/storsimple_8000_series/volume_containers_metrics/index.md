...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="$filter, deviceName, managerName, resourceGroupName, subscriptionId, volumeContainerName" /> |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="$filter, deviceName, managerName, resourceGroupName, subscriptionId, volumeContainerName" /> |
