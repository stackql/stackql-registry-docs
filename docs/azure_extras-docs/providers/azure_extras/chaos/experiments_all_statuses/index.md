...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.chaos.experiments_all_statuses" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="api-version, experimentName, resourceGroupName, subscriptionId" /> |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="api-version, experimentName, resourceGroupName, subscriptionId" /> |
