...
<tr><td><b>Id</b></td><td><code>azure_extras.automanage.best_practices</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| `BestPractices_Get` | `SELECT` | `bestPracticeName` | Get information about a Automanage best practice |
| `BestPractices_ListByTenant` | `SELECT` |  | Retrieve a list of Automanage best practices |
