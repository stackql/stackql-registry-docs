...
Creates, updates, deletes, gets or lists a <code>operations_partners</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | This method gets all the operations that are exposed for customer. |
