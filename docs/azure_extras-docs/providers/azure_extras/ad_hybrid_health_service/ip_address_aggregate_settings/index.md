...
<tr><td><b>Id</b></td><td><code>azure_extras.ad_hybrid_health_service.ip_address_aggregate_settings</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| `list_IPAddressAggregateSettings` | `SELECT` | `serviceName` | Gets the IP address aggregate settings. |
| `update_IPAddressAggregateSettings` | `EXEC` | `serviceName` | Updates the IP address aggregate settings alert thresholds. |
