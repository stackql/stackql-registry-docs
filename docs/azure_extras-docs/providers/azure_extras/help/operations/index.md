...
| <CopyableCode code="check_name_availability_check_availability" /> | `EXEC` | <CopyableCode code="scope" /> | This API is used to check the uniqueness of a resource name used for a diagnostic, troubleshooter or solutions |
