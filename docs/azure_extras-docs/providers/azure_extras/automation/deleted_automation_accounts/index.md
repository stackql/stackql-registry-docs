...
<tr><td><b>Id</b></td><td><code>azure_extras.automation.deleted_automation_accounts</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `deletedAutomationAccounts_ListBySubscription` | `SELECT` | `subscriptionId` |
