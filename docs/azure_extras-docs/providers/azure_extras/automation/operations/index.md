...
<tr><td><b>Id</b></td><td><code>azure_extras.automation.operations</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| `Operations_List` | `SELECT` |  | Lists all of the available Automation REST API operations. |
| `convertGraphRunbookContent` | `EXEC` | `automationAccountName, resourceGroupName, subscriptionId` | Post operation to serialize or deserialize GraphRunbookContent |
