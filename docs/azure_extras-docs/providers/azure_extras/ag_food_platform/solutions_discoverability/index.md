...
<tr><td><b>Id</b></td><td><CopyableCode code="azure_extras.ag_food_platform.solutions_discoverability" /></td></tr>
</tbody></table>
...
| <CopyableCode code="list" /> | `SELECT` |  | Get list of Data Manager For Agriculture solutions. |
| <CopyableCode code="_list" /> | `EXEC` |  | Get list of Data Manager For Agriculture solutions. |
