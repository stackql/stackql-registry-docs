...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="" /> | Lists the available operations of Microsoft.AgFoodPlatform resource provider. |
| <CopyableCode code="check_name_availability_check_name_availability" /> | `EXEC` | <CopyableCode code="subscriptionId" /> | Checks the name availability of the resource with requested resource name. |
