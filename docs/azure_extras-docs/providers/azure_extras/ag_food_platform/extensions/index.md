...
| <CopyableCode code="_list_by_data_manager_for_agriculture" /> | `EXEC` | <CopyableCode code="dataManagerForAgricultureResourceName, resourceGroupName, subscriptionId" /> | Get installed extensions details. |
