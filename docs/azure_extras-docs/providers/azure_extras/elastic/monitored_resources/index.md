...
<tr><td><b>Id</b></td><td><code>azure_extras.elastic.monitored_resources</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `MonitoredResources_List` | `SELECT` | `monitorName, resourceGroupName, subscriptionId` |
