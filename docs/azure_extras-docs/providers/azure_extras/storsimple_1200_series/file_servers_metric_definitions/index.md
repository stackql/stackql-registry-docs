...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="deviceName, fileServerName, managerName, resourceGroupName, subscriptionId" /> | Retrieves metric definitions of all metrics aggregated at the file server. |
