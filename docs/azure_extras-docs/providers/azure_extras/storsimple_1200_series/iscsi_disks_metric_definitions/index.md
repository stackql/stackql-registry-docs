...
Creates, updates, deletes, gets or lists a <code>iscsi_disks_metric_definitions</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="deviceName, diskName, iscsiServerName, managerName, resourceGroupName, subscriptionId" /> | Retrieves metric definitions for all metric aggregated at the iSCSI disk. |
