...
Creates, updates, deletes, gets or lists a <code>iscsi_disks_metrics</code> resource.
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="deviceName, diskName, iscsiServerName, managerName, resourceGroupName, subscriptionId" /> | Gets the iSCSI disk metrics |
