...
<tr><td><b>Id</b></td><td><code>azure_extras.device_update.operations</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| `Operations_List` | `SELECT` |  | Returns list of operations for Microsoft.DeviceUpdate resource provider. |
| `CheckNameAvailability` | `EXEC` | `subscriptionId` | Checks ADU resource name availability. |
