...
| <CopyableCode code="correlation_reason" /> | `object` |  |
...
|:-----|:--------------|:----------------|
| <CopyableCode code="list_incident_related_change_events" /> | `SELECT` | <CopyableCode code="id" /> |
| <CopyableCode code="_list_incident_related_change_events" /> | `EXEC` | <CopyableCode code="id" /> |
