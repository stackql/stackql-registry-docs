...
<tr><td><b>Id</b></td><td><code>pagerduty.automation_actions.runners_teams</code></td></tr>
</tbody></table>
...
| `create_automation_actions_runner_team_association` | `INSERT` | `id, data__team` | Associate a runner with a team<br /> |
| `delete_automation_actions_runner_team_association` | `DELETE` | `id, team_id` | Disassociates a runner from a team<br /> |
