...
<tr><td><b>Id</b></td><td><code>pagerduty.escalation_policies.audit_records</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `list_escalation_policy_audit_records` | `SELECT` | `id` |
| `_list_escalation_policy_audit_records` | `EXEC` | `id` |
