...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="show_effective_autokey_config" /> | `EXEC` | <CopyableCode code="projectsId" /> | Returns the effective Cloud KMS Autokey configuration for a given project. |
