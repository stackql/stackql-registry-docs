...
Creates, updates, deletes or gets an <code>app_connection</code> resource or lists <code>app_connections</code> in a region
...
Updates a app_connection only if the necessary resources are available.
...
Deletes the specified app_connection resource.
