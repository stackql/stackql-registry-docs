...
<tr><td><b>Id</b></td><td><CopyableCode code="bigquerydatapolicy.data_policies_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_get_iam_policy" /> | `EXEC` | <CopyableCode code="dataPoliciesId, locationsId, projectsId" /> | Gets the IAM policy for the specified data policy. |
