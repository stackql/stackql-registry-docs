...
<tr><td><b>Id</b></td><td><CopyableCode code="discoveryengine.data_store_operations" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="projects_locations_collections_data_stores_operations_get" /> | `SELECT` | <CopyableCode code="collectionsId, dataStoresId, locationsId, operationsId, projectsId" /> |
