...
<tr><td><b>Id</b></td><td><CopyableCode code="storagetransfer.transfer_operations" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="filter" /> | Lists transfer operations. Operations are ordered by their creation time in reverse chronological order. |
