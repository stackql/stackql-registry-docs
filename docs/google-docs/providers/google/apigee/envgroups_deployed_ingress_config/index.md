...
<tr><td><b>Id</b></td><td><CopyableCode code="apigee.envgroups_deployed_ingress_config" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="organizations_envgroups_get_deployed_ingress_config" /> | `SELECT` | <CopyableCode code="envgroupsId, organizationsId" /> |
