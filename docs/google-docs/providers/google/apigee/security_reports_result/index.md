...
<tr><td><b>Id</b></td><td><CopyableCode code="apigee.security_reports_result" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="organizations_environments_security_reports_get_result" /> | `SELECT` | <CopyableCode code="environmentsId, organizationsId, securityReportsId" /> |
