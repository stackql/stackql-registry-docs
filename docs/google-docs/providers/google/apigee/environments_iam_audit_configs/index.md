...
<tr><td><b>Id</b></td><td><code>google.apigee.environments_iam_audit_configs</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `organizations_environments_getIamPolicy` | `SELECT` | `environmentsId, organizationsId` |
