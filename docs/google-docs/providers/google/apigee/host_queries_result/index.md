...
<tr><td><b>Id</b></td><td><CopyableCode code="apigee.host_queries_result" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="organizations_host_queries_get_result" /> | `SELECT` | <CopyableCode code="hostQueriesId, organizationsId" /> |
