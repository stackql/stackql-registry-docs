...
| <CopyableCode code="displayName" /> | `string` | Display name of the security profile. |
...
| <CopyableCode code="revisionPublishTime" /> | `string` | Output only. The time when revision was published. Once published, the security profile revision cannot be updated further and can be attached to environments. |
