...
Creates, updates, deletes or gets an <code>deployed_ingress_config</code> resource or lists <code>deployed_ingress_config</code> in a region
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="organizations_get_deployed_ingress_config" /> | `SELECT` | <CopyableCode code="organizationsId" /> | Gets the deployed ingress configuration for an organization. |
