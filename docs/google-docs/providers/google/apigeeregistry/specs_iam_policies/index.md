...
<tr><td><b>Id</b></td><td><CopyableCode code="apigeeregistry.specs_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_projects_locations_apis_versions_specs_get_iam_policy" /> | `EXEC` | <CopyableCode code="apisId, locationsId, projectsId, specsId, versionsId" /> | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. |
