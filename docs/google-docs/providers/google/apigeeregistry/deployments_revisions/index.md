...
<tr><td><b>Id</b></td><td><CopyableCode code="apigeeregistry.deployments_revisions" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="projects_locations_apis_deployments_list_revisions" /> | `SELECT` | <CopyableCode code="apisId, deploymentsId, locationsId, projectsId" /> |
| <CopyableCode code="_projects_locations_apis_deployments_list_revisions" /> | `EXEC` | <CopyableCode code="apisId, deploymentsId, locationsId, projectsId" /> |
