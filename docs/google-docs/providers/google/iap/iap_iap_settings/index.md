...
Creates, updates, deletes or gets an <code>iap_iap_setting</code> resource or lists <code>iap_iap_settings</code> in a region
...
Updates a iap_iap_setting only if the necessary resources are available.
