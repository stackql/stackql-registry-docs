...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_taxonomies_policy_tags_get_iam_policy` | `SELECT` | `locationsId, policyTagsId, projectsId, taxonomiesId` | Gets the IAM policy for a policy tag or a taxonomy. |
