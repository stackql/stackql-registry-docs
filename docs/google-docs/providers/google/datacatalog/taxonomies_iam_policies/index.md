...
<tr><td><b>Id</b></td><td><CopyableCode code="datacatalog.taxonomies_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_projects_locations_taxonomies_get_iam_policy" /> | `EXEC` | <CopyableCode code="locationsId, projectsId, taxonomiesId" /> | Gets the IAM policy for a policy tag or a taxonomy. |
