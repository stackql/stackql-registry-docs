...
<tr><td><b>Id</b></td><td><CopyableCode code="contactcenterinsights.views" /></td></tr>
</tbody></table>
...
| <CopyableCode code="patch" /> | `EXEC` | <CopyableCode code="locationsId, projectsId, viewsId" /> | Updates a view. |
