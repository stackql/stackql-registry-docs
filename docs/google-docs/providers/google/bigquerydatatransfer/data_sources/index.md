...
| `_projects_data_sources_list` | `EXEC` | `projectsId` | Lists supported data sources and returns their settings. |
| `_projects_locations_data_sources_list` | `EXEC` | `locationsId, projectsId` | Lists supported data sources and returns their settings. |
