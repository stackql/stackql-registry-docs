...
<tr><td><b>Id</b></td><td><CopyableCode code="baremetalsolution.operations" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="locationsId, operationsId, projectsId" /> |
