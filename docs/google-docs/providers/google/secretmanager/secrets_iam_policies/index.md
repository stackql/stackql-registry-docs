...
<tr><td><b>Id</b></td><td><CopyableCode code="secretmanager.secrets_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_get_iam_policy" /> | `EXEC` | <CopyableCode code="projectsId, secretsId" /> | Gets the access control policy for a secret. Returns empty policy if the secret exists and does not have a policy set. |
