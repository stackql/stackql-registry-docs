...
| `_get_iam_policy` | `EXEC` | `jobsId, locationsId, projectsId` | Gets the IAM Access Control policy currently in effect for the given Job. This result does not include any inherited policies. |
