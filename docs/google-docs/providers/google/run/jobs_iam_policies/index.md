...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_jobs_getIamPolicy` | `SELECT` | `jobsId, locationsId, projectsId` | Get the IAM Access Control policy currently in effect for the given Job. This result does not include any inherited policies. |
