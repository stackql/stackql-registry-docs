...
<tr><td><b>Id</b></td><td><code>google.metastore.backups_iam_audit_configs</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `projects_locations_services_backups_getIamPolicy` | `SELECT` | `backupsId, locationsId, projectsId, servicesId` |
