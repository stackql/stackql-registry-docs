...
Creates, updates, deletes or gets an <code>migration_execution</code> resource or lists <code>migration_executions</code> in a region
...
Deletes the specified migration_execution resource.
