...
<tr><td><b>Id</b></td><td><code>google.metastore.services_iam_bindings</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `projects_locations_services_getIamPolicy` | `SELECT` | `locationsId, projectsId, servicesId` |
