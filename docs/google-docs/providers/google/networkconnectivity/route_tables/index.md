...
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="hubsId, projectsId" /> | Lists route tables in a given project. |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="hubsId, projectsId" /> | Lists route tables in a given project. |
