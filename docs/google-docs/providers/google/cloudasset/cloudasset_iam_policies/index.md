...
<tr><td><b>Id</b></td><td><code>google.cloudasset.cloudasset_iam_policies</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| `analyze_iam_policy` | `EXEC` | `scope` | Analyzes IAM policies to answer which identities have what accesses on which resources. |
