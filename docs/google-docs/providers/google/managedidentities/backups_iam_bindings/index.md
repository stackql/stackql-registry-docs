...
<tr><td><b>Id</b></td><td><code>google.managedidentities.backups_iam_bindings</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `projects_locations_global_domains_backups_getIamPolicy` | `SELECT` | `backupsId, domainsId, projectsId` |
