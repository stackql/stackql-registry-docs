...
Creates, updates, deletes or gets an <code>comment_threads_iam_policy</code> resource or lists <code>comment_threads_iam_policies</code> in a region
...
members,
role
FROM google.dataform.comment_threads_iam_policies
