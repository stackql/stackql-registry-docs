...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_repositories_compilationResults_get` | `SELECT` | `compilationResultsId, locationsId, projectsId, repositoriesId` | Fetches a single CompilationResult. |
| `projects_locations_repositories_compilationResults_list` | `SELECT` | `locationsId, projectsId, repositoriesId` | Lists CompilationResults in a given Repository. |
| `projects_locations_repositories_compilationResults_create` | `INSERT` | `locationsId, projectsId, repositoriesId` | Creates a new CompilationResult in a given project and location. |
| `projects_locations_repositories_compilationResults_query` | `EXEC` | `compilationResultsId, locationsId, projectsId, repositoriesId` | Returns CompilationResultActions in a given CompilationResult. |
