...
<tr><td><b>Id</b></td><td><CopyableCode code="config.revisions" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="deploymentsId, locationsId, projectsId" /> | Lists Revisions of a deployment. |
