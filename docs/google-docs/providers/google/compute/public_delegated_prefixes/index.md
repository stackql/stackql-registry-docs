...
| `_list` | `EXEC` | `project, region` | Lists the PublicDelegatedPrefixes for a project in the given region. |
| `aggregated_list` | `EXEC` | `project` | Lists all PublicDelegatedPrefix resources owned by the specific project across all scopes. |
