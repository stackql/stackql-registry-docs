...
|:-----|:--------------|:----------------|:------------|
| `aggregated_list` | `SELECT` | `project` | Lists all PublicDelegatedPrefix resources owned by the specific project across all scopes. |
...
| `_aggregated_list` | `EXEC` | `project` | Lists all PublicDelegatedPrefix resources owned by the specific project across all scopes. |
