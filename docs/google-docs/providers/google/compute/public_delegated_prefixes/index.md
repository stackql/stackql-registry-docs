...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="aggregated_list" /> | `SELECT` | <CopyableCode code="project" /> | Lists all PublicDelegatedPrefix resources owned by the specific project across all scopes. |
...
| <CopyableCode code="_aggregated_list" /> | `EXEC` | <CopyableCode code="project" /> | Lists all PublicDelegatedPrefix resources owned by the specific project across all scopes. |
