...
| `network` | `string` | [Output Only] The URL of the network which the Network Attachment belongs to. |
...
|:-----|:--------------|:----------------|:------------|
| `networkAttachments_aggregatedList` | `SELECT` | `project` | Retrieves the list of all NetworkAttachment resources, regional and global, available to the specified project. |
| `networkAttachments_get` | `SELECT` | `networkAttachment, project, region` | Returns the specified NetworkAttachment resource in the given scope. |
| `networkAttachments_list` | `SELECT` | `project, region` | Lists the NetworkAttachments for a project in the given scope. |
| `networkAttachments_insert` | `INSERT` | `project, region` | Creates a NetworkAttachment in the specified project in the given scope using the parameters that are included in the request. |
| `networkAttachments_delete` | `DELETE` | `networkAttachment, project, region` | Deletes the specified NetworkAttachment in the given scope |
