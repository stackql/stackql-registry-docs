...
| `_list` | `EXEC` | `project, region` | Lists the NetworkAttachments for a project in the given scope. |
| `aggregated_list` | `EXEC` | `project` | Retrieves the list of all NetworkAttachment resources, regional and global, available to the specified project. |
