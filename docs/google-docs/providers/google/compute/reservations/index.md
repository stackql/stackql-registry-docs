...
| `_list` | `EXEC` | `project, zone` | A list of all the reservations that have been configured for the specified project in specified zone. |
| `aggregated_list` | `EXEC` | `project` | Retrieves an aggregated list of reservations. |
