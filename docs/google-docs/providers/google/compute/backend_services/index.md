...
|:-----|:--------------|:----------------|:------------|
| `get` | `SELECT` | `backendService, project` | Returns the specified BackendService resource. |
...
| `_list` | `EXEC` | `project` | Retrieves the list of BackendService resources available to the specified project. |
...
| `set_edge_security_policy` | `EXEC` | `backendService, project` | Sets the edge security policy for the specified backend service. |
| `set_security_policy` | `EXEC` | `backendService, project` | Sets the Google Cloud Armor security policy for the specified backend service. For more information, see Google Cloud Armor Overview |
