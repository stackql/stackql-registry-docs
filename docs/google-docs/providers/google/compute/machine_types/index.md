...
|:-----|:--------------|:----------------|:------------|
| `aggregated_list` | `SELECT` | `project` | Retrieves an aggregated list of machine types. |
...
| `_aggregated_list` | `EXEC` | `project` | Retrieves an aggregated list of machine types. |
