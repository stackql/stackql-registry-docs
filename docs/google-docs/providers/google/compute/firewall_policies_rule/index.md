...
Creates, updates, deletes or gets an <code>firewall_policies_rule</code> resource or lists <code>firewall_policies_rule</code> in a region
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get_rule" /> | `SELECT` | <CopyableCode code="firewallPolicy" /> | Gets a rule of the specified priority. |
| <CopyableCode code="add_rule" /> | `INSERT` | <CopyableCode code="firewallPolicy" /> | Inserts a rule into a firewall policy. |
| <CopyableCode code="remove_rule" /> | `DELETE` | <CopyableCode code="firewallPolicy" /> | Deletes a rule of the specified priority. |
...
Use the following StackQL query and manifest file to create a new <code>firewall_policies_rule</code> resource.
...
Deletes the specified firewall_policies_rule resource.
