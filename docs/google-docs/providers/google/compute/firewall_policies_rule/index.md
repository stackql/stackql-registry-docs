...
<tr><td><b>Id</b></td><td><CopyableCode code="compute.firewall_policies_rule" /></td></tr>
</tbody></table>
...
| <CopyableCode code="add_rule" /> | `EXEC` | <CopyableCode code="firewallPolicy" /> | Inserts a rule into a firewall policy. |
| <CopyableCode code="remove_rule" /> | `EXEC` | <CopyableCode code="firewallPolicy" /> | Deletes a rule of the specified priority. |
