...
Creates, updates, deletes or gets an <code>region_network_endpoint_groups_network_endpoint</code> resource or lists <code>region_network_endpoint_groups_network_endpoints</code> in a region
