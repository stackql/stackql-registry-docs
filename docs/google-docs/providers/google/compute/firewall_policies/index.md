...
| `_list` | `EXEC` |  | Lists all the policies that have been configured for the specified folder or organization. |
| `clone_rules` | `EXEC` | `firewallPolicy` | Copies rules to the specified firewall policy. |
...
| `patch_rule` | `EXEC` | `firewallPolicy` | Patches a rule of the specified priority. |
