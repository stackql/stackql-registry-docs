...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="httpsHealthCheck, project" /> | Updates a HttpsHealthCheck resource in the specified project using the data included in the request. |
