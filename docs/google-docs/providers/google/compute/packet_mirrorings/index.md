...
|:-----|:--------------|:----------------|:------------|
| `aggregated_list` | `SELECT` | `project` | Retrieves an aggregated list of packetMirrorings. |
...
| `_aggregated_list` | `EXEC` | `project` | Retrieves an aggregated list of packetMirrorings. |
