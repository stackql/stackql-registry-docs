...
| `_list` | `EXEC` | `project, region` | Retrieves a list of commitments contained within the specified region. |
| `aggregated_list` | `EXEC` | `project` | Retrieves an aggregated list of commitments by region. |
