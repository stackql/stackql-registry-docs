...
<tr><td><b>Id</b></td><td><CopyableCode code="compute.region_network_firewall_policies_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_get_iam_policy" /> | `EXEC` | <CopyableCode code="project, region, resource" /> | Gets the access control policy for a resource. May be empty if no such policy or resource exists. |
