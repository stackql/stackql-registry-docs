...
| <CopyableCode code="update" /> | `UPDATE` | <CopyableCode code="healthCheck, project" /> | Updates a HealthCheck resource in the specified project using the data included in the request. |
