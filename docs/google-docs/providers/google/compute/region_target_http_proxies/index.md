...
| `_list` | `EXEC` | `project, region` | Retrieves the list of TargetHttpProxy resources available to the specified project in the specified region. |
| `set_url_map` | `EXEC` | `project, region, targetHttpProxy` | Changes the URL map for TargetHttpProxy. |
