...
<tr><td><b>Id</b></td><td><code>google.compute.region_target_tcp_proxies</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| `regionTargetTcpProxies_get` | `SELECT` | `project, region, targetTcpProxy` | Returns the specified TargetTcpProxy resource. |
| `regionTargetTcpProxies_list` | `SELECT` | `project, region` | Retrieves a list of TargetTcpProxy resources available to the specified project in a given region. |
| `regionTargetTcpProxies_insert` | `INSERT` | `project, region` | Creates a TargetTcpProxy resource in the specified project and region using the data included in the request. |
| `regionTargetTcpProxies_delete` | `DELETE` | `project, region, targetTcpProxy` | Deletes the specified TargetTcpProxy resource. |
