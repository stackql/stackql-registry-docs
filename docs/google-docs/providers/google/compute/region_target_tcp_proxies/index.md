...
| `list` | `SELECT` | `project, region` | Retrieves a list of TargetTcpProxy resources available to the specified project in a given region. |
| `insert` | `INSERT` | `project, region` | Creates a TargetTcpProxy resource in the specified project and region using the data included in the request. |
| `delete` | `DELETE` | `project, region, targetTcpProxy` | Deletes the specified TargetTcpProxy resource. |
| `_list` | `EXEC` | `project, region` | Retrieves a list of TargetTcpProxy resources available to the specified project in a given region. |
