...
| `_list` | `EXEC` | `project` | List all the policies that have been configured for the specified project. |
...
| `patch_rule` | `EXEC` | `project, securityPolicy` | Patches a rule at the specified priority. To clear fields in the rule, leave the fields empty and specify them in the updateMask. |
