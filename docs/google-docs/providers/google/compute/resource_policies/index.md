...
| `_list` | `EXEC` | `project, region` | A list all the resource policies that have been configured for the specified project in specified region. |
| `aggregated_list` | `EXEC` | `project` | Retrieves an aggregated list of resource policies. |
