...
<tr><td><b>Id</b></td><td><CopyableCode code="compute.region_security_policies_rule" /></td></tr>
</tbody></table>
...
| <CopyableCode code="add_rule" /> | `EXEC` | <CopyableCode code="project, region, securityPolicy" /> | Inserts a rule into a security policy. |
| <CopyableCode code="remove_rule" /> | `EXEC` | <CopyableCode code="project, region, securityPolicy" /> | Deletes a rule at the specified priority. |
