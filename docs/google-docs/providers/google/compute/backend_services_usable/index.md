...
Creates, updates, deletes or gets an <code>backend_services_usable</code> resource or lists <code>backend_services_usable</code> in a region
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list_usable" /> | `SELECT` | <CopyableCode code="project" /> | Retrieves a list of all usable backend services in the specified project. |
