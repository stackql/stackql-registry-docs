...
|:-----|:--------------|:----------------|:------------|
| `get` | `SELECT` | `firewallPolicy, project, region` | Returns the specified network firewall policy. |
| `list` | `SELECT` | `project, region` | Lists all the network firewall policies that have been configured for the specified project in the given region. |
| `insert` | `INSERT` | `project, region` | Creates a new network firewall policy in the specified project and region. |
| `delete` | `DELETE` | `firewallPolicy, project, region` | Deletes the specified network firewall policy. |
| `_list` | `EXEC` | `project, region` | Lists all the network firewall policies that have been configured for the specified project in the given region. |
| `clone_rules` | `EXEC` | `firewallPolicy, project, region` | Copies rules to the specified network firewall policy. |
| `patch` | `EXEC` | `firewallPolicy, project, region` | Patches the specified network firewall policy. |
| `patch_rule` | `EXEC` | `firewallPolicy, project, region` | Patches a rule of the specified priority. |
