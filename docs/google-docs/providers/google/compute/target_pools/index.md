...
| `_list` | `EXEC` | `project, region` | Retrieves a list of target pools available to the specified project and region. |
| `aggregated_list` | `EXEC` | `project` | Retrieves an aggregated list of target pools. |
