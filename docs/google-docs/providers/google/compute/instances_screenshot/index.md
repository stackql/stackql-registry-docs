...
<tr><td><b>Id</b></td><td><CopyableCode code="compute.instances_screenshot" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get_screenshot" /> | `SELECT` | <CopyableCode code="instance, project, zone" /> |
