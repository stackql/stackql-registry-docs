...
<tr><td><b>Id</b></td><td><CopyableCode code="compute.instance_group_managers_errors" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="list_errors" /> | `SELECT` | <CopyableCode code="instanceGroupManager, project, zone" /> |
