...
| `globalAddresses_setLabels` | `EXEC` | `project, resource` | Sets the labels on a GlobalAddress. To learn more about labels, read the Labeling Resources documentation. |
