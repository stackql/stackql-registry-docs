...
Creates, updates, deletes or gets an <code>disks_resource_policy</code> resource or lists <code>disks_resource_policies</code> in a region
...
Deletes the specified disks_resource_policy resource.
