...
<tr><td><b>Id</b></td><td><code>google.compute.backend_services_iam_policies</code></td></tr>
</tbody></table>
...
| `_get_iam_policy` | `EXEC` | `project, resource` | Gets the access control policy for a resource. May be empty if no such policy or resource exists. |
