...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="forwardingRule, project" /> | Returns the specified GlobalForwardingRule resource. Gets a list of available forwarding rules by making a list() request. |
...
Use the following StackQL query and manifest file to create a new <code>global_forwarding_rules</code> resource.
