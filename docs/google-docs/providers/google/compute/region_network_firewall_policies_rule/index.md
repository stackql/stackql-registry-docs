...
Creates, updates, deletes or gets an <code>region_network_firewall_policies_rule</code> resource or lists <code>region_network_firewall_policies_rule</code> in a region
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get_rule" /> | `SELECT` | <CopyableCode code="firewallPolicy, project, region" /> | Gets a rule of the specified priority. |
| <CopyableCode code="add_rule" /> | `INSERT` | <CopyableCode code="firewallPolicy, project, region" /> | Inserts a rule into a network firewall policy. |
| <CopyableCode code="remove_rule" /> | `DELETE` | <CopyableCode code="firewallPolicy, project, region" /> | Deletes a rule of the specified priority. |
...
Use the following StackQL query and manifest file to create a new <code>region_network_firewall_policies_rule</code> resource.
...
Deletes the specified region_network_firewall_policies_rule resource.
