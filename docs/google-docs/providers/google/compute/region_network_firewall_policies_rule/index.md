...
|:-----|:--------------|:----------------|:------------|
| `get_rule` | `SELECT` | `firewallPolicy, project, region` | Gets a rule of the specified priority. |
| `add_rule` | `EXEC` | `firewallPolicy, project, region` | Inserts a rule into a network firewall policy. |
| `remove_rule` | `EXEC` | `firewallPolicy, project, region` | Deletes a rule of the specified priority. |
