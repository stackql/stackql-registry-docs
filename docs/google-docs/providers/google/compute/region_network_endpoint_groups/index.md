...
|:-----|:--------------|:----------------|:------------|
| `get` | `SELECT` | `networkEndpointGroup, project, region` | Returns the specified network endpoint group. |
...
| `_list` | `EXEC` | `project, region` | Retrieves the list of regional network endpoint groups available to the specified project in the given region. |
