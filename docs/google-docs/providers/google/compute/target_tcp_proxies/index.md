...
| `targetTcpProxies_aggregatedList` | `EXEC` | `project` | Retrieves the list of all TargetTcpProxy resources, regional and global, available to the specified project. |
