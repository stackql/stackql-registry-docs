...
| `_list` | `EXEC` | `project, zone` | Retrieves a list of TargetInstance resources available to the specified project and zone. |
| `aggregated_list` | `EXEC` | `project` | Retrieves an aggregated list of target instances. |
