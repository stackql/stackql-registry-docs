...
|:-----|:--------------|:----------------|:------------|
| `get` | `SELECT` | `project, targetHttpProxy` | Returns the specified TargetHttpProxy resource. |
...
| `_list` | `EXEC` | `project` | Retrieves the list of TargetHttpProxy resources available to the specified project. |
...
| `set_url_map` | `EXEC` | `project, targetHttpProxy` | Changes the URL map for TargetHttpProxy. |
