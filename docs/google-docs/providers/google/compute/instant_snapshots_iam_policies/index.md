...
Creates, updates, deletes, gets or lists a <code>instant_snapshots_iam_policies</code> resource.
...
Replaces all fields in the specified <code>instant_snapshots_iam_policies</code> resource.
