...
| `_list` | `EXEC` | `project, region` | Retrieves the list of interconnect attachments contained within the specified region. |
| `aggregated_list` | `EXEC` | `project` | Retrieves an aggregated list of interconnect attachments. |
