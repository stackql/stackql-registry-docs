...
| `insert` | `INSERT` | `project` | Returns the specified SSL policy resource. |
...
| `_list` | `EXEC` | `project` | Lists all the SSL policies that have been configured for the specified project. |
