...
|:-----|:--------------|:----------------|:------------|
| `aggregated_list` | `SELECT` | `project` | Retrieves an aggregated list of persistent disks. |
...
| `_aggregated_list` | `EXEC` | `project` | Retrieves an aggregated list of persistent disks. |
