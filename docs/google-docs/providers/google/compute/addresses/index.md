...
| `_list` | `EXEC` | `project, region` | Retrieves a list of addresses contained within the specified region. |
| `aggregated_list` | `EXEC` | `project` | Retrieves an aggregated list of addresses. |
| `move` | `EXEC` | `address, project, region` | Moves the specified address resource. |
| `set_labels` | `EXEC` | `project, region, resource` | Sets the labels on an Address. To learn more about labels, read the Labeling Resources documentation. |
