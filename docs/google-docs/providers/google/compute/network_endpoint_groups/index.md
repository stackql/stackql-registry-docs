...
|:-----|:--------------|:----------------|:------------|
| `aggregated_list` | `SELECT` | `project` | Retrieves the list of network endpoint groups and sorts them by zone. |
...
| `_aggregated_list` | `EXEC` | `project` | Retrieves the list of network endpoint groups and sorts them by zone. |
