...
Creates, updates, deletes or gets an <code>network_endpoint_group</code> resource or lists <code>network_endpoint_groups</code> in a region
...
Deletes the specified network_endpoint_group resource.
