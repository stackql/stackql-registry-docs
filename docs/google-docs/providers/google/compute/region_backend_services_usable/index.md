...
<tr><td><b>Id</b></td><td><CopyableCode code="compute.region_backend_services_usable" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="list_usable" /> | `SELECT` | <CopyableCode code="project, region" /> |
