...
<tr><td><b>Id</b></td><td><code>google.bigtableadmin.backups_iam_audit_configs</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `projects_instances_clusters_backups_getIamPolicy` | `SELECT` | `backupsId, clustersId, instancesId, projectsId` |
