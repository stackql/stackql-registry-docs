...
<tr><td><b>Id</b></td><td><CopyableCode code="bigtableadmin.authorized_views_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_get_iam_policy" /> | `EXEC` | <CopyableCode code="authorizedViewsId, instancesId, projectsId, tablesId" /> | Gets the access control policy for a Bigtable resource. Returns an empty policy if the resource exists but does not have a policy set. |
