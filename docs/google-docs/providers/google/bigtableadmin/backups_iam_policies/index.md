...
|:-----|:--------------|:----------------|:------------|
| `get_iam_policy` | `SELECT` | `backupsId, clustersId, instancesId, projectsId` | Gets the access control policy for a Table resource. Returns an empty policy if the resource exists but does not have a policy set. |
| `_get_iam_policy` | `EXEC` | `backupsId, clustersId, instancesId, projectsId` | Gets the access control policy for a Table resource. Returns an empty policy if the resource exists but does not have a policy set. |
