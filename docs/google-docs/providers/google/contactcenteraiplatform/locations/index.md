...
| `projects_locations_queryContactCenterQuota` | `EXEC` | `locationsId, projectsId` | Queries the contact center quota, an aggregation over all the projects, that belongs to the billing account, which the input project belongs to. |
