...
<tr><td><b>Id</b></td><td><CopyableCode code="servicemanagement.operations" /></td></tr>
</tbody></table>
...
| <CopyableCode code="list" /> | `SELECT` |  | Lists service operations that match the specified filter in the request. |
| <CopyableCode code="_list" /> | `EXEC` |  | Lists service operations that match the specified filter in the request. |
