...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudidentity.memberships_membership_graph" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="get_membership_graph" /> | `SELECT` | <CopyableCode code="groupsId" /> |
