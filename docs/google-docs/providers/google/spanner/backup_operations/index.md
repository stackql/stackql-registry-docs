...
<tr><td><b>Id</b></td><td><CopyableCode code="spanner.backup_operations" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="projects_instances_backup_operations_list" /> | `SELECT` | <CopyableCode code="instancesId, projectsId" /> |
| <CopyableCode code="_projects_instances_backup_operations_list" /> | `EXEC` | <CopyableCode code="instancesId, projectsId" /> |
