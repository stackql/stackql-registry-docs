...
|:-----|:--------------|:----------------|
| <CopyableCode code="projects_instance_config_operations_list" /> | `SELECT` | <CopyableCode code="projectsId" /> |
| <CopyableCode code="_projects_instance_config_operations_list" /> | `EXEC` | <CopyableCode code="projectsId" /> |
