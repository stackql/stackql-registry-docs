...
<tr><td><b>Id</b></td><td><CopyableCode code="spanner.databases" /></td></tr>
</tbody></table>
...
| <CopyableCode code="enableDropProtection" /> | `boolean` | Whether drop protection is enabled for this database. Defaults to false, if not set. For more details, please see how to [prevent accidental database deletion](https://cloud.google.com/spanner/docs/prevent-database-deletion). |
...
| <CopyableCode code="_projects_instances_databases_list" /> | `EXEC` | <CopyableCode code="instancesId, projectsId" /> | Lists Cloud Spanner databases. |
