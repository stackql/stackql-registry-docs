...
<tr><td><b>Id</b></td><td><CopyableCode code="spanner.instance_partition_operations" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="projects_instances_instance_partition_operations_list" /> | `SELECT` | <CopyableCode code="instancesId, projectsId" /> |
| <CopyableCode code="_projects_instances_instance_partition_operations_list" /> | `EXEC` | <CopyableCode code="instancesId, projectsId" /> |
