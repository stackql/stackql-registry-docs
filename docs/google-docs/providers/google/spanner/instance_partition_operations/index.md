...
Creates, updates, deletes or gets an <code>instance_partition_operation</code> resource or lists <code>instance_partition_operations</code> in a region
