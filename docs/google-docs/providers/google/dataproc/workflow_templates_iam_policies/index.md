...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_workflow_templates_get_iam_policy` | `SELECT` | `locationsId, projectsId, workflowTemplatesId` | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. |
| `projects_regions_workflow_templates_get_iam_policy` | `SELECT` | `projectsId, regionsId, workflowTemplatesId` | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. |
