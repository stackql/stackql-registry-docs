...
Creates, updates, deletes or gets an <code>session_template</code> resource or lists <code>session_templates</code> in a region
...
Updates a session_template only if the necessary resources are available.
...
Deletes the specified session_template resource.
