...
<tr><td><b>Id</b></td><td><CopyableCode code="dataproc.clusters_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_projects_regions_clusters_get_iam_policy" /> | `EXEC` | <CopyableCode code="clustersId, projectsId, regionsId" /> | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. |
