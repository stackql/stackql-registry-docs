...
<tr><td><b>Id</b></td><td><CopyableCode code="artifactregistry.repositories_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_get_iam_policy" /> | `EXEC` | <CopyableCode code="locationsId, projectsId, repositoriesId" /> | Gets the IAM policy for a given resource. |
