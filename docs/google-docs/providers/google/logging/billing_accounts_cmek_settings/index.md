...
<tr><td><b>Id</b></td><td><CopyableCode code="logging.billing_accounts_cmek_settings" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="billing_accounts_get_cmek_settings" /> | `SELECT` | <CopyableCode code="billingAccountsId" /> |
