...
Creates, updates, deletes or gets an <code>consent</code> resource or lists <code>consents</code> in a region
...
Updates a consent only if the necessary resources are available.
...
Deletes the specified consent resource.
