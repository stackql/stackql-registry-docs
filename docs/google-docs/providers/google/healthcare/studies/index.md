...
| <CopyableCode code="set_blob_storage_settings" /> | `EXEC` | <CopyableCode code="datasetsId, dicomStoresId, locationsId, projectsId, studiesId" /> | SetBlobStorageSettings sets the blob storage settings of the specified resources. |
