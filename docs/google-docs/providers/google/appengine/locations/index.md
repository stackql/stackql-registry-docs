...
<tr><td><b>Id</b></td><td><CopyableCode code="appengine.locations" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="get" /> | `SELECT` | <CopyableCode code="appsId, locationsId" /> | Gets information about a location. |
| <CopyableCode code="list" /> | `SELECT` | <CopyableCode code="appsId" /> | Lists information about the supported locations for this service. |
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="appsId" /> | Lists information about the supported locations for this service. |
