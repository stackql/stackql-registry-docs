...
<tr><td><b>Id</b></td><td><code>google.workstations.iam_policies</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_workstationClusters_workstationConfigs_workstations_getIamPolicy` | `SELECT` | `locationsId, projectsId, workstationClustersId, workstationConfigsId, workstationsId` | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. |
