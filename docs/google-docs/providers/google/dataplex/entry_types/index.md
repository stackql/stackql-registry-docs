...
Creates, updates, deletes or gets an <code>entry_type</code> resource or lists <code>entry_types</code> in a region
...
Updates a entry_type only if the necessary resources are available.
...
Deletes the specified entry_type resource.
