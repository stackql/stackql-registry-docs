...
<tr><td><b>Id</b></td><td><CopyableCode code="dataplex.data_scans_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_projects_locations_data_scans_get_iam_policy" /> | `EXEC` | <CopyableCode code="dataScansId, locationsId, projectsId" /> | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set. |
