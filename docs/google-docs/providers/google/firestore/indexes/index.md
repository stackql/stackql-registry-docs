...
<tr><td><b>Id</b></td><td><CopyableCode code="firestore.indexes" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="collectionGroupsId, databasesId, projectsId" /> | Lists composite indexes. |
