...
<tr><td><b>Id</b></td><td><CopyableCode code="storage.managed_folders_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_get_iam_policy" /> | `EXEC` | <CopyableCode code="bucket, managedFolder" /> | Returns an IAM policy for the specified managed folder. |
