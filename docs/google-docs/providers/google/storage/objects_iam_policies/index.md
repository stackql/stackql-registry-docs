...
|:-----|:--------------|:----------------|:------------|
| `get_iam_policy` | `SELECT` | `bucket, object` | Returns an IAM policy for the specified object. |
| `_get_iam_policy` | `EXEC` | `bucket, object` | Returns an IAM policy for the specified object. |
| `set_iam_policy` | `EXEC` | `bucket, object` | Updates an IAM policy for the specified object. |
| `test_iam_permissions` | `EXEC` | `bucket, object, permissions` | Tests a set of permissions on the given object to see which, if any, are held by the caller. |
