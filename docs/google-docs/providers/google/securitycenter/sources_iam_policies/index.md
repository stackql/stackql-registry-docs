...
<tr><td><b>Id</b></td><td><CopyableCode code="securitycenter.sources_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_organizations_sources_get_iam_policy" /> | `EXEC` | <CopyableCode code="organizationsId, sourcesId" /> | Gets the access control policy on the specified Source. |
