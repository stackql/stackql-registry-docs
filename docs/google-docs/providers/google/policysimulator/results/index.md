...
| `_folders_locations_replays_results_list` | `EXEC` | `foldersId, locationsId, replaysId` |
| `_organizations_locations_replays_results_list` | `EXEC` | `locationsId, organizationsId, replaysId` |
| `_projects_locations_replays_results_list` | `EXEC` | `locationsId, projectsId, replaysId` |
