...
| `projects_locations_pipelines_list` | `SELECT` | `locationsId, projectsId` | Lists pipelines. Returns a "FORBIDDEN" error if the caller doesn't have permission to access it. |
