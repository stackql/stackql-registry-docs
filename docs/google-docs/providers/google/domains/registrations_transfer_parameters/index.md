...
Creates, updates, deletes or gets an <code>registrations_transfer_parameter</code> resource or lists <code>registrations_transfer_parameters</code> in a region
