...
Creates, updates, deletes or gets an <code>registrations_register_parameter</code> resource or lists <code>registrations_register_parameters</code> in a region
