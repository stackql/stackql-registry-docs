...
Creates, updates, deletes or gets an <code>registrations_authorization_code</code> resource or lists <code>registrations_authorization_code</code> in a region
