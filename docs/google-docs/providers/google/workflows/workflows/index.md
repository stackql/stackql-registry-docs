...
|:-----|:---------|:------------|
| <CopyableCode code="name" /> | `string` | The resource name of the workflow. Format: projects/&#123;project&#125;/locations/&#123;location&#125;/workflows/&#123;workflow&#125; |
| <CopyableCode code="description" /> | `string` | Description of the workflow provided by the user. Must be at most 1000 unicode characters long. |
...
| <CopyableCode code="createTime" /> | `string` | Output only. The timestamp for when the workflow was created. |
...
| <CopyableCode code="updateTime" /> | `string` | Output only. The timestamp for when the workflow was last updated. |
| <CopyableCode code="userEnvVars" /> | `object` | Optional. User-defined environment variables associated with this workflow revision. This map has a maximum length of 20. Each string can take up to 40KiB. Keys cannot be empty strings and cannot start with “GOOGLE” or “WORKFLOWS". |
## Methods
