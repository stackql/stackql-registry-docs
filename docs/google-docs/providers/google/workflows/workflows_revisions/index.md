...
<tr><td><b>Id</b></td><td><CopyableCode code="workflows.workflows_revisions" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="list_revisions" /> | `SELECT` | <CopyableCode code="locationsId, projectsId, workflowsId" /> |
| <CopyableCode code="_list_revisions" /> | `EXEC` | <CopyableCode code="locationsId, projectsId, workflowsId" /> |
