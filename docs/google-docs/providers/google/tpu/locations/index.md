...
<tr><td><b>Id</b></td><td><CopyableCode code="tpu.locations" /></td></tr>
</tbody></table>
...
| <CopyableCode code="generate_service_identity" /> | `EXEC` | <CopyableCode code="locationsId, projectsId" /> | Generates the Cloud TPU service identity for the project. |
