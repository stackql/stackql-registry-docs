...
<tr><td><b>Id</b></td><td><CopyableCode code="dialogflow.flows" /></td></tr>
</tbody></table>
...
| <CopyableCode code="projects_locations_agents_flows_patch" /> | `EXEC` | <CopyableCode code="agentsId, flowsId, locationsId, projectsId" /> | Updates the specified flow. Note: You should always train a flow prior to sending it queries. See the [training documentation](https://cloud.google.com/dialogflow/cx/docs/concept/training). |
