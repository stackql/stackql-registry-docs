...
<tr><td><b>Id</b></td><td><CopyableCode code="dialogflow.results" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_projects_locations_agents_test_cases_results_list" /> | `EXEC` | <CopyableCode code="agentsId, locationsId, projectsId, testCasesId" /> | Fetches the list of run results for the given test case. A maximum of 100 results are kept for each test case. |
