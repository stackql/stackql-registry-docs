...
|:-----|:--------------|:----------------|:------------|
| `get` | `SELECT` | `httpRoutesId, locationsId, projectsId` | Gets details of a single HttpRoute. |
| `list` | `SELECT` | `locationsId, projectsId` | Lists HttpRoute in a given project and location. |
| `create` | `INSERT` | `locationsId, projectsId` | Creates a new HttpRoute in a given project and location. |
| `delete` | `DELETE` | `httpRoutesId, locationsId, projectsId` | Deletes a single HttpRoute. |
| `_list` | `EXEC` | `locationsId, projectsId` | Lists HttpRoute in a given project and location. |
| `patch` | `EXEC` | `httpRoutesId, locationsId, projectsId` | Updates the parameters of a single HttpRoute. |
