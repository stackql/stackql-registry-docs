...
<tr><td><b>Id</b></td><td><CopyableCode code="networkservices.service_lb_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="patch" /> | `EXEC` | <CopyableCode code="locationsId, projectsId, serviceLbPoliciesId" /> | Updates the parameters of a single ServiceLbPolicy. |
