...
| <CopyableCode code="ignoreRecsDenylist" /> | `boolean` | When the flag is enabled, the products in the denylist will not be filtered out in the recommendation filtering results. |
