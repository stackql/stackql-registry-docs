---
title: catalogs__completion_config
hide_title: false
hide_table_of_contents: false
keywords:
  - catalogs__completion_config
  - retail
  - google    
  - stackql
...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><code>catalogs__completion_config</code></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><code>google.retail.catalogs__completion_config</code></td></tr>
</tbody></table>
...
| `lastSuggestionsImportOperation` | `string` | Output only. Name of the LRO corresponding to the latest suggestion terms list import. Can use GetOperation API to retrieve the latest state of the Long Running Operation. |
...
|:-----|:--------------|:----------------|
| `projects_locations_catalogs_getCompletionConfig` | `SELECT` | `catalogsId, locationsId, projectsId` |
