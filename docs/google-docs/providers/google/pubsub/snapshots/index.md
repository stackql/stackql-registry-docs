...
<tr><td><b>Id</b></td><td><CopyableCode code="pubsub.snapshots" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_projects_snapshots_list" /> | `EXEC` | <CopyableCode code="projectsId" /> | Lists the existing snapshots. Snapshots are used in [Seek]( https://cloud.google.com/pubsub/docs/replay-overview) operations, which allow you to manage message acknowledgments in bulk. That is, you can set the acknowledgment state of messages in an existing subscription to the state captured by a snapshot. |
| <CopyableCode code="_projects_topics_snapshots_list" /> | `EXEC` | <CopyableCode code="projectsId, topicsId" /> | Lists the names of the snapshots on this topic. Snapshots are used in [Seek](https://cloud.google.com/pubsub/docs/replay-overview) operations, which allow you to manage message acknowledgments in bulk. That is, you can set the acknowledgment state of messages in an existing subscription to the state captured by a snapshot. |
