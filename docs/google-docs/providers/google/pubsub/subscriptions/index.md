...
<tr><td><b>Id</b></td><td><CopyableCode code="pubsub.subscriptions" /></td></tr>
</tbody></table>
...
| <CopyableCode code="projects_subscriptions_patch" /> | `EXEC` | <CopyableCode code="projectsId, subscriptionsId" /> | Updates an existing subscription by updating the fields specified in the update mask. Note that certain properties of a subscription, such as its topic, are not modifiable. |
