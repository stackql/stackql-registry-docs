...
<tr><td><b>Id</b></td><td><CopyableCode code="aiplatform.batch_prediction_jobs" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="locationsId, projectsId" /> | Lists BatchPredictionJobs in a Location. |
