...
<tr><td><b>Id</b></td><td><code>google.aiplatform.experiments</code></td></tr>
</tbody></table>
...
| `_list` | `EXEC` | `locationsId, projectsId, tensorboardsId` | Lists TensorboardExperiments in a Location. |
| `patch` | `EXEC` | `experimentsId, locationsId, projectsId, tensorboardsId` | Updates a TensorboardExperiment. |
