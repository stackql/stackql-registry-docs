...
<tr><td><b>Id</b></td><td><CopyableCode code="aiplatform.custom_jobs" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="locationsId, projectsId" /> | Lists CustomJobs in a Location. |
