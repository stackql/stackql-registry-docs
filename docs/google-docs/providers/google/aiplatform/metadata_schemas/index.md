...
<tr><td><b>Id</b></td><td><CopyableCode code="aiplatform.metadata_schemas" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_list" /> | `EXEC` | <CopyableCode code="locationsId, metadataStoresId, projectsId" /> | Lists MetadataSchemas. |
