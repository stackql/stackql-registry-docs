...
<tr><td><b>Id</b></td><td><CopyableCode code="aiplatform.models_versions" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="list_versions" /> | `SELECT` | <CopyableCode code="locationsId, modelsId, projectsId" /> |
| <CopyableCode code="_list_versions" /> | `EXEC` | <CopyableCode code="locationsId, modelsId, projectsId" /> |
