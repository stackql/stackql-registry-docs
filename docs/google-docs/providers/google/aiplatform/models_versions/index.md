...
Creates, updates, deletes or gets an <code>models_version</code> resource or lists <code>models_versions</code> in a region
...
|:-----|:--------------|:----------------|:------------|
| <CopyableCode code="list_versions" /> | `SELECT` | <CopyableCode code="locationsId, modelsId, projectsId" /> | Lists versions of the specified model. |
