...
Creates, updates, deletes or gets an <code>relyingparty_oob_confirmation_code</code> resource or lists <code>relyingparty_oob_confirmation_code</code> in a region
