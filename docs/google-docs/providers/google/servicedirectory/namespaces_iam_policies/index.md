...
|:-----|:--------------|:----------------|:------------|
| `projects_locations_namespaces_getIamPolicy` | `SELECT` | `locationsId, namespacesId, projectsId` | Gets the IAM Policy for a resource (namespace or service only). |
| `projects_locations_namespaces_setIamPolicy` | `EXEC` | `locationsId, namespacesId, projectsId` | Sets the IAM Policy for a resource (namespace or service only). |
| `projects_locations_namespaces_testIamPermissions` | `EXEC` | `locationsId, namespacesId, projectsId` | Tests IAM permissions for a resource (namespace or service only). |
