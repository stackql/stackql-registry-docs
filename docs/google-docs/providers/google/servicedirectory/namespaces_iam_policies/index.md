...
|:-----|:--------------|:----------------|:------------|
| `get_iam_policy` | `SELECT` | `locationsId, namespacesId, projectsId` | Gets the IAM Policy for a resource (namespace or service only). |
| `_get_iam_policy` | `EXEC` | `locationsId, namespacesId, projectsId` | Gets the IAM Policy for a resource (namespace or service only). |
