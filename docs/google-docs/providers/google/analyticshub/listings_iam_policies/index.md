...
<tr><td><b>Id</b></td><td><CopyableCode code="analyticshub.listings_iam_policies" /></td></tr>
</tbody></table>
...
| <CopyableCode code="_projects_locations_data_exchanges_listings_get_iam_policy" /> | `EXEC` | <CopyableCode code="dataExchangesId, listingsId, locationsId, projectsId" /> | Gets the IAM policy. |
