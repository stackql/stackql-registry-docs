...
<tr><td><b>Id</b></td><td><CopyableCode code="analyticshub.data_exchanges_subscriptions" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="projects_locations_data_exchanges_list_subscriptions" /> | `SELECT` | <CopyableCode code="dataExchangesId, locationsId, projectsId" /> |
| <CopyableCode code="_projects_locations_data_exchanges_list_subscriptions" /> | `EXEC` | <CopyableCode code="dataExchangesId, locationsId, projectsId" /> |
