...
| `_projects_locations_product_sets_list` | `EXEC` | `locationsId, projectsId` | Lists ProductSets in an unspecified order. Possible errors: * Returns INVALID_ARGUMENT if page_size is greater than 100, or less than 1. |
