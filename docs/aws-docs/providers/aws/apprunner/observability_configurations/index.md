...
Used to retrieve a list of <code>observability_configurations</code> in a region or create a <code>observability_configurations</code> resource, use <code>observability_configuration</code> to operate on an individual resource.
