...
---
Used to retrieve a list of <code>capabilities</code> in a region or create a <code>capabilities</code> resource, use <code>capability</code> to operate on an individual resource.
