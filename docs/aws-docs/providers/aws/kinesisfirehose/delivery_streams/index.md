...
Used to retrieve a list of <code>delivery_streams</code> in a region or create a <code>delivery_streams</code> resource, use <code>delivery_stream</code> to operate on an individual resource.
