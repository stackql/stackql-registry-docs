...
Gets or updates an individual <code>location_s3</code> resource, use <code>location_s3s</code> to retrieve a list of resources or to create or delete a resource.
