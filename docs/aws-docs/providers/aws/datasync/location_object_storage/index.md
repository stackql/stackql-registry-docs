...
Gets or operates on an individual <code>location_object_storage</code> resource, use <code>location_object_storages</code> to retrieve a list of resources or to create a resource.
