...
Gets or operates on an individual <code>locationf_sx_ontap</code> resource, use <code>locationf_sx_ontaps</code> to retrieve a list of resources or to create a resource.
