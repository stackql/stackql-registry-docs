...
<tr><td><code>SizeConstraints</code></td><td><code>array</code></td><td></td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.wafregional.size_constraint_set<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;Id&gt;'
</pre>
