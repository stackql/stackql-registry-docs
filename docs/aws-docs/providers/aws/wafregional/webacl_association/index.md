...
<tr><td><code>WebACLId</code></td><td><code>string</code></td><td></td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.wafregional.webacl_association<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;Id&gt;'
</pre>
