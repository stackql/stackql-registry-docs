...
Gets or updates an individual <code>channel_group</code> resource, use <code>channel_groups</code> to retrieve a list of resources or to create or delete a resource.
