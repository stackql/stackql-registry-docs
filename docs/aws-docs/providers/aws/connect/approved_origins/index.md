...
Used to retrieve a list of <code>approved_origins</code> in a region or create a <code>approved_origins</code> resource, use <code>approved_origin</code> to operate on an individual resource.
