...
Gets or operates on an individual <code>approved_origin</code> resource, use <code>approved_origins</code> to retrieve a list of resources or to create a resource.
