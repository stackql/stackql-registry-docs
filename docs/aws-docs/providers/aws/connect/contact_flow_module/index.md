...
<tr><td><code>ContactFlowModuleArn</code></td><td><code>string</code></td><td>The identifier of the contact flow module (ARN).</td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.connect.contact_flow_module<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;ContactFlowModuleArn&gt;'
</pre>
