...
Used to retrieve a list of <code>launch_configurations</code> in a region or create a <code>launch_configurations</code> resource, use <code>launch_configuration</code> to operate on an individual resource.
