...
<tr><td><code>PredictiveScalingConfiguration</code></td><td><code>object</code></td><td>A predictive scaling policy. Includes support for predefined metrics only.</td></tr>
...
<tr><td><code>TargetTrackingConfiguration</code></td><td><code>object</code></td><td>A target tracking scaling policy. Includes support for predefined or customized metrics.</td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.autoscaling.scaling_policy<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;Arn&gt;'
</pre>
