...
Gets or updates an individual <code>image_pipeline</code> resource, use <code>image_pipelines</code> to retrieve a list of resources or to create or delete a resource.
