...
For permissions required to operate on the <code>lifecycle_policy_tags</code> resource, see <a href="/providers/aws/imagebuilder/lifecycle_policies/#permissions"><code>lifecycle_policies</code></a>
