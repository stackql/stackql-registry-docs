...
Gets or operates on an individual <code>distribution_configuration</code> resource, use <code>distribution_configurations</code> to retrieve a list of resources or to create a resource.
