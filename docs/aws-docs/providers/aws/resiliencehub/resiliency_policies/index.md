...
Used to retrieve a list of <code>resiliency_policies</code> in a region or create a <code>resiliency_policies</code> resource, use <code>resiliency_policy</code> to operate on an individual resource.
