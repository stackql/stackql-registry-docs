...
---
Used to retrieve a list of <code>trust_anchors</code> in a region or create a <code>trust_anchors</code> resource, use <code>trust_anchor</code> to operate on an individual resource.
