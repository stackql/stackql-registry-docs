...
---
Used to retrieve a list of <code>pricing_plans</code> in a region or create a <code>pricing_plans</code> resource, use <code>pricing_plan</code> to operate on an individual resource.
