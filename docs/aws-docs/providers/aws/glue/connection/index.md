...
<tr><td><code>ConnectionInput</code></td><td><code>object</code></td><td></td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.glue.connection<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;Id&gt;'
</pre>
