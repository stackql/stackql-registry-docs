...
For permissions required to operate on the <code>dataset_tags</code> resource, see <a href="/providers/aws/forecast/datasets/#permissions"><code>datasets</code></a>
