...
---
Used to retrieve a list of <code>masters</code> in a region or create a <code>masters</code> resource, use <code>master</code> to operate on an individual resource.
