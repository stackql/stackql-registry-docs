...
For permissions required to operate on the <code>detector_tags</code> resource, see <a href="/providers/aws/guardduty/detectors/#permissions"><code>detectors</code></a>
