...
Gets or updates an individual <code>training_dataset</code> resource, use <code>training_datasets</code> to retrieve a list of resources or to create or delete a resource.
