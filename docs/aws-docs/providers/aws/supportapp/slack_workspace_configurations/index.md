...
Used to retrieve a list of <code>slack_workspace_configurations</code> in a region or create a <code>slack_workspace_configurations</code> resource, use <code>slack_workspace_configuration</code> to operate on an individual resource.
