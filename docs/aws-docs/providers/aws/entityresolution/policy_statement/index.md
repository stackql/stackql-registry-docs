...
Gets or updates an individual <code>policy_statement</code> resource, use <code>policy_statements</code> to retrieve a list of resources or to create or delete a resource.
