...
Gets or operates on an individual <code>rule_groups_namespace</code> resource, use <code>rule_groups_namespaces</code> to retrieve a list of resources or to create a resource.
