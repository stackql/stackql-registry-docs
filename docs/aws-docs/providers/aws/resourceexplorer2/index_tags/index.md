...
For permissions required to operate on the <code>index_tags</code> resource, see <a href="/providers/aws/resourceexplorer2/indices/#permissions"><code>indices</code></a>
