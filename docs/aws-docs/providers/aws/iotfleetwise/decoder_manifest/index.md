...
Gets or updates an individual <code>decoder_manifest</code> resource, use <code>decoder_manifests</code> to retrieve a list of resources or to create or delete a resource.
