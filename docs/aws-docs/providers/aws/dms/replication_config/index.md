...
Gets or updates an individual <code>replication_config</code> resource, use <code>replication_configs</code> to retrieve a list of resources or to create or delete a resource.
