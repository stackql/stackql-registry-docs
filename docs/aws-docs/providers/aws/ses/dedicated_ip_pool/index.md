...
Gets or updates an individual <code>dedicated_ip_pool</code> resource, use <code>dedicated_ip_pools</code> to retrieve a list of resources or to create or delete a resource.
