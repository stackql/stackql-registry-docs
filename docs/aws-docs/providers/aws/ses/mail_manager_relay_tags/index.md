...
For permissions required to operate on the <code>mail_manager_relay_tags</code> resource, see <a href="/providers/aws/ses/mail_manager_relays/#permissions"><code>mail_manager_relays</code></a>
