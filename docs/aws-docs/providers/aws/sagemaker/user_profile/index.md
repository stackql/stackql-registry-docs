...
Gets or updates an individual <code>user_profile</code> resource, use <code>user_profiles</code> to retrieve a list of resources or to create or delete a resource.
