...
Gets or updates an individual <code>device_fleet</code> resource, use <code>device_fleets</code> to retrieve a list of resources or to create or delete a resource.
