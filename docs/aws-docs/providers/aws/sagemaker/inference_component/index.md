...
Gets or updates an individual <code>inference_component</code> resource, use <code>inference_components</code> to retrieve a list of resources or to create or delete a resource.
