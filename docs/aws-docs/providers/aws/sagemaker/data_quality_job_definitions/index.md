...
---
Used to retrieve a list of <code>data_quality_job_definitions</code> in a region or create a <code>data_quality_job_definitions</code> resource, use <code>data_quality_job_definition</code> to operate on an individual resource.
