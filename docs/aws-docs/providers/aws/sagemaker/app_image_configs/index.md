...
Used to retrieve a list of <code>app_image_configs</code> in a region or create a <code>app_image_configs</code> resource, use <code>app_image_config</code> to operate on an individual resource.
