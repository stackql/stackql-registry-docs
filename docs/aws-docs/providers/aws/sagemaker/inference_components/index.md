...
---
Used to retrieve a list of <code>inference_components</code> in a region or create a <code>inference_components</code> resource, use <code>inference_component</code> to operate on an individual resource.
