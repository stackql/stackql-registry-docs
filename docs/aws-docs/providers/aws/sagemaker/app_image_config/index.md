...
Gets or updates an individual <code>app_image_config</code> resource, use <code>app_image_configs</code> to retrieve a list of resources or to create or delete a resource.
