...
Used to retrieve a list of <code>device_fleets</code> in a region or create a <code>device_fleets</code> resource, use <code>device_fleet</code> to operate on an individual resource.
