...
---
Used to retrieve a list of <code>agent_aliases</code> in a region or create a <code>agent_aliases</code> resource, use <code>agent_alias</code> to operate on an individual resource.
