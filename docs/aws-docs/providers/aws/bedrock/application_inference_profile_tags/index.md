...
For permissions required to operate on the <code>application_inference_profile_tags</code> resource, see <a href="/providers/aws/bedrock/application_inference_profiles/#permissions"><code>application_inference_profiles</code></a>
