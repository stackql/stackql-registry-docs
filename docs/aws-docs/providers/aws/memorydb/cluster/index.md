...
<tr><td><code>DataTiering</code></td><td><code>string</code></td><td>Enables data tiering. Data tiering is only supported for clusters using the r6gd node type. This parameter must be set when using r6gd nodes.</td></tr>
...
<tr><td><code>ClusterEndpoint</code></td><td><code>object</code></td><td>The cluster endpoint.</td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.memorydb.cluster<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;ClusterName&gt;'
</pre>
