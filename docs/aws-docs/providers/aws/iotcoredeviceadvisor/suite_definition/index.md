...
Gets or updates an individual <code>suite_definition</code> resource, use <code>suite_definitions</code> to retrieve a list of resources or to create or delete a resource.
