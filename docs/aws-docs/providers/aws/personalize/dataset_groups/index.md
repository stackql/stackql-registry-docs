...
---
Used to retrieve a list of <code>dataset_groups</code> in a region or create a <code>dataset_groups</code> resource, use <code>dataset_group</code> to operate on an individual resource.
