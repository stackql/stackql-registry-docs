...
<tr><td><code>ScheduledSplitsConfig</code></td><td><code>array</code></td><td></td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.evidently.launch<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;Arn&gt;'
</pre>
