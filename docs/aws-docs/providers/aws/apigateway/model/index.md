...
<tr><td><CopyableCode code="schema" /></td><td><code>object</code></td><td>The schema for the model. For ``application&#x2F;json`` models, this should be JSON schema draft 4 model. Do not include "\*&#x2F;" characters in the description of any properties because such "\*&#x2F;" characters may be interpreted as the closing marker for comments in some languages, such as Java or JavaScript, causing the installation of your API's SDK generated by API Gateway to fail.</td></tr>
