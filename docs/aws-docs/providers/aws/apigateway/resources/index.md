...
---
Used to retrieve a list of <code>resources</code> in a region or create a <code>resources</code> resource, use <code>resource</code> to operate on an individual resource.
