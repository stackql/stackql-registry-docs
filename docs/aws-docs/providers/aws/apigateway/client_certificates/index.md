...
Used to retrieve a list of <code>client_certificates</code> in a region or to create or delete a <code>client_certificates</code> resource, use <code>client_certificate</code> to read or update an individual resource.
...
Use the following StackQL query and manifest file to create a new <code>client_certificate</code> resource, using <a ref="https://pypi.org/project/stack-deploy/" target="_blank"><code><b>stack-deploy</b></code></a>.
