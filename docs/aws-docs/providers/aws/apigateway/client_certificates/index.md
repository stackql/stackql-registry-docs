...
---
Used to retrieve a list of <code>client_certificates</code> in a region or create a <code>client_certificates</code> resource, use <code>client_certificate</code> to operate on an individual resource.
