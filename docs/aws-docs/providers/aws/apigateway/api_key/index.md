...
<tr><td><code>APIKeyId</code></td><td><code>string</code></td><td>A Unique Key ID which identifies the API Key. Generated by the Create API and returned by the Read and List APIs </td></tr>
<tr><td><code>CustomerId</code></td><td><code>string</code></td><td>An AWS Marketplace customer identifier to use when integrating with the AWS SaaS Marketplace.</td></tr>
...
<tr><td><code>GenerateDistinctId</code></td><td><code>boolean</code></td><td>Specifies whether the key identifier is distinct from the created API key value. This parameter is deprecated and should not be used.</td></tr>
...
<tr><td><code>StageKeys</code></td><td><code>array</code></td><td>A list of stages to associate with this API key.</td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.apigateway.api_key<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;APIKeyId&gt;'
</pre>
