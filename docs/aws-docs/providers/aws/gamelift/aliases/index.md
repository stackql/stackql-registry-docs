...
---
Used to retrieve a list of <code>aliases</code> in a region or create a <code>aliases</code> resource, use <code>alias</code> to operate on an individual resource.
