...
Gets or operates on an individual <code>game_session_queue</code> resource, use <code>game_session_queues</code> to retrieve a list of resources or to create a resource.
