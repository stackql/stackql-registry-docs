...
For permissions required to operate on the <code>location_tags</code> resource, see <a href="/providers/aws/gamelift/locations/#permissions"><code>locations</code></a>
