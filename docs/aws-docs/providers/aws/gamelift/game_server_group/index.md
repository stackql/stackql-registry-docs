...
Gets or updates an individual <code>game_server_group</code> resource, use <code>game_server_groups</code> to retrieve a list of resources or to create or delete a resource.
