...
Gets or operates on an individual <code>api_destination</code> resource, use <code>api_destinations</code> to retrieve a list of resources or to create a resource.
