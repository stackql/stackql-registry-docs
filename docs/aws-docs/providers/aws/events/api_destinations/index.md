...
Used to retrieve a list of <code>api_destinations</code> in a region or create a <code>api_destinations</code> resource, use <code>api_destination</code> to operate on an individual resource.
