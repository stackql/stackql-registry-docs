...
Use the following StackQL query and manifest file to create a new <code>directory_registration</code> resource, using <a ref="https://pypi.org/project/stack-deploy/" target="_blank"><code><b>stack-deploy</b></code></a>.
...
```sql
-- directory_registration.iql (required properties only)
...
```sql
-- directory_registration.iql (all properties)
INSERT INTO aws.pcaconnectorad.directory_registrations (
 DirectoryId,
 Tags,
 region
