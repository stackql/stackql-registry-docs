...
Gets or updates an individual <code>directory_registration</code> resource, use <code>directory_registrations</code> to retrieve a list of resources or to create or delete a resource.
