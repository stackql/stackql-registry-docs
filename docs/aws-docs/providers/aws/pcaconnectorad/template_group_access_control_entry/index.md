...
Gets or updates an individual <code>template_group_access_control_entry</code> resource, use <code>template_group_access_control_entries</code> to retrieve a list of resources or to create or delete a resource.
