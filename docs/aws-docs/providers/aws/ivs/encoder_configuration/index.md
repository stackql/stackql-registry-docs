...
Gets or updates an individual <code>encoder_configuration</code> resource, use <code>encoder_configurations</code> to retrieve a list of resources or to create or delete a resource.
