...
---
Gets or operates on an individual <code>recording_configuration</code> resource, use <code>recording_configurations</code> to retrieve a list of resources or to create a resource.
