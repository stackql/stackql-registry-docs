...
---
Used to retrieve a list of <code>stream_keys</code> in a region or create a <code>stream_keys</code> resource, use <code>stream_key</code> to operate on an individual resource.
