...
For permissions required to operate on the <code>public_key_tags</code> resource, see <a href="/providers/aws/ivs/public_keys/#permissions"><code>public_keys</code></a>
