...
For permissions required to operate on the <code>resource_set_tags</code> resource, see <a href="/providers/aws/fms/resource_sets/#permissions"><code>resource_sets</code></a>
