...
Gets or updates an individual <code>subscription_target</code> resource, use <code>subscription_targets</code> to retrieve a list of resources or to create or delete a resource.
