...
Gets or operates on an individual <code>readiness_check</code> resource, use <code>readiness_checks</code> to retrieve a list of resources or to create a resource.
