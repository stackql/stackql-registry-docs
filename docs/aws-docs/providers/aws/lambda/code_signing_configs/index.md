...
Used to retrieve a list of <code>code_signing_configs</code> in a region or create a <code>code_signing_configs</code> resource, use <code>code_signing_config</code> to operate on an individual resource.
