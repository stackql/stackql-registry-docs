...
---
Gets or operates on an individual <code>event_invoke_config</code> resource, use <code>event_invoke_configs</code> to retrieve a list of resources or to create a resource.
