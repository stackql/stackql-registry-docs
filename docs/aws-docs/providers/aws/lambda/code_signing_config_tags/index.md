...
For permissions required to operate on the <code>code_signing_config_tags</code> resource, see <a href="/providers/aws/lambda/code_signing_configs/#permissions"><code>code_signing_configs</code></a>
