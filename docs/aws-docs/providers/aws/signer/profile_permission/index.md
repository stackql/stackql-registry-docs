...
Gets or updates an individual <code>profile_permission</code> resource, use <code>profile_permissions</code> to retrieve a list of resources or to create or delete a resource.
