...
Gets or updates an individual <code>named_query</code> resource, use <code>named_queries</code> to retrieve a list of resources or to create or delete a resource.
