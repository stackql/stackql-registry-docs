...
---
Used to retrieve a list of <code>organizations</code> in a region or create a <code>organizations</code> resource, use <code>organization</code> to operate on an individual resource.
