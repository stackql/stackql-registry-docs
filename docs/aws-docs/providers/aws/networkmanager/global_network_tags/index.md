...
For permissions required to operate on the <code>global_network_tags</code> resource, see <a href="/providers/aws/networkmanager/global_networks/#permissions"><code>global_networks</code></a>
