...
---
Used to retrieve a list of <code>core_networks</code> in a region or create a <code>core_networks</code> resource, use <code>core_network</code> to operate on an individual resource.
