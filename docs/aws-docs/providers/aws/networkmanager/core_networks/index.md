...
Use the following StackQL query and manifest file to create a new <code>core_network</code> resource, using <a ref="https://pypi.org/project/stack-deploy/" target="_blank"><code><b>stack-deploy</b></code></a>.
...
```sql
-- core_network.iql (required properties only)
...
```sql
-- core_network.iql (all properties)
INSERT INTO aws.networkmanager.core_networks (
 GlobalNetworkId,
 PolicyDocument,
 Description,
