...
Gets or updates an individual <code>global_network</code> resource, use <code>global_networks</code> to retrieve a list of resources or to create or delete a resource.
