...
Gets or updates an individual <code>site_to_site_vpn_attachment</code> resource, use <code>site_to_site_vpn_attachments</code> to retrieve a list of resources or to create or delete a resource.
