...
---
Gets or operates on an individual <code>transit_gateway_peering</code> resource, use <code>transit_gateway_peerings</code> to retrieve a list of resources or to create a resource.
