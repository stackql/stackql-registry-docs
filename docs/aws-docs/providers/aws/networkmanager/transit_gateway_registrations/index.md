...
Used to retrieve a list of <code>transit_gateway_registrations</code> in a region or to create or delete a <code>transit_gateway_registrations</code> resource, use <code>transit_gateway_registration</code> to read or update an individual resource.
