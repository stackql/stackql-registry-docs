...
Gets or updates an individual <code>customer_gateway_association</code> resource, use <code>customer_gateway_associations</code> to retrieve a list of resources or to create or delete a resource.
