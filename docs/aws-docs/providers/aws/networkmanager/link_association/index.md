...
## Example
<pre>
SELECT *<br/>FROM aws.networkmanager.link_association<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;GlobalNetworkId&gt;'<br/>AND data__Identifier = '&lt;DeviceId&gt;'<br/>AND data__Identifier = '&lt;LinkId&gt;'
</pre>
