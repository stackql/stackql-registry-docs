...
Gets or operates on an individual <code>transit_gateway_registration</code> resource, use <code>transit_gateway_registrations</code> to retrieve a list of resources or to create a resource.
