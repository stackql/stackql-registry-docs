...
## Example
<pre>
SELECT *<br/>FROM aws.networkmanager.transit_gateway_registration<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;GlobalNetworkId&gt;'<br/>AND data__Identifier = '&lt;TransitGatewayArn&gt;'
</pre>
