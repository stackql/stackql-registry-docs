...
Gets or operates on an individual <code>global_replication_group</code> resource, use <code>global_replication_groups</code> to retrieve a list of resources or to create a resource.
