...
Gets or updates an individual <code>multi_region_access_point</code> resource, use <code>multi_region_access_points</code> to retrieve a list of resources or to create or delete a resource.
