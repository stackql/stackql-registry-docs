...
For permissions required to operate on the <code>stored_query_tags</code> resource, see <a href="/providers/aws/config/stored_queries/#permissions"><code>stored_queries</code></a>
