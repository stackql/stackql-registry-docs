...
---
Gets or operates on an individual <code>conformance_pack</code> resource, use <code>conformance_packs</code> to retrieve a list of resources or to create a resource.
