...
Gets or updates an individual <code>aggregation_authorization</code> resource, use <code>aggregation_authorizations</code> to retrieve a list of resources or to create or delete a resource.
