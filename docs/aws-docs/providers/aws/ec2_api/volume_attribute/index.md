...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.ec2_api.volume_attribute" /></td></tr>
</tbody></table>

## Fields
| Name | Datatype | Description |
|:-----|:---------|:------------|
| <CopyableCode code="autoEnableIO" /> | `object` | Describes a value for a resource attribute that is a Boolean value. |
