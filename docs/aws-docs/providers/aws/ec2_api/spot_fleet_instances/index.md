...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.ec2_api.spot_fleet_instances" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="spot_fleet_instances_Describe" /> | `SELECT` | <CopyableCode code="SpotFleetRequestId, region" /> |
