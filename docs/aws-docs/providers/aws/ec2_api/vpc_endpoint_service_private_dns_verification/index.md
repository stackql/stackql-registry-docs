...
<tr><td><b>Id</b></td><td><code>aws.ec2_api.vpc_endpoint_service_private_dns_verification</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `vpc_endpoint_service_private_dns_verification_Start` | `EXEC` | `ServiceId, region` |
