...
<tr><td><b>Id</b></td><td><code>aws.ec2_api.transit_gateway_route_table_associations</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `transit_gateway_route_table_associations_Get` | `SELECT` | `TransitGatewayRouteTableId, region` |
