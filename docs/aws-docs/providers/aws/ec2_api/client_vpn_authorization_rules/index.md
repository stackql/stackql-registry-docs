...
<tr><td><b>Id</b></td><td><code>aws.ec2_api.client_vpn_authorization_rules</code></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| `client_vpn_authorization_rules_Describe` | `SELECT` | `ClientVpnEndpointId, region` |
