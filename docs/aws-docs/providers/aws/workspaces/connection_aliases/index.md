...
Used to retrieve a list of <code>connection_aliases</code> in a region or create a <code>connection_aliases</code> resource, use <code>connection_alias</code> to operate on an individual resource.
