...
Used to retrieve a list of <code>reference_stores</code> in a region or create a <code>reference_stores</code> resource, use <code>reference_store</code> to operate on an individual resource.
