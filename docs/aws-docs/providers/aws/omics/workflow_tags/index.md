...
For permissions required to operate on the <code>workflow_tags</code> resource, see <a href="/providers/aws/omics/workflows/#permissions"><code>workflows</code></a>
