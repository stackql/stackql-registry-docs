...
Gets or operates on an individual <code>annotation_store</code> resource, use <code>annotation_stores</code> to retrieve a list of resources or to create a resource.
