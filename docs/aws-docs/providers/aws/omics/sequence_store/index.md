...
<tr><td><code>SequenceStoreId</code></td><td><code>string</code></td><td></td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.omics.sequence_store<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;SequenceStoreId&gt;'
</pre>
