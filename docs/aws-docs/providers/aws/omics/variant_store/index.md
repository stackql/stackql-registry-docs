...
Gets or updates an individual <code>variant_store</code> resource, use <code>variant_stores</code> to retrieve a list of resources or to create or delete a resource.
