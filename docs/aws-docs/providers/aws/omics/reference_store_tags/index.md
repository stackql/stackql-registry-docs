...
For permissions required to operate on the <code>reference_store_tags</code> resource, see <a href="/providers/aws/omics/reference_stores/#permissions"><code>reference_stores</code></a>
