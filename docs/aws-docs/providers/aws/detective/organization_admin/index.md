...
Gets or updates an individual <code>organization_admin</code> resource, use <code>organization_admins</code> to retrieve a list of resources or to create or delete a resource.
