...
Gets or updates an individual <code>map</code> resource, use <code>maps</code> to retrieve a list of resources or to create or delete a resource.
...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.location.map" /></td></tr>
</tbody></table>
