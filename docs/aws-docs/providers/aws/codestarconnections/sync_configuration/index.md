...
Gets or updates an individual <code>sync_configuration</code> resource, use <code>sync_configurations</code> to retrieve a list of resources or to create or delete a resource.
