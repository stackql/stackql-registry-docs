...
For permissions required to operate on the <code>connection_tags</code> resource, see <a href="/providers/aws/codestarconnections/connections/#permissions"><code>connections</code></a>
