...
Used to retrieve a list of <code>bridges</code> in a region or create a <code>bridges</code> resource, use <code>bridge</code> to operate on an individual resource.
