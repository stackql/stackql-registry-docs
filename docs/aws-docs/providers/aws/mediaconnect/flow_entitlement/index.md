...
Gets or operates on an individual <code>flow_entitlement</code> resource, use <code>flow_entitlements</code> to retrieve a list of resources or to create a resource.
