...
Gets or updates an individual <code>bridge_output</code> resource, use <code>bridge_outputs</code> to retrieve a list of resources or to create or delete a resource.
