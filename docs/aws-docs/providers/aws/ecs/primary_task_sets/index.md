...
Used to retrieve a list of <code>primary_task_sets</code> in a region or create a <code>primary_task_sets</code> resource, use <code>primary_task_set</code> to operate on an individual resource.
