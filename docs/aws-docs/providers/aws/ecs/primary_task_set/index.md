...
Gets or updates an individual <code>primary_task_set</code> resource, use <code>primary_task_sets</code> to retrieve a list of resources or to create or delete a resource.
