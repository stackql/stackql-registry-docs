...
Gets or updates an individual <code>packaging_configuration</code> resource, use <code>packaging_configurations</code> to retrieve a list of resources or to create or delete a resource.
