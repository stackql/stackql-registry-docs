...
For permissions required to operate on the <code>sdi_source_tags</code> resource, see <a href="/providers/aws/medialive/sdi_sources/#permissions"><code>sdi_sources</code></a>
