...
For permissions required to operate on the <code>channel_placement_group_tags</code> resource, see <a href="/providers/aws/medialive/channel_placement_groups/#permissions"><code>channel_placement_groups</code></a>
