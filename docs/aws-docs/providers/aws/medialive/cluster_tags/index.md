...
For permissions required to operate on the <code>cluster_tags</code> resource, see <a href="/providers/aws/medialive/clusters/#permissions"><code>clusters</code></a>
