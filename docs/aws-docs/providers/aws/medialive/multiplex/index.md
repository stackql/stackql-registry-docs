...
Gets or updates an individual <code>multiplex</code> resource, use <code>multiplexes</code> to retrieve a list of resources or to create or delete a resource.
