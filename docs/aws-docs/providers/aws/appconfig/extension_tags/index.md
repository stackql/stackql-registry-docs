...
For permissions required to operate on the <code>extension_tags</code> resource, see <a href="/providers/aws/appconfig/extensions/#permissions"><code>extensions</code></a>
