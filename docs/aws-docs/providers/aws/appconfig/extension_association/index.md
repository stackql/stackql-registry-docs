...
Gets or operates on an individual <code>extension_association</code> resource, use <code>extension_associations</code> to retrieve a list of resources or to create a resource.
