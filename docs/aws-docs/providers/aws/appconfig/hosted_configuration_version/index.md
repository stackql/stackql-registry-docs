...
Gets or updates an individual <code>hosted_configuration_version</code> resource, use <code>hosted_configuration_versions</code> to retrieve a list of resources or to create or delete a resource.
