...
For permissions required to operate on the <code>application_tags</code> resource, see <a href="/providers/aws/appconfig/applications/#permissions"><code>applications</code></a>
