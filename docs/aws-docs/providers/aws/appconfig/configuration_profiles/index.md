...
Used to retrieve a list of <code>configuration_profiles</code> in a region or create a <code>configuration_profiles</code> resource, use <code>configuration_profile</code> to operate on an individual resource.
