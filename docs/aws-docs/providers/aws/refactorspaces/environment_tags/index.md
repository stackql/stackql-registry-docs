...
For permissions required to operate on the <code>environment_tags</code> resource, see <a href="/providers/aws/refactorspaces/environments/#permissions"><code>environments</code></a>
