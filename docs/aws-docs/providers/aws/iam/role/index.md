...
Gets or updates an individual <code>role</code> resource, use <code>roles</code> to retrieve a list of resources or to create or delete a resource.
...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iam.role" /></td></tr>
</tbody></table>
