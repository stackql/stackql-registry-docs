...
---
Gets or operates on an individual <code>oidc_provider</code> resource, use <code>oidc_providers</code> to retrieve a list of resources or to create a resource.
