...
Gets or operates on an individual <code>managed_policy</code> resource, use <code>managed_policies</code> to retrieve a list of resources or to create a resource.
