...
Gets or updates an individual <code>replicator</code> resource, use <code>replicators</code> to retrieve a list of resources or to create or delete a resource.
