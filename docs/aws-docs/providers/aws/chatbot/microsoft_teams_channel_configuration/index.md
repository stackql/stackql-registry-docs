...
Gets or updates an individual <code>microsoft_teams_channel_configuration</code> resource, use <code>microsoft_teams_channel_configurations</code> to retrieve a list of resources or to create or delete a resource.
