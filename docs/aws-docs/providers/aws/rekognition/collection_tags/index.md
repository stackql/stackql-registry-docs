...
For permissions required to operate on the <code>collection_tags</code> resource, see <a href="/providers/aws/rekognition/collections/#permissions"><code>collections</code></a>
