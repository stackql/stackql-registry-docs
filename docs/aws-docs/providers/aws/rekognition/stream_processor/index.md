...
---
Gets or operates on an individual <code>stream_processor</code> resource, use <code>stream_processors</code> to retrieve a list of resources or to create a resource.
