...
Gets or updates an individual <code>topic_inline_policy</code> resource, use <code>topic_inline_policies</code> to retrieve a list of resources or to create or delete a resource.
