...
Gets or updates an individual <code>identity_pool_role_attachment</code> resource, use <code>identity_pool_role_attachments</code> to retrieve a list of resources or to create or delete a resource.
