...
Used to retrieve a list of <code>user_pool_user_to_group_attachments</code> in a region or create a <code>user_pool_user_to_group_attachments</code> resource, use <code>user_pool_user_to_group_attachment</code> to operate on an individual resource.
