...
Gets or updates an individual <code>log_delivery_configuration</code> resource, use <code>log_delivery_configurations</code> to retrieve a list of resources or to create or delete a resource.
