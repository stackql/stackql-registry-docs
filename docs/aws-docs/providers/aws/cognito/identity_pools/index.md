...
---
Used to retrieve a list of <code>identity_pools</code> in a region or create a <code>identity_pools</code> resource, use <code>identity_pool</code> to operate on an individual resource.
