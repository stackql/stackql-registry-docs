...
---
Used to retrieve a list of <code>environment_templates</code> in a region or create a <code>environment_templates</code> resource, use <code>environment_template</code> to operate on an individual resource.
