...
Use the following StackQL query and manifest file to create a new <code>environment_template</code> resource, using <a ref="https://pypi.org/project/stack-deploy/" target="_blank"><code><b>stack-deploy</b></code></a>.
...
```sql
-- environment_template.iql (required properties only)
...
```sql
-- environment_template.iql (all properties)
INSERT INTO aws.proton.environment_templates (
 Description,
 DisplayName,
 EncryptionKey,
