...
Gets or operates on an individual <code>environment_template</code> resource, use <code>environment_templates</code> to retrieve a list of resources or to create a resource.
