...
<tr><td><code>ChannelArn</code></td><td><code>undefined</code></td><td></td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.cloudtrail.channel<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;ChannelArn&gt;'
</pre>
