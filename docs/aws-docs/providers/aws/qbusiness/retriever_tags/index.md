...
For permissions required to operate on the <code>retriever_tags</code> resource, see <a href="/providers/aws/qbusiness/retrievers/#permissions"><code>retrievers</code></a>
