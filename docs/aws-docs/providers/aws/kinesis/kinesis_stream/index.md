...
---
Gets or operates on an individual <code>kinesis_stream</code> resource, use <code>kinesis_streams</code> to retrieve a list of resources or to create a resource.
