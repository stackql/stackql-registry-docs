...
---
Used to retrieve a list of <code>state_machines</code> in a region or create a <code>state_machines</code> resource, use <code>state_machine</code> to operate on an individual resource.
