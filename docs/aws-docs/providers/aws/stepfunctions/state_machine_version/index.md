...
---
Gets or operates on an individual <code>state_machine_version</code> resource, use <code>state_machine_versions</code> to retrieve a list of resources or to create a resource.
