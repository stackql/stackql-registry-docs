...
Used to retrieve a list of <code>activities</code> in a region or create a <code>activities</code> resource, use <code>activity</code> to operate on an individual resource.
