...
Gets or updates an individual <code>target_account_configuration</code> resource, use <code>target_account_configurations</code> to retrieve a list of resources or to create or delete a resource.
