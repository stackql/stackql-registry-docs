...
Gets or operates on an individual <code>experiment_template</code> resource, use <code>experiment_templates</code> to retrieve a list of resources or to create a resource.
