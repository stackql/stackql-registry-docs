...
Gets or updates an individual <code>configuration_template</code> resource, use <code>configuration_templates</code> to retrieve a list of resources or to create or delete a resource.
