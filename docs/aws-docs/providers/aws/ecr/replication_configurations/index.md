...
---
Used to retrieve a list of <code>replication_configurations</code> in a region or create a <code>replication_configurations</code> resource, use <code>replication_configuration</code> to operate on an individual resource.
