...
Gets or updates an individual <code>repository_creation_template</code> resource, use <code>repository_creation_templates</code> to retrieve a list of resources or to create or delete a resource.
