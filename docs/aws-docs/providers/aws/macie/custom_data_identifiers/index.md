...
---
Used to retrieve a list of <code>custom_data_identifiers</code> in a region or create a <code>custom_data_identifiers</code> resource, use <code>custom_data_identifier</code> to operate on an individual resource.
