...
Gets or updates an individual <code>findings_filter</code> resource, use <code>findings_filters</code> to retrieve a list of resources or to create or delete a resource.
