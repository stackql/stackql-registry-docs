...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.route53.hosted_zone" /></td></tr>
</tbody></table>
...
<tr><td><CopyableCode code="hosted_zone_config" /></td><td><code>object</code></td><td>A complex type that contains an optional comment.&lt;br&#x2F;&gt; If you don't want to specify a comment, omit the ``HostedZoneConfig`` and ``Comment`` elements.</td></tr>
...
<tr><td><CopyableCode code="vpcs" /></td><td><code>array</code></td><td>*Private hosted zones:* A complex type that contains information about the VPCs that are associated with the specified hosted zone.&lt;br&#x2F;&gt;  For public hosted zones, omit ``VPCs``, ``VPCId``, and ``VPCRegion``.</td></tr>
