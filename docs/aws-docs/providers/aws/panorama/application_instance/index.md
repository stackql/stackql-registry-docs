...
Gets or updates an individual <code>application_instance</code> resource, use <code>application_instances</code> to retrieve a list of resources or to create or delete a resource.
