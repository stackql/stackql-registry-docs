...
Used to retrieve a list of <code>accessors</code> in a region or create a <code>accessors</code> resource, use <code>accessor</code> to operate on an individual resource.
