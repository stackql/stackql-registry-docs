...
Used to retrieve a list of <code>deliveries</code> in a region or to create or delete a <code>deliveries</code> resource, use <code>delivery</code> to read or update an individual resource.
...
Use the following StackQL query and manifest file to create a new <code>delivery</code> resource, using <a ref="https://pypi.org/project/stack-deploy/" target="_blank"><code><b>stack-deploy</b></code></a>.
...
```sql
-- delivery.iql (required properties only)
