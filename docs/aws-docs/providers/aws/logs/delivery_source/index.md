...
---
Gets or operates on an individual <code>delivery_source</code> resource, use <code>delivery_sources</code> to retrieve a list of resources or to create a resource.
