...
Gets or operates on an individual <code>query_definition</code> resource, use <code>query_definitions</code> to retrieve a list of resources or to create a resource.
