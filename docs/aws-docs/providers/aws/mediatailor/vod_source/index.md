...
Gets or updates an individual <code>vod_source</code> resource, use <code>vod_sources</code> to retrieve a list of resources or to create or delete a resource.
