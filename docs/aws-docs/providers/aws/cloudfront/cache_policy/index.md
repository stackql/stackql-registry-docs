...
---
Gets or operates on an individual <code>cache_policy</code> resource, use <code>cache_policies</code> to retrieve a list of resources or to create a resource.
