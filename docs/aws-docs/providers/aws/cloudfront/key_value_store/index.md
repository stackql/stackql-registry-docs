...
Gets or updates an individual <code>key_value_store</code> resource, use <code>key_value_stores</code> to retrieve a list of resources or to create or delete a resource.
