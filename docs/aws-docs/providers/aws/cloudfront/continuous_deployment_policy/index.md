...
Gets or operates on an individual <code>continuous_deployment_policy</code> resource, use <code>continuous_deployment_policies</code> to retrieve a list of resources or to create a resource.
