...
Gets or updates an individual <code>realtime_log_config</code> resource, use <code>realtime_log_configs</code> to retrieve a list of resources or to create or delete a resource.
