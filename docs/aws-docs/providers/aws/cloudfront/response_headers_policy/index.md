...
Gets or operates on an individual <code>response_headers_policy</code> resource, use <code>response_headers_policies</code> to retrieve a list of resources or to create a resource.
