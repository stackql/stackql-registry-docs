...
---
Used to retrieve a list of <code>realtime_log_configs</code> in a region or create a <code>realtime_log_configs</code> resource, use <code>realtime_log_config</code> to operate on an individual resource.
