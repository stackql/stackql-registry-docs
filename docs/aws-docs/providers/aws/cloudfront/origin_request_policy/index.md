...
---
Gets or operates on an individual <code>origin_request_policy</code> resource, use <code>origin_request_policies</code> to retrieve a list of resources or to create a resource.
