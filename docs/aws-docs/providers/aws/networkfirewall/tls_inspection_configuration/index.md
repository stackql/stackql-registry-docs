...
---
Gets or operates on an individual <code>tls_inspection_configuration</code> resource, use <code>tls_inspection_configurations</code> to retrieve a list of resources or to create a resource.
