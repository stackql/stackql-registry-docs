...
## Example
<pre>
SELECT *<br/>FROM aws.lakeformation.tag_association<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;ResourceIdentifier&gt;'<br/>AND data__Identifier = '&lt;TagsIdentifier&gt;'
</pre>
