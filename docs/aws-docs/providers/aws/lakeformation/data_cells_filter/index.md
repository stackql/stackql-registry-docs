...
Gets or updates an individual <code>data_cells_filter</code> resource, use <code>data_cells_filters</code> to retrieve a list of resources or to create or delete a resource.
