...
---
Used to retrieve a list of <code>outcomes</code> in a region or create a <code>outcomes</code> resource, use <code>outcome</code> to operate on an individual resource.
