...
For permissions required to operate on the <code>variable_tags</code> resource, see <a href="/providers/aws/frauddetector/variables/#permissions"><code>variables</code></a>
