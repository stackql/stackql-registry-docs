...
For permissions required to operate on the <code>outcome_tags</code> resource, see <a href="/providers/aws/frauddetector/outcomes/#permissions"><code>outcomes</code></a>
