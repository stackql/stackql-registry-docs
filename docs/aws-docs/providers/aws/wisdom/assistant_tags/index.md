...
For permissions required to operate on the <code>assistant_tags</code> resource, see <a href="/providers/aws/wisdom/assistants/#permissions"><code>assistants</code></a>
