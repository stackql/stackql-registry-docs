...
Gets or updates an individual <code>knowledge_base</code> resource, use <code>knowledge_bases</code> to retrieve a list of resources or to create or delete a resource.
