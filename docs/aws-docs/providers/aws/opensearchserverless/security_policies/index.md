...
---
Used to retrieve a list of <code>security_policies</code> in a region or create a <code>security_policies</code> resource, use <code>security_policy</code> to operate on an individual resource.
