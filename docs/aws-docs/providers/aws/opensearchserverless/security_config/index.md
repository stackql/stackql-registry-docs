...
Gets or operates on an individual <code>security_config</code> resource, use <code>security_configs</code> to retrieve a list of resources or to create a resource.
