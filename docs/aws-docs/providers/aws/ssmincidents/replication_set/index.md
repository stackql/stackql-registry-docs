...
Gets or updates an individual <code>replication_set</code> resource, use <code>replication_sets</code> to retrieve a list of resources or to create or delete a resource.
