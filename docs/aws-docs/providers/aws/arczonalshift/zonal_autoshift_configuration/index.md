...
Gets or operates on an individual <code>zonal_autoshift_configuration</code> resource, use <code>zonal_autoshift_configurations</code> to retrieve a list of resources or to create a resource.
