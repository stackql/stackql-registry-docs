...
---
Gets or operates on an individual <code>cluster_parameter_group</code> resource, use <code>cluster_parameter_groups</code> to retrieve a list of resources or to create a resource.
