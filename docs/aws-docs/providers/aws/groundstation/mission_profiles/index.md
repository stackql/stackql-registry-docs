...
---
Used to retrieve a list of <code>mission_profiles</code> in a region or create a <code>mission_profiles</code> resource, use <code>mission_profile</code> to operate on an individual resource.
