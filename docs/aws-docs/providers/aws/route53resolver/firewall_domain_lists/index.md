...
Used to retrieve a list of <code>firewall_domain_lists</code> in a region or create a <code>firewall_domain_lists</code> resource, use <code>firewall_domain_list</code> to operate on an individual resource.
