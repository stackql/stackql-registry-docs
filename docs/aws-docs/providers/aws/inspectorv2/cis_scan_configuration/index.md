...
Gets or updates an individual <code>cis_scan_configuration</code> resource, use <code>cis_scan_configurations</code> to retrieve a list of resources or to create or delete a resource.
