...
## Example
<pre>
SELECT *<br/>FROM aws.emr.studio_session_mapping<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;StudioId&gt;'<br/>AND data__Identifier = '&lt;IdentityType&gt;'<br/>AND data__Identifier = '&lt;IdentityName&gt;'
</pre>
