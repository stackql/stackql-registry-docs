...
Gets or updates an individual <code>metric_stream</code> resource, use <code>metric_streams</code> to retrieve a list of resources or to create or delete a resource.
