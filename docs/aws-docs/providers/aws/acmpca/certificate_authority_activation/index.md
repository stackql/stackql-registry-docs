...
---
Gets or operates on an individual <code>certificate_authority_activation</code> resource, use <code>certificate_authority_activations</code> to retrieve a list of resources or to create a resource.
