...
Gets or updates an individual <code>certificate_authority</code> resource, use <code>certificate_authorities</code> to retrieve a list of resources or to create or delete a resource.
