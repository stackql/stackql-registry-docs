...
Used to retrieve a list of <code>control_panels</code> in a region or create a <code>control_panels</code> resource, use <code>control_panel</code> to operate on an individual resource.
