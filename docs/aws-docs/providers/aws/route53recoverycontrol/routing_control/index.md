...
---
Gets or operates on an individual <code>routing_control</code> resource, use <code>routing_controls</code> to retrieve a list of resources or to create a resource.
