...
Gets or updates an individual <code>queue_environment</code> resource, use <code>queue_environments</code> to retrieve a list of resources or to create or delete a resource.
