...
Gets or updates an individual <code>storage_profile</code> resource, use <code>storage_profiles</code> to retrieve a list of resources or to create or delete a resource.
