...
Gets or updates an individual <code>alias</code> resource, use <code>aliases</code> to retrieve a list of resources or to create or delete a resource.
