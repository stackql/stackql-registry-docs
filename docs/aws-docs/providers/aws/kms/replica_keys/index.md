...
Used to retrieve a list of <code>replica_keys</code> in a region or create a <code>replica_keys</code> resource, use <code>replica_key</code> to operate on an individual resource.
