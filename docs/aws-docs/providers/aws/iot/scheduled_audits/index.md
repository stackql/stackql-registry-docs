...
Used to retrieve a list of <code>scheduled_audits</code> in a region or create a <code>scheduled_audits</code> resource, use <code>scheduled_audit</code> to operate on an individual resource.
