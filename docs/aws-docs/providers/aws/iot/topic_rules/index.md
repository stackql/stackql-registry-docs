...
Used to retrieve a list of <code>topic_rules</code> in a region or create a <code>topic_rules</code> resource, use <code>topic_rule</code> to operate on an individual resource.
