...
Gets or updates an individual <code>provisioning_template</code> resource, use <code>provisioning_templates</code> to retrieve a list of resources or to create or delete a resource.
