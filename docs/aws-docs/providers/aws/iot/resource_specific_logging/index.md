...
Gets or operates on an individual <code>resource_specific_logging</code> resource, use <code>resource_specific_loggings</code> to retrieve a list of resources or to create a resource.
