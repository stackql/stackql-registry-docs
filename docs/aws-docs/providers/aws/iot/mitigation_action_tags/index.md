...
For permissions required to operate on the <code>mitigation_action_tags</code> resource, see <a href="/providers/aws/iot/mitigation_actions/#permissions"><code>mitigation_actions</code></a>
