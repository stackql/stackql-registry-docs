...
Gets or updates an individual <code>account_audit_configuration</code> resource, use <code>account_audit_configurations</code> to retrieve a list of resources or to create or delete a resource.
