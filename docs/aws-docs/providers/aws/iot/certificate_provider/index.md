...
Gets or updates an individual <code>certificate_provider</code> resource, use <code>certificate_providers</code> to retrieve a list of resources or to create or delete a resource.
