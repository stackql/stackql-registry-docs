...
Gets or updates an individual <code>billing_group</code> resource, use <code>billing_groups</code> to retrieve a list of resources or to create or delete a resource.
