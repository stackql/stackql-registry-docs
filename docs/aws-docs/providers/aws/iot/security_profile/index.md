...
Gets or updates an individual <code>security_profile</code> resource, use <code>security_profiles</code> to retrieve a list of resources or to create or delete a resource.
