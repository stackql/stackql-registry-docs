...
---
Used to retrieve a list of <code>certificate_providers</code> in a region or create a <code>certificate_providers</code> resource, use <code>certificate_provider</code> to operate on an individual resource.
