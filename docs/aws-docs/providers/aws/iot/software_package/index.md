...
Gets or updates an individual <code>software_package</code> resource, use <code>software_packages</code> to retrieve a list of resources or to create or delete a resource.
