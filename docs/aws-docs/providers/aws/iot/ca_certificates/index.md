...
Used to retrieve a list of <code>ca_certificates</code> in a region or create a <code>ca_certificates</code> resource, use <code>ca_certificate</code> to operate on an individual resource.
