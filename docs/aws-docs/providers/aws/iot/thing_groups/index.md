...
Used to retrieve a list of <code>thing_groups</code> in a region or create a <code>thing_groups</code> resource, use <code>thing_group</code> to operate on an individual resource.
