...
Gets or updates an individual <code>backup_selection</code> resource, use <code>backup_selections</code> to retrieve a list of resources or to create or delete a resource.
