...
Used to retrieve a list of <code>parameters</code> in a region or to create or delete a <code>parameters</code> resource, use <code>parameter</code> to read or update an individual resource.
