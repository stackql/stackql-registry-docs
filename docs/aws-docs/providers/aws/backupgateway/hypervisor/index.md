...
Gets or updates an individual <code>hypervisor</code> resource, use <code>hypervisors</code> to retrieve a list of resources or to create or delete a resource.
