...
Used to retrieve a list of <code>robots</code> in a region or create a <code>robots</code> resource, use <code>robot</code> to operate on an individual resource.
