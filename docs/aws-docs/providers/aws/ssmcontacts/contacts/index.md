...
Used to retrieve a list of <code>contacts</code> in a region or create a <code>contacts</code> resource, use <code>contact</code> to operate on an individual resource.
