...
---
Used to retrieve a list of <code>data_repository_associations</code> in a region or create a <code>data_repository_associations</code> resource, use <code>data_repository_association</code> to operate on an individual resource.
