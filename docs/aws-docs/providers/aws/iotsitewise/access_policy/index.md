...
Gets or updates an individual <code>access_policy</code> resource, use <code>access_policies</code> to retrieve a list of resources or to create or delete a resource.
