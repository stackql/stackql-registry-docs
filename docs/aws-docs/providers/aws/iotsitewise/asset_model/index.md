...
Gets or updates an individual <code>asset_model</code> resource, use <code>asset_models</code> to retrieve a list of resources or to create or delete a resource.
