...
Used to retrieve a list of <code>public_type_versions</code> in a region or create a <code>public_type_versions</code> resource, use <code>public_type_version</code> to operate on an individual resource.
