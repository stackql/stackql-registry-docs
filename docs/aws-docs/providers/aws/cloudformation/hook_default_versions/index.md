...
Used to retrieve a list of <code>hook_default_versions</code> in a region or create a <code>hook_default_versions</code> resource, use <code>hook_default_version</code> to operate on an individual resource.
