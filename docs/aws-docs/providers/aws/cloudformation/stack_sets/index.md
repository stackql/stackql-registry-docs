...
<tr><td><code>AutoDeployment</code></td><td><code>object</code></td><td>Describes whether StackSets automatically deploys to AWS Organizations accounts that are added to the target organization or organizational unit (OU). Specify only if PermissionModel is SERVICE_MANAGED.</td></tr>
...
<tr><td><code>OperationPreferences</code></td><td><code>object</code></td><td></td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.cloudformation.stack_sets<br/>WHERE region = 'us-east-1'
</pre>
