...
<tr><td><CopyableCode code="operation_preferences" /></td><td><code>The user-specified preferences for how AWS CloudFormation performs a stack set operation.</code></td><td></td></tr>
