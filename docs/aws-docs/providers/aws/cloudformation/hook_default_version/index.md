...
---
Gets or operates on an individual <code>hook_default_version</code> resource, use <code>hook_default_versions</code> to retrieve a list of resources or to create a resource.
