...
Used to retrieve a list of <code>licenses</code> in a region or create a <code>licenses</code> resource, use <code>license</code> to operate on an individual resource.
