...
---
Used to retrieve a list of <code>grants</code> in a region or create a <code>grants</code> resource, use <code>grant</code> to operate on an individual resource.
