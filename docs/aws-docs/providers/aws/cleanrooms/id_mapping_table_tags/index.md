...
For permissions required to operate on the <code>id_mapping_table_tags</code> resource, see <a href="/providers/aws/cleanrooms/id_mapping_tables/#permissions"><code>id_mapping_tables</code></a>
