...
Gets or operates on an individual <code>collaboration</code> resource, use <code>collaborations</code> to retrieve a list of resources or to create a resource.
