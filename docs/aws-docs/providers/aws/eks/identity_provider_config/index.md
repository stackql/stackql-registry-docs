...
Gets or updates an individual <code>identity_provider_config</code> resource, use <code>identity_provider_configs</code> to retrieve a list of resources or to create or delete a resource.
