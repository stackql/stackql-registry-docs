...
Gets or updates an individual <code>access_entry</code> resource, use <code>access_entries</code> to retrieve a list of resources or to create or delete a resource.
