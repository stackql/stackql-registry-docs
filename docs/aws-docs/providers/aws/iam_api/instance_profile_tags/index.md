...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iam_api.instance_profile_tags" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="instance_profile_tags_List" /> | `SELECT` | <CopyableCode code="InstanceProfileName, region" /> |
