...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iam_api.mfa_device_tags" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="mfa_device_tags_List" /> | `SELECT` | <CopyableCode code="SerialNumber, region" /> |
