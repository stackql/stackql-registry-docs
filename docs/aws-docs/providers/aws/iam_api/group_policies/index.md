...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iam_api.group_policies" /></td></tr>
</tbody></table>

## Fields
| Name | Datatype | Description |
|:-----|:---------|:------------|
| <CopyableCode code="GroupName" /> | `string` | The group the policy is associated with. |
