...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iam_api.attached_role_policies" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="attached_role_policies_List" /> | `SELECT` | <CopyableCode code="RoleName, region" /> |
