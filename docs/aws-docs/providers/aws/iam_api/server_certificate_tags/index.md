...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iam_api.server_certificate_tags" /></td></tr>
</tbody></table>
...
|:-----|:--------------|:----------------|
| <CopyableCode code="server_certificate_tags_List" /> | `SELECT` | <CopyableCode code="ServerCertificateName, region" /> |
