...
Gets or updates an individual <code>multicast_group</code> resource, use <code>multicast_groups</code> to retrieve a list of resources or to create or delete a resource.
