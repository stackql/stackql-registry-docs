...
Gets or updates an individual <code>device_profile</code> resource, use <code>device_profiles</code> to retrieve a list of resources or to create or delete a resource.
