...
Gets or operates on an individual <code>load_balancer_tls_certificate</code> resource, use <code>load_balancer_tls_certificates</code> to retrieve a list of resources or to create a resource.
