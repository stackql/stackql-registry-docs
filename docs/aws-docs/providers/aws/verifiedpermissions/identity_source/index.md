...
Gets or updates an individual <code>identity_source</code> resource, use <code>identity_sources</code> to retrieve a list of resources or to create or delete a resource.
