...
---
Gets or operates on an individual <code>resource_group</code> resource, use <code>resource_groups</code> to retrieve a list of resources or to create a resource.
