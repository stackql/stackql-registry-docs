...
---
Used to retrieve a list of <code>resource_groups</code> in a region or create a <code>resource_groups</code> resource, use <code>resource_group</code> to operate on an individual resource.
