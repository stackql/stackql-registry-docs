...
---
Used to retrieve a list of <code>inputs</code> in a region or create a <code>inputs</code> resource, use <code>input</code> to operate on an individual resource.
