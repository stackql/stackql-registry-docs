...
Gets or operates on an individual <code>eventschemas_registry</code> resource, use <code>eventschemas_registries</code> to retrieve a list of resources or to create a resource.
