...
<tr><td><code>RevisionId</code></td><td><code>string</code></td><td></td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.eventschemas.registry_policy<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;Id&gt;'
</pre>
