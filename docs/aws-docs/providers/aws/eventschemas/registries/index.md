...
Used to retrieve a list of <code>registries</code> in a region or create a <code>registries</code> resource, use <code>registry</code> to operate on an individual resource.
