...
For permissions required to operate on the <code>vpc_endpoint_service_tags</code> resource, see <a href="/providers/aws/ec2/vpc_endpoint_services/#permissions"><code>vpc_endpoint_services</code></a>
