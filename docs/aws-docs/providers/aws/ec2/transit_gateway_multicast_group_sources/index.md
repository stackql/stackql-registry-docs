...
Use the following StackQL query and manifest file to create a new <code>transit_gateway_multicast_group_source</code> resource, using <a ref="https://pypi.org/project/stack-deploy/" target="_blank"><code><b>stack-deploy</b></code></a>.
...
```sql
-- transit_gateway_multicast_group_source.iql (required properties only)
...
```sql
-- transit_gateway_multicast_group_source.iql (all properties)
INSERT INTO aws.ec2.transit_gateway_multicast_group_sources (
 GroupIpAddress,
 TransitGatewayMulticastDomainId,
 NetworkInterfaceId,
