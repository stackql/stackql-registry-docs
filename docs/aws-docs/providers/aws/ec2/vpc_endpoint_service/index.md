...
Gets or updates an individual <code>vpc_endpoint_service</code> resource, use <code>vpc_endpoint_services</code> to retrieve a list of resources or to create or delete a resource.
