...
Used to retrieve a list of <code>carrier_gateways</code> in a region or create a <code>carrier_gateways</code> resource, use <code>carrier_gateway</code> to operate on an individual resource.
