...
Gets or updates an individual <code>vpn_gateway</code> resource, use <code>vpn_gateways</code> to retrieve a list of resources or to create or delete a resource.
