...
Gets or updates an individual <code>transit_gateway_route_table_association</code> resource, use <code>transit_gateway_route_table_associations</code> to retrieve a list of resources or to create or delete a resource.
