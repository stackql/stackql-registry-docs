...
---
Gets or operates on an individual <code>vpc_endpoint_service_permissions</code> resource, use <code>vpc_endpoint_service_permissions</code> to retrieve a list of resources or to create a resource.
