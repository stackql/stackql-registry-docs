...
Gets or operates on an individual <code>verified_access_instance</code> resource, use <code>verified_access_instances</code> to retrieve a list of resources or to create a resource.
