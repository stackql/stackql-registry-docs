...
---
Used to retrieve a list of <code>placement_groups</code> in a region or create a <code>placement_groups</code> resource, use <code>placement_group</code> to operate on an individual resource.
