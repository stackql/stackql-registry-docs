...
Gets or updates an individual <code>transit_gateway_multicast_domain</code> resource, use <code>transit_gateway_multicast_domains</code> to retrieve a list of resources or to create or delete a resource.
