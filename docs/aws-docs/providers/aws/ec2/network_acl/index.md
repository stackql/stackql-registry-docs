...
Gets or updates an individual <code>network_acl</code> resource, use <code>network_acls</code> to retrieve a list of resources or to create or delete a resource.
