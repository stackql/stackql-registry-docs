...
Gets or operates on an individual <code>transit_gateway_peering_attachment</code> resource, use <code>transit_gateway_peering_attachments</code> to retrieve a list of resources or to create a resource.
