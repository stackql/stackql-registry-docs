...
Use the following StackQL query and manifest file to create a new <code>vpcdhcp_options_association</code> resource, using <a ref="https://pypi.org/project/stack-deploy/" target="_blank"><code><b>stack-deploy</b></code></a>.
...
```sql
-- vpcdhcp_options_association.iql (required properties only)
...
```sql
-- vpcdhcp_options_association.iql (all properties)
INSERT INTO aws.ec2.vpcdhcp_options_associations (
 DhcpOptionsId,
 VpcId,
 region
