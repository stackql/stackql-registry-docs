...
Gets or updates an individual <code>carrier_gateway</code> resource, use <code>carrier_gateways</code> to retrieve a list of resources or to create or delete a resource.
