...
Used to retrieve a list of <code>transit_gateway_route_tables</code> in a region or create a <code>transit_gateway_route_tables</code> resource, use <code>transit_gateway_route_table</code> to operate on an individual resource.
