...
Gets or updates an individual <code>enclave_certificate_iam_role_association</code> resource, use <code>enclave_certificate_iam_role_associations</code> to retrieve a list of resources or to create or delete a resource.
