...
---
Used to retrieve a list of <code>ipam_pool_cidrs</code> in a region or create a <code>ipam_pool_cidrs</code> resource, use <code>ipam_pool_cidr</code> to operate on an individual resource.
