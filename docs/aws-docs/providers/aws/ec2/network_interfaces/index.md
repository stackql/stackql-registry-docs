...
Used to retrieve a list of <code>network_interfaces</code> in a region or create a <code>network_interfaces</code> resource, use <code>network_interface</code> to operate on an individual resource.
