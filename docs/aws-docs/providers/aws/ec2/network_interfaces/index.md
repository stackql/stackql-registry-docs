...
Used to retrieve a list of <code>network_interfaces</code> in a region or to create or delete a <code>network_interfaces</code> resource, use <code>network_interface</code> to read or update an individual resource.
