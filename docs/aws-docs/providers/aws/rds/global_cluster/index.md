...
---
Gets or operates on an individual <code>global_cluster</code> resource, use <code>global_clusters</code> to retrieve a list of resources or to create a resource.
