...
Used to retrieve a list of <code>db_instances</code> in a region or create a <code>db_instances</code> resource, use <code>db_instance</code> to operate on an individual resource.
