...
Gets or updates an individual <code>db_proxy_endpoint</code> resource, use <code>db_proxy_endpoints</code> to retrieve a list of resources or to create or delete a resource.
