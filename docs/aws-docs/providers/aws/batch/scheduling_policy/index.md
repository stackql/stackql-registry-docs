...
<tr><td><code>FairsharePolicy</code></td><td><code>object</code></td><td></td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.batch.scheduling_policy<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;Arn&gt;'
</pre>
