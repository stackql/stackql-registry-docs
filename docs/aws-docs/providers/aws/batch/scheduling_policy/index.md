...
---
Gets or operates on an individual <code>scheduling_policy</code> resource, use <code>scheduling_policies</code> to retrieve a list of resources or to create a resource.
