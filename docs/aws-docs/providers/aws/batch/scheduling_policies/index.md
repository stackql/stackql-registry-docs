...
---
Used to retrieve a list of <code>scheduling_policies</code> in a region or create a <code>scheduling_policies</code> resource, use <code>scheduling_policy</code> to operate on an individual resource.
