...
Used to retrieve a list of <code>auth_policies</code> in a region or create a <code>auth_policies</code> resource, use <code>auth_policy</code> to operate on an individual resource.
