...
<tr><td><code>DestinationArn</code></td><td><code>string</code></td><td></td></tr>
...
## Example
<pre>
SELECT *<br/>FROM aws.vpclattice.access_log_subscription<br/>WHERE region = 'us-east-1'<br/>AND data__Identifier = '&lt;Arn&gt;'
</pre>
