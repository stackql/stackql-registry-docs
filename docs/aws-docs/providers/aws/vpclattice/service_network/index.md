...
Gets or updates an individual <code>service_network</code> resource, use <code>service_networks</code> to retrieve a list of resources or to create or delete a resource.
