...
For permissions required to operate on the <code>service_tags</code> resource, see <a href="/providers/aws/vpclattice/services/#permissions"><code>services</code></a>
