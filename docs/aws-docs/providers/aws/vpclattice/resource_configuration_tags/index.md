...
For permissions required to operate on the <code>resource_configuration_tags</code> resource, see <a href="/providers/aws/vpclattice/resource_configurations/#permissions"><code>resource_configurations</code></a>
